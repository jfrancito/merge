...
class EnviarCorreoValeRendirDetalleDiasController extends Controller
{
    use EnviarCorreoVRDetalleDiasTraits;

    public function actionEnviarCorreoVRDetalleDias(Request $request)
    {
        ...
        $exito = $this->enviarCorreoValeRendirDetalleDias($valerendir_id);
