...
class EnviarCorreoValeRendirGeneradoController extends Controller
{
    use EnviarCorreoVRGeneradoTraits;

    public function actionEnviarCorreoVRGenerado(Request $request)
    {
