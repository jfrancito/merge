...
class GestionOrdenPedidoAutorizaController extends Controller
{
    ...
    public function insertAutorizaOrdenPedido(Request $request)
    {
        ...
        try {
            ...
            ob_clean();
            \Log::error('Error al autorizar orden de pedido: ' . $e->getMessage());
    ...
    public function insertRechazarOrdenPedido(Request $request)
    {
        ...
        try {
            ...
            ob_clean();
            \Log::error('Error al rechazar orden de pedido: ' . $e->getMessage());
            return response()->json(['success' => false, 'mensaje' => $e->getMessage()], 500);
        }
    }
    ...
    public function actionDetallePedidoAut(Request $request)
    {
        $id_buscar = $request->input('orden_pedido_id');
    ...
    public function actionGuardarEditarDetalleAut(Request $request)
    {
        $orden_pedido_id = $request->input('orden_pedido_id');
