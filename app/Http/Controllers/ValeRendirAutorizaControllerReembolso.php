...
class ValeRendirAutorizaControllerReembolso extends Controller
{
    use ValeRendirReembolsoTraits;  

   
    public function actionValeRendirAutorizaReembolso()
    {
        ...
        $listarusuarios = $this->listaValeRendirAutorizaReembolso(
                "GEN",
                "",
                "",
                "",
        ...
        return view('valerendirreembolso.ajax.modalvalerendirautorizareembolso', [
                    'listausuarios' => $combo,
    ...
    public function actionAutorizarValeRendirReembolso(Request $request)
    { 
        ...
        $vale = WEBValeRendirReembolso::where('ID', $id_buscar)->first();


        $registro = DB::table('WEB.VALE_RENDIR_REEMBOLSO')
        ->select('COD_CENTRO')
        ...
        $cod_centro = $registro ? $registro->COD_CENTRO : null;
            ...
            $this->insertValeRendirAutoApruebaRechazaReembolso(
                'D', 
                $id_buscar,
                '', 
                '',
     ...
     public function actionRechazarValeRendirReembolso(Request $request)
    { 
        $id_buscar = $request->input('valerendir_id'); 
        ...
        $usuario_nombre_logueado_id = Session::get('usuario')->nombre;
            ...
            DB::table('WEB.VALE_RENDIR_REEMBOLSO')
                ->where('ID', $id_buscar)
                ->update([
        ...
        public function actionDetalleImporteReembolso(Request $request)
    { 
        $id_buscar = $request->input('valerendir_id'); 
