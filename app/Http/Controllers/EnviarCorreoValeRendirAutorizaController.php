...
use App\Traits\EnviarCorreoVRAutorizaTraits;
...
class EnviarCorreoValeRendirAutorizaController extends Controller
{
    use EnviarCorreoVRAutorizaTraits;

    public function actionEnviarCorreoVRAutoriza(Request $request)
    {
