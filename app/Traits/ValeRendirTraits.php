...
trait ValeRendirTraits
{
                                              ...
                                              $cod_centro_gasto, $ind_ms)
    {
        try {
            ...
            $stmt = DB::connection('sqlsrv')->getPdo()->prepare('SET NOCOUNT ON; EXEC TES.AUTORIZACION_IUD
                                                                    @IND_TIPO_OPERACION = ?,
                                                                    @COD_AUTORIZACION = ?,
                                                                    @COD_EMPR = ?,
                                                                    @COD_CENTRO = ?,
...

    {
         try {
                ...
                $cod_centro = $centrot->COD_CENTRO; 
                 ...
                 $stmt->bindParam(1, $ind_tipo_operacion, PDO::PARAM_STR);
                 $stmt->bindParam(2, $id, PDO::PARAM_STR);
                 $stmt->bindParam(3, $fec_inicio, PDO::PARAM_STR);
                 $stmt->bindParam(4, $fec_fin, PDO::PARAM_STR);
