        ...
        $listadatos             =   DB::table('FE_DOCUMENTO')
                                    ...
                                    ->select(DB::raw('FE_DOCUMENTO.TXT_NRO_CUENTA_BANCARIA,
                                                    ...
                                                    CASE 
                                                            ...
                                                            THEN CAN_TOTAL - ISNULL(MONTO_ANTICIPO_DESC,0) - ISNULL(MONTO_ANTICIPO_DESC_OTROS,0) - MONTO_DETRACCION_RED
                                                            ELSE CAN_TOTAL - ISNULL(MONTO_ANTICIPO_DESC,0) - ISNULL(MONTO_ANTICIPO_DESC_OTROS,0)
                                                        END AS TOTAL_PAGAR,
    ...
    private function con_lista_doc_proveedor_banco_folio($folio,$banco_txt) {
        ...
        $listadatos             =   CMPDocumentoCtble::join('FE_DOCUMENTO', 'FE_DOCUMENTO.ID_DOCUMENTO', '=', 'CMP.DOCUMENTO_CTBLE.COD_DOCUMENTO_CTBLE')
                                    ...
                                    ->select(DB::raw('FE_DOCUMENTO.TXT_NRO_CUENTA_BANCARIA,
                                                    ...
                                                    SUM(CASE 
                                                            WHEN FE_DOCUMENTO.COD_PAGO_DETRACCION = CMP.DOCUMENTO_CTBLE.COD_EMPR 
                                                            THEN ISNULL(FE_DOCUMENTO.TOTAL_VENTA_ORIG,0) - ROUND(ISNULL(FE_DOCUMENTO.MONTO_DETRACCION_RED,0), 0) - ISNULL(FE_DOCUMENTO.MONTO_RETENCION,0) - ISNULL(FE_DOCUMENTO.CAN_IMPUESTO_RENTA,0) - ISNULL(FE_DOCUMENTO.MONTO_ANTICIPO_DESC,0) - ISNULL(FE_DOCUMENTO.MONTO_ANTICIPO_DESC_OTROS,0) + ISNULL(FE_DOCUMENTO.PERCEPCION,0)
                                                            ELSE ISNULL(FE_DOCUMENTO.TOTAL_VENTA_ORIG,0) - ISNULL(FE_DOCUMENTO.MONTO_RETENCION,0) - ISNULL(FE_DOCUMENTO.CAN_IMPUESTO_RENTA,0)  - ISNULL(FE_DOCUMENTO.MONTO_ANTICIPO_DESC,0) - ISNULL(FE_DOCUMENTO.MONTO_ANTICIPO_DESC_OTROS,0) + ISNULL(FE_DOCUMENTO.PERCEPCION,0)
                                                        END) AS TOTAL_PAGAR,
    ...
    private function con_lista_doc_proveedor_banco_folio_oc($folio,$banco_txt) {
        ...
        $listadatos             =   CMPOrden::join('FE_DOCUMENTO', 'FE_DOCUMENTO.ID_DOCUMENTO', '=', 'CMP.ORDEN.COD_ORDEN')
                                    ...
                                    ->select(DB::raw('FE_DOCUMENTO.TXT_NRO_CUENTA_BANCARIA,
                                                    ...
                                                    SUM(CASE 
                                                            WHEN FE_DOCUMENTO.COD_PAGO_DETRACCION = CMP.ORDEN.COD_EMPR 
                                                            THEN CMP.ORDEN.CAN_TOTAL - ROUND(CMP.ORDEN.CAN_DETRACCION, 0) - CMP.ORDEN.CAN_RETENCION - ISNULL(FE_DOCUMENTO.MONTO_ANTICIPO_DESC,0) - ISNULL(FE_DOCUMENTO.MONTO_ANTICIPO_DESC_OTROS,0) + CMP.ORDEN.CAN_PERCEPCION
                                                            ELSE CMP.ORDEN.CAN_TOTAL - CMP.ORDEN.CAN_RETENCION - ISNULL(FE_DOCUMENTO.MONTO_ANTICIPO_DESC,0)- ISNULL(FE_DOCUMENTO.MONTO_ANTICIPO_DESC_OTROS,0) + CMP.ORDEN.CAN_PERCEPCION
                                                        END) AS TOTAL_PAGAR,
