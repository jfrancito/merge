                            ...
                            <div class='filtrotabla row'>
                                <div class="col-xs-12">
                                    ...
                                    <form method="POST"
                                          id="formdescargar"
                                          target="_blank"
                                          action="<?php echo e(url('/obtener-reporte-liquidaciones-trabajador-excel')); ?>"
...
<input type="hidden" name="device_info" id='device_info'>
                                        ...
                                        <script>
                                            ...
                                            let defaultText = "<?php echo e('TODOS'); ?>";
                                        </script>
                            ...
                            <div class='listajax'>
                                <?php echo $__env->make('reporte.administracion.ajax.listaliquidacionestrabajador', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/reporte/reporteliquidaciones.js?v='.$version)); ?>" type="text/javascript"></script>
