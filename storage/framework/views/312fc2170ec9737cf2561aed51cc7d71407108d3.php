...
<div class="modal-body" style="font-family: 'Times New Roman', serif; font-size: 15px; padding: 18px;">
    <input type="hidden" id="vale_id" value="<?php echo e($vale->ID); ?>">
        ...
        <tbody>
            <tr>
                ...
                <td style="width: 55%;">
                    <span class="text-black">
                        <?php echo e($fecha_inicio ? \Carbon\Carbon::parse($fecha_inicio)->format('d/m/Y') : ''); ?>
           ...
           <tr>
            ...
            <tr>
                ...
                <td>
                    <span class="text-black"><?php echo e($ruta_viaje ?? '—'); ?></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <span class="text-black"><?php echo e($txt_glosa ?? '—'); ?></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="number" 
                           ...
                           min="0" 
                           value="<?php echo e($vale->AUMENTO_DIAS ?? ''); ?>"
