  ...
  <?php if($item->COD_ESTADO == 'ETM0000000000001'): ?> 
      <span class="badge badge-default" style="display: inline-block;"><?php echo e($item->TXT_ESTADO); ?></span> 
  <?php else: ?>
    ...
    <?php else: ?>
      <?php if($item->COD_ESTADO == 'ETM0000000000002'): ?> 
          <span class="badge badge-warning" style="display: inline-block;"><?php echo e($item->TXT_ESTADO); ?></span>
      <?php else: ?>
        ...
        <?php else: ?>
          ...
          <?php else: ?>
            <?php if($item->COD_ESTADO == 'ETM0000000000005'): ?> 
                <span class="badge badge-primary" style="display: inline-block;"><?php echo e($item->TXT_ESTADO); ?></span>
            <?php else: ?>
              <?php if($item->COD_ESTADO == 'ETM0000000000006'): ?> 
                  <span class="badge badge-danger" style="display: inline-block;"><?php echo e($item->TXT_ESTADO); ?></span>
              <?php else: ?>
                <?php if($item->COD_ESTADO == 'ETM0000000000007'): ?> 
                    <span class="badge badge-warning" style="display: inline-block;"><?php echo e($item->TXT_ESTADO); ?></span>
                <?php else: ?>
                  <?php if($item->COD_ESTADO == 'ETM0000000000008'): ?> 
                      <span class="badge badge-success" style="display: inline-block;"><?php echo e($item->TXT_ESTADO); ?></span>
                  <?php else: ?>
