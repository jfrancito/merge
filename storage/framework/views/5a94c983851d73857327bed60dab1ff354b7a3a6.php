                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 20px;">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 cajareporte">
                            <div class="form-group">
                              ...
                              <div class="col-sm-12 abajocaja" >
                                <input type="text"  class="form-control control input-sm" value = '<?php echo e($fedocumento->TXT_CATEGORIA_BANCO); ?>' readonly>
                              </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 cajareporte ajax_cb">
                          <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja" >
                              <input type="text"  class="form-control control input-sm" value = '<?php echo e($fedocumento->TXT_NRO_CUENTA_BANCARIA); ?>' readonly>
                            </div>
                          </div>
                        </div>
                    </div>
