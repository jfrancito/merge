                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="<?php echo e(url('/aprobar-comprobante-contabilidad-estiba/'.$idopcion.'/'.$lote)); ?>"
                                                ...
                                                <?php echo $__env->make('comprobante.form.formaprobarcontestiba', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidoreparable'
                                                  action="<?php echo e(url('/agregar-reparable-contabilidad-estiba/'.$idopcion.'/'.$lote)); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
...
<input type="hidden" name="device_info" id='device_info'>
                                                ...
                                                <input type="hidden" name="operacion_id" id="operacion_id"
                                                       value="<?php echo e($fedocumento->OPERACION); ?>">
                                                <?php echo $__env->make('comprobante.form.formreparableestiba', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                            </form>
                                        </div>
                                    </div>
                                </div>
