<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <?php echo $__env->make('comprobante.form.contrato.seguimientocontabilidad', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
</div>
                                ...
                                <div class="btn-group btn-hspace">
                                    ...
                                    <ul role="menu" class="dropdown-menu pull-right">
                                        ...
                                        <?php if(Session::get('usuario')->id == '1CIX00000001' or Session::get('usuario')->rol_id == '1CIX00000016' or Session::get('usuario')->rol_id == '1CIX00000015'): ?>
                                            <li>
                                                <a class="elimnaritem"
                                                   href="<?php echo e(url('/eliminar-archivo-item-contrato/'.$item->TIPO_ARCHIVO.'/'.$item->NOMBRE_ARCHIVO.'/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_DOCUMENTO_CTBLE, 0,7).'/'.Hashids::encode(substr($ordencompra->COD_DOCUMENTO_CTBLE, -9)))); ?>">
                                                    Eliminar Item
                                                </a>
                                            </li>
                                        <?php endif; ?>
