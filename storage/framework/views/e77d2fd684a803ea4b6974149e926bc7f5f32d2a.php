            ...
            <div class="col-sm-12">
                ...
                <div class="tab-container">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#crearconsolidadogeneral" data-toggle="tab"><b>CREAR CONSOLIDADO GENERAL</b></a></li>
                        <li><a href="#consoldadogeneralterminado" data-toggle="tab"><b>ORDEN CONSOLIDADO GENERAL</b></a></li>
                    </ul>

                    <!-- CONTENIDO TABS -->
                    <div class="tab-content">
                        <div id="crearconsolidadogeneral" class="tab-pane fade in active cont">
                             <?php echo $__env->make('ordenpedido.tab.creartabordenconsolidadogeneral', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>

                        <div id="consoldadogeneralterminado" class="tab-pane fade cont">
                            <?php echo $__env->make('ordenpedido.consolidadogeneral.alistaordenconsolidadogeneralterminado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
