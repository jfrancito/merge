    ...
    <div class="row">
      <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading">Revision de Comporbante (<?php echo e($lote); ?>)</div>
                ...
                <div id="aprobar" class="tab-pane active cont">
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                      <form method="POST" id='formpedido' action="<?php echo e(url('/aprobar-comprobante-acopio-estiba/'.$idopcion.'/'.$lote)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

<input type="hidden" name="device_info" id='device_info'>

                            <input type="hidden" name="operacion_id" id="operacion_id" value = "<?php echo e($fedocumento->OPERACION); ?>">
                            
                        <?php echo $__env->make('acopio.form.formaprobaracopioestiba', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                      </form>
                    </div>
                  </div>
                </div>
                <div id="observar" class="tab-pane cont">
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                      <form method="POST" id='formpedidoobservar' action="<?php echo e(url('/agregar-observacion-acopio-estiba/'.$idopcion.'/'.$lote)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                            <?php echo e(csrf_field()); ?>
                        ...
                        <?php echo $__env->make('acopio.form.formobservaracopioestiba', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                      </form>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        ...
                        <div class="panel-body">
                            <form method="POST" id='formpedidorechazar'
                                  action="<?php echo e(url('/agregar-extorno-estiba-acopio/'.$idopcion.'/'.$lote)); ?>"
                                ...
                                <?php echo $__env->make('acopio.form.formrechazoacopioestiba', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </form>
                        </div>
                    </div>
                </div>
