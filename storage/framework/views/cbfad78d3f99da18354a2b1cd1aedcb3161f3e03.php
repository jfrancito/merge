...
<tr>
    ...
    <td colspan="2" style="border : 1px solid #000000" >
        <?php if(isset($cab->COD_ESTADO) && $cab->COD_ESTADO == 'ETM0000000000015' && isset($cab->COD_TRABAJADOR_APRUEBA_ADM) && $cab->COD_TRABAJADOR_APRUEBA_ADM == 'IITR000000000391'): ?>
            POR APROBAR GERENCIA ADM
        <?php else: ?>
            <?php echo e($cab->TXT_ESTADO); ?>
