  ...
  <div class="panel panel-default panel-contrast">
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table id="table-pedidos-adm-pendientes" class="table table-hover table-striped mb-0 listatabla">
                ...
                <tbody>
                    <?php $__currentLoopData = $listapedido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($item['COD_ESTADO'] === 'ETM0000000000015' && $item['COD_TRABAJADOR_APRUEBA_ADM'] === $usuario_logueado_id): ?>
