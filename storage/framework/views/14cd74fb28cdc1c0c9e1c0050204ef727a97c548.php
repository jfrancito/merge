            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000010394'): ?> panel-border-color-danger <?php else: ?> <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000007086'): ?> panel-border-color-success <?php else: ?> panel-border-color-info <?php endif; ?> <?php endif; ?>">
                        <div class="panel-heading negrita">Reporte Inventario
                            <div class="tools tooltiptop">
                                <div class="dropdown">
                                    <a href="#" class="tooltipcss opciones buscarinventarioformato">
                            ...
                            <div class='filtrotabla row'>
                                <div class="col-xs-12">
                                    <form method="POST"
                                          id="formdescargar"
                                          target="_blank"
                                          action="<?php echo e(url('/descargar-archivo-inventario-consolidado')); ?>"
...
<input type="hidden" name="device_info" id='device_info'>
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label labelleft negrita">Fecha Hasta
                                                    :</label>
                                                <input required id="fecha_hasta" name="fecha_hasta"
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                              ...
                                              <div class="col-sm-12 abajocaja" >
                                                <?php echo Form::select( 'cod_empr', $combo_empresa, $combo_emp_sel,
                                                                  [
                            ...
                            <div class='listajax'>
                                <?php echo $__env->make('inventario.ajax.alistainventario', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/inventario/inventarioconsolidado.js?v='.$version)); ?>" type="text/javascript"></script>
