                            ...
                            <td class="rigth">
                                <div class="btn-group btn-hspace">
                                    ...
                                    <ul role="menu" class="dropdown-menu pull-right">
                                        ...
                                        <?php if(Session::get('usuario')->id == '1CIX00000001' or Session::get('usuario')->rol_id == '1CIX00000016' or Session::get('usuario')->rol_id == '1CIX00000015'): ?>
                                            <li>
                                                <a class="elimnaritem"
                                                   href="<?php echo e(url('/eliminar-archivo-item/'.$item->TIPO_ARCHIVO.'/'.$item->NOMBRE_ARCHIVO.'/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>">
                                                    Eliminar Item
                                                </a>
                                            </li>
                                        <?php endif; ?>
...
<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
    <div class="panel panel-default panel-contrast">
        <div class="panel-heading" style="background: #1d3a6d;color: #fff;">COMENTARIO
        </div>
        <div class="panel-body panel-body-contrast">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group sectioncargarimagen">
                        <label class="col-sm-12 control-label" style="text-align: left;"><b>REALIZAR UN COMENTARIO</b> <br><br></label>
                        <div class="col-sm-12">
                      <textarea
                              name="descripcion"
                              id="descripcion"
