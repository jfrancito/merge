...
<html lang="<?php echo e(app()->getLocale()); ?>">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/css/login.css?v='.$version)); ?>" type="text/css"/>
  ...
  <body class="be-splash-screen login-top">
    ...
    <?php echo $__env->make('error.erroresbd', ['id' => Session::get('errorbd')  , 'error' => Session::get('errorbd'), 'data' => '2'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
              ...
              <div class="tab-container color-azul-indu" >
                ...
                <div class="tab-content card color-azul-indu">
                  <div id="login" class="tab-pane active cont box">
                    ...
                    <img src="<?php echo e(asset('public/img/indulogo.png')); ?>" alt="logo" width="150" height="130" class="logo-img">
...
<input type="hidden" name="device_info" id='device_info'>
                        ...
                        <div class="form-group">
                          ...
                          <input id="name" name='name' type="text" required = "" value="<?php echo e(old('name')); ?>"  placeholder="RUC" autocomplete="off" class="form-control" data-aw="1"/>
                        ...
                        <div class="form-group">
                          ...
                          <?php echo $__env->make('error.erroresvalidate', ['id' => $errors->has('name')  , 'error' => $errors->first('name', ':message'), 'data' => '2'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        ...
                        <div class="form-group login-submit">
                          ...
                          <a href="<?php echo e(url('/registrate')); ?>" type="button"  class="btn btn-success btn-xl background-rojo color-blanco border-color-rojo" style="margin-top: 15px;"><b>REGISTRATE</b></a>

                        </div>

                        <input type='hidden' id='carpeta' value="<?php echo e($capeta); ?>"/>
                        <input type="hidden" id="token"  class ="ocultar" name="_token"  value="<?php echo e(csrf_token()); ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <a href="<?php echo e(url('/descargar-manual/')); ?>" class="color-blanco" target="_blank">DESCARGAR MANUAL</a>
                      </div>
                    </div>
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="profile-sidebar background-amarillo color-blanco">
                              ...
                              <div class="profile-userpic">
                                <img src="<?php echo e(asset('public/img/jl.jpg')); ?>" class="img-responsive" alt="">
                              </div>
                              <!-- END SIDEBAR USERPIC -->
                              <!-- SIDEBAR USER TITLE -->
                            ...
                            <div class="profile-sidebar background-rojo">
                              <!-- SIDEBAR USERPIC -->
                              <div class="profile-userpic">
                                <img src="<?php echo e(asset('public/img/jf.jpg')); ?>" class="img-responsive" alt="">
                              </div>
                              <!-- END SIDEBAR USERPIC -->
                              <!-- SIDEBAR USER TITLE -->
                              <div class="profile-usertitle">
    ...
    <script src="<?php echo e(asset('public/js/user/user.js')); ?>" type="text/javascript"></script>
