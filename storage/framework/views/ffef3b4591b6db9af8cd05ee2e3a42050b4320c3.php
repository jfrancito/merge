              ...
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading"><?php echo e($titulo); ?>
                  ...
                  <div class="tools tooltiptop">
                    <a href="<?php echo e(url('/agregar-contrato-acopio/'.$idopcion)); ?>" class="btn btn-secondary botoncabecera tooltipcss opciones" style="width:140px;">
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('contratoacopio.ajax.alistacontratoacopio', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
