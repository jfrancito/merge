...
<div class="be-content consolidadopedidoapruebaprincipal">
    <!-- VALORES OCULTOS -->
            ...
            <div class="col-sm-12">
                <div class="tab-container">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#consolidadopedidoaprueba" data-toggle="tab"><b>CONSOLIDADO DE PEDIDOS</b></a>
                        </li>
                         <li>
                            <a href="#listacotizacionpedidoaprobados" data-toggle="tab"><b>LISTA CONSOLIDADO DE PEDIDOS</b></a>
                        </li>
                    </ul>

                    <div class="tab-content">
                        <!-- TAB: CREAR -->
                        <div id="consolidadopedidoaprueba" class="tab-pane active cont">
                            <?php echo $__env->make('ordenpedido.consolidadoap.ajax.alistaconsolidadopedidoaprueba', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>

                         <div id="listacotizacionpedidoaprobados" class="tab-pane fade cont">
                            <?php echo $__env->make('ordenpedido.consolidadoap.listaconsolidadosaprobados', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
...
<script src="<?php echo e(asset('public/js/ordenpedido/consolidadoaprobado.js?v=' . $version)); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
