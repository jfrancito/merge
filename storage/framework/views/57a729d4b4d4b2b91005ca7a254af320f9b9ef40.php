      ...
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          ...
          <div class="panel-body">
            <form method="POST" action="<?php echo e(url('/agregar-rol/'.$idopcion)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
...
<input type="hidden" name="device_info" id='device_info'>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <input  type="text"
                            id="nombre" name='nombre' value="<?php echo e(old('nombre')); ?>" placeholder="Nombres"
                            required = ""
