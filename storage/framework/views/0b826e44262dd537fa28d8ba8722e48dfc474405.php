    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">CONSTANCIA 4TA CATEGORIA
            <span class="panel-subtitle">Crear un nueva nueva constancia 4ta categoria</span>
          </div>
          <div class="panel-body">
            <form method="POST" action="<?php echo e(url('/agregar-cuarta-categoria/'.$idopcion)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" id ='frmpm' enctype="multipart/form-data">
                  <?php echo e(csrf_field()); ?>

<input type="hidden" name="device_info" id='device_info'>

                  <div class='formconsulta'>
                    <?php echo $__env->make('cuartacategoria.form.facuartacategoria', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <div class="row xs-pt-15">
                      ...
                      <div class="col-xs-6">
                        <p class="text-right">
                            <button type="submit" class="btn btn-space btn-primary btnguardarplanillamovilidad">Crear Nueva Constancia 4ta Categoria</button>     
                        </p>
                      </div>
                    </div>
                  </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $('#empresa_id').select2({
            ...
            ajax: {
                dataType: 'json',
                url: '<?php echo e(url("buscarempresarenta")); ?>',
                delay: 100,
