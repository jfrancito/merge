        ...
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">PENDIENTES
            ...
            <div class="chart-legend">
              <a href="<?php echo e(url($urldip)); ?>" class="btn btn-rounded btn-space btn-primary dasboark">Ir Aprobar</a>
            </div>
            <span class="count-das"><?php echo e($count_x_aprobar_dip); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-12 col-md-4">
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">OBSERVADOS
            ...
            <span class="count-das"><?php echo e($count_observados_dip); ?></span>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-md-4">
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">REPARABLE
            ...
            <span class="count-das"><?php echo e($count_reparables_dip); ?></span>
          </div>
        </div>
      </div>
      <?php endif; ?>
      ...
      <div class="col-xs-12 col-md-4">
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">REPARABLE
            <span class="panel-subtitle" style="color: #fff;">Documentos reparables</span>
            <div class="chart-legend">
              <a href="<?php echo e(url($url_rep_dip)); ?>" class="btn btn-rounded btn-space btn-primary dasboark">Ir Reparable</a>
            </div>
            <span class="count-das"><?php echo e($count_reparables_dip); ?></span>
          </div>
        </div>
      ...
      <div class="col-xs-12 col-md-4">
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">REVISAR REPARABLE
            <span class="panel-subtitle" style="color: #fff;">Documentos reparables</span>
            <div class="chart-legend">
              <a href="<?php echo e(url($url_rep_dip_revisar)); ?>" class="btn btn-rounded btn-space btn-primary dasboark">Ir Reparable</a>
            </div>
            <span class="count-das"><?php echo e($count_reparables__revdip); ?></span>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-md-4">
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">OBSERVADOS
            <span class="panel-subtitle" style="color: #fff;">Documentos observados</span>
            <div class="chart-legend">
              <a href="<?php echo e(url($urldip.'&tab_id=observado')); ?>" class="btn btn-rounded btn-space btn-primary dasboark">Ir Observados</a>
            </div>
            <span class="count-das"><?php echo e($count_observados_dip); ?></span>
          </div>
        </div>
      ...
      <div class="col-xs-12 col-md-4">
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">OBSERVACIONES LEVANTADAS
            ...
            <div class="chart-legend">
              <a href="<?php echo e(url($urldip.'&tab_id=observadole')); ?>" class="btn btn-rounded btn-space btn-primary dasboark">Ir Observados</a>
            </div>
            <span class="count-das"><?php echo e($count_observadosdip_le); ?></span>
          </div>
        </div>
      </div>
      <?php endif; ?>
