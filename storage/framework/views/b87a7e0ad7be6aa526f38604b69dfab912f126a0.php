        ...
        <div class="panel panel-default panel-border-color panel-border-color-success">
          <div class="panel-heading"><?php echo e($titulo); ?>
            ...
            <div class="tools tooltiptop">
              ...
              <a href="#" class="btn btn-secondary botoncabecera tooltipcss opciones btnacumuladodias"
                style="width:140px;">
...
<!--               <a href="<?php echo e(url('/subir-firma/' . $idopcion)); ?>" class="btn btn-secondary botoncabecera tooltipcss opciones"
                style="width:140px;">
                <span class="tooltiptext">Subir Firma</span>
                Subir Firma
              </a> -->

              <a href="<?php echo e(url('/tutorial/planillaovilidad_03.mp4')); ?>"
              ...
              <!-- TUTORIAL-PASO-1: Clic para iniciar una nueva planilla de movilidad -->
              <a href="<?php echo e(url('/agregar-planilla-movilidad/' . $idopcion)); ?>"
                class="btn btn-secondary botoncabecera tooltipcss opciones" style="width:140px;">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-sm-12 abajocaja">
                    <div data-min-view="2" data-date-format="dd-mm-yyyy"
                      ...
                      <input size="16" type="text" value="<?php echo e($fecha_inicio); ?>" placeholder="Fecha Inicio"
                        id='fecha_inicio' name='fecha_inicio' required="" class="form-control input-sm" />
              ...
              <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                <div class="form-group ">
                  ...
                  <div class="col-sm-12 abajocaja">
                    <div data-min-view="2" data-date-format="dd-mm-yyyy"
                      class="input-group date datetimepicker pickerfecha" style='padding: 0px 0;margin-top: -3px;'>
                      <input size="16" type="text" value="<?php echo e($fecha_fin); ?>" placeholder="Fecha Fin" id='fecha_fin'
                        name='fecha_fin' required="" class="form-control input-sm" />
                      <span class="input-group-addon btn btn-primary"><i class="icon-th mdi mdi-calendar"></i></span>
                    </div>
                  </div>
                </div>
...
<!--               <div role="alert" class="alert alert-primary alert-icon alert-icon-colored alert-dismissible">
                ...
                <div class="message">
                  <strong> <?php echo e($mensaje_firma); ?> </strong>
                </div>
              </div> -->
          ...
          <div class='listajax'>
            <?php echo $__env->make('planillamovilidad.ajax.alistaplanillamovilidad', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          </div>
        </div>
      </div>
    </div>
