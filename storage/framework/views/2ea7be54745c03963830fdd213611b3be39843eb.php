...
<table table id="tablalistanegraproveedores" class="table table-striped table-borderless">
  <thead style="background-color: #1d3a6d; color: white;">
      ...
      <tbody>
          <?php $__currentLoopData = $listarlistanegra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <tr>
