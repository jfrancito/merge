                ...
                <div class="text-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-3">
                        <span style="font-size: 16px; color: rgba(255,255,255,0.85); font-weight: 500;">
                            <i class="fa fa-tag me-1" style="color: white;"></i> Pedido: <b><?php echo e($pedido->ID_PEDIDO); ?></b>
                        </span>
            ...
            <div class="panel-body" style="padding: 30px 40px;">
                ...
                <div class="table-responsive" style="border-radius: 8px; border: 1px solid #eaecf4;">
                    <table class="table table-hover mb-0" id="tabla-detalle-tab-ger">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span style="background: #edf2ff; color: #4e73df; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 700; border: 1px solid #d0dcfc; display: inline-flex; align-items: center;">
                                            <i class="fa fa-barcode me-1" style="font-size: 10px;"></i> <?php echo e($detalle->COD_PRODUCTO); ?>
                                    ...
                                    <td class="text-center">
                                        <?php if($pedido->COD_TRABAJADOR_APRUEBA_GER == $cod_usuario_session && $pedido->COD_ESTADO == 'ETM0000000000013'): ?>
                                            <input type="number" 
                        ...
                        <tfoot>
                            <tr style="background: #f8f9fc;">
                                <td colspan="<?php echo e(8 + ($mostrarJefe ? 1 : 0)); ?>" class="text-right fw-bold text-uppercase" style="padding: 15px; color: #0f2a52;">Total General</td>
                                <td class="text-center fw-bold text-primary total-general-ger" style="padding: 15px; font-size: 18px;">S/ <?php echo e(number_format($suma_total_general, 2)); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
