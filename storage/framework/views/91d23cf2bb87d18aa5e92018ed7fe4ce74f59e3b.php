                  ...
                  <div class="row mt-4">
                        ...
                        <div class="col-md-3 col-lg-3">
                          <div class="form-group">
                            ...
                            <?php echo Form::select('tipo_pago', $listausuarios5, '',
                              [
                    ...
                    <div class="col-md-4 col-lg-3" id="grupo_entidad">
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo e($txt_categoria_banco); ?>" 
                               data-valor="<?php echo e($txt_categoria_banco); ?>"
                    ...
                    <div class="col-md-4 col-lg-3" id="grupo_cuenta">
                       <label class="form-label fw-bold labelleft negrita">
                        ...
                        <input type="text" 
                               ...
                               data-valor="<?php echo e($numero_cuenta); ?>"
                               class="form-control bg-light" readonly
                               autocomplete="off"
                               pattern="[0-9]*">
                    </div>
