<?php $__env->startSection('style'); ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/dashboard.css?v='.$version)); ?> " />
	...
	<div class="be-content  contenido proveedor" style="height: 100vh;">
		<div class="main-content container-fluid">
			<div class='container'>
                 ...
                 <?php if(Session::get('usuario')->rol_id == '1CIX00000001' || 
                    ...
                    <div class="col-md-4">
                        <div class="btn-toolbar">
                            <div role="group" class="btn-group btn-group-justified btn-space">
                                <?php if(Session::get('usuario')->rol_id == '1CIX00000001' || Session::get('usuario')->id == '1CIX00000173' || Session::get('usuario')->id == '1CIX00000167'): ?>
                                <a href="<?php echo e(url('/actualizar-data/BE')); ?>" class="btn btn-primary btn_actualizar_data">DATA BE</a>
                                <?php endif; ?>
                                <?php if(Session::get('usuario')->rol_id == '1CIX00000001' || Session::get('usuario')->id == '1CIX00000442'): ?>
                                <a href="<?php echo e(url('/actualizar-data/RI')); ?>" class="btn btn-primary btn_actualizar_data" >DATA RI</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
              ...
              <div class="row">
                      <?php if(Session::get('usuario')->rol_id == '1CIX00000024'): ?>
                        <?php echo $__env->make('usuario.proveedores', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                      <?php else: ?>
                        <?php echo $__env->make('usuario.administrativo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                      <?php endif; ?>
                </div>
			</div>
		</div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <small class="form-text text-muted">
                        Total de proveedores: <span id="totalProveedores"><?php echo e(count(Session::get('listanegra'))); ?></span>
                    </small>
                </div>
                ...
                <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody id="tablaProveedores">
                            <?php $__currentLoopData = Session::get('listanegra'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="fila-proveedor">
                                <td><?php echo e($index + 1); ?></td>
                                <td class="proveedor-nombre"><?php echo e($proveedor->TXT_EMPRESA_PROVEEDOR); ?></td>
                            </tr>
...
<?php endif; ?>
  	...
  	<?php echo $__env->make('usuario.modal.musuario', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php if(trim(Session::get('usuario')->rol_id) != '1CIX00000024'): ?>
            ...
            <div class="modal-body p-0" style="background: #fafbfc;">
                ...
                <div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; background: #000;">
                    <video id="videoAnuncio" controls playsinline webkit-playsinline preload="metadata" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none;">
                        <source src="<?php echo e(asset('public/videos/video_planilla.mp4')); ?>" type="video/mp4">
...
<script>
  ...
  <script src="<?php echo e(asset('public/js/user/proveedor.js?v='.$version)); ?>" type="text/javascript"></script>
