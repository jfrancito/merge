...
<table table id="tablalistafirmavaleaprobados" class="table table-striped table-borderless">
  <thead style="background-color: #1d3a6d; color: white;">
      ...
      <tbody>
          <?php $__currentLoopData = $aprobados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <tr>
              ...
              <td style="width:150px;"><?php echo e($item['NOM_SOLICITA']); ?></td>
              <td><?php echo e($item['CONTRATO']); ?></td>               
              <td><?php echo e($item['CULTIVO']); ?></td>    
              <td style="width:150px;"><?php echo e($item['TRA_AUTORIZA']); ?></td>    
