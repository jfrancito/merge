<html>
    ...
    <?php 
        ...
        $total_saldo = 0.0000;
        // Array para el resumen por contrato
        $resumen_contratos = [];
     ?>
    <style type="text/css">
    ...
    <table>
        ...
        <?php $__currentLoopData = $cuentas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php 
                ...
                $esCentroRioja = ($item['Centro'] ?? '') === 'RIOJA';
             ?>

            <?php if($item['IND_REL'] === 'T' && $item['IND_CP'] === 'C' && $esCreditoEspecial && $esCentroRioja): ?>
                <?php 
                    $esMN = ($item['COD_MONEDA'] ?? '') === 'MON0000000000001';
                    $esME = ($item['COD_MONEDA'] ?? '') !== 'MON0000000000001';
                 ...
                 ?>
                <tr>
                    <td class="border"> <?php echo e($item['NOM_CLIENTE']); ?></td>
                    <td class="border"><?php echo e($contratoFormateado); ?></td>
                    <td class="border"><?php echo e($item['Centro']); ?></td>
                    <td class="border"><?php echo e(number_format($item['Tcambio'], 2, '.', '')); ?></td>
                    
                    <td class="border"><?php echo e(\PhpOffice\PhpSpreadsheet\Shared\Date::PHPToExcel(new \DateTime($item["FecDocumento"]))); ?></td>
                    <td class="border"><?php echo e($item['TipoDocumento']); ?></td>
                    <td class="border"><?php echo e($item['NroDocumento']); ?></td>
                    <td class="border"><?php echo e($item['diasTranscurridos']); ?></td>
                    <td class="border"><?php echo e($item['SIM_MONEDA']); ?></td>
                    <td class="border"><?php echo e($item['JEFE_VENTA']); ?></td>
                    <td class="border"><?php echo e($item['TIPO_CONTRATO']); ?></td>
                    <td class="border"><?php echo e(number_format($item['TOT_DOC'], 2, '.', '')); ?></td>
                    <td class="border"><?php echo e($item['COD_MONEDA'] === 'MON0000000000001' ? number_format($item['CAN_CAPITAL_SALDO'], 2, '.', '') : 0.00); ?></td>
                    <td class="border"><?php echo e($item['COD_MONEDA'] !== 'MON0000000000001' ? number_format($item['CAN_CAPITAL_SALDO_ME'], 2, '.', ''): 0.00); ?></td>
                    <td class="border"><?php echo e(number_format($item['CAN_INTERES_SALDO'], 2, '.', '')); ?></td>
                    <td class="border"><?php echo e($item['COD_MONEDA'] === 'MON0000000000001' ? number_format($item['CAN_CAPITAL_SALDO'] + $item['CAN_INTERES_SALDO'], 2, '.', '') : number_format($item['CAN_CAPITAL_SALDO_ME'] + $item['CAN_INTERES_SALDO'], 2, '.', '')); ?></td>
                <?php 
        ...
        <tr>
            ...
            <th class="footerho"><?php echo e(number_format($total_mn, 2, '.', '')); ?></th>
            <th class="footerho"><?php echo e(number_format($total_me, 2, '.', '')); ?></th>
            <th class="footerho"><?php echo e(number_format($total_interes, 2, '.', '')); ?></th>
            <th class="footerho"><?php echo e(number_format($total_saldo, 2, '.', '')); ?></th>
        </tr>
        </tfoot>
    </table>
    <!-- TABLA DE RESUMEN POR CONTRATO -->
    <?php if(!empty($resumen_contratos)): ?>
        <?php 
        ...
        <table>
            ...
            <tbody>
            <?php $__currentLoopData = $resumen_contratos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resumen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php 
                ...
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td class="border"><?php echo e($resumen['contrato']); ?></td>
                    <td class="border"><?php echo e($resumen['titular']); ?></td>
                    <td class="border"><?php echo e($resumen['tipo_contrato']); ?></td>
                    <td class="border" style="text-align: right;"><?php echo e(number_format($resumen['importe_original'], 2, '.', '')); ?></td>
                    <td class="border" style="text-align: right;"><?php echo e(number_format($resumen['saldo_mn'], 2, '.', '')); ?></td>
                    <td class="border" style="text-align: right;"><?php echo e(number_format($resumen['saldo_me'], 2, '.', '')); ?></td>
                    <td class="border" style="text-align: right;"><?php echo e(number_format($resumen['intereses'], 2, '.', '')); ?></td>
                    <td class="border" style="text-align: right;"><?php echo e(number_format($resumen['total_saldo'], 2, '.', '')); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
            <tfoot>
            <tr>
                ...
                <th class="resumen-total" style="text-align: right;"><?php echo e(number_format($total_resumen_importe, 2, '.', '')); ?></th>
                <th class="resumen-total" style="text-align: right;"><?php echo e(number_format($total_resumen_mn, 2, '.', '')); ?></th>
                <th class="resumen-total" style="text-align: right;"><?php echo e(number_format($total_resumen_me, 2, '.', '')); ?></th>
                <th class="resumen-total" style="text-align: right;"><?php echo e(number_format($total_resumen_interes, 2, '.', '')); ?></th>
                <th class="resumen-total" style="text-align: right;"><?php echo e(number_format($total_resumen_saldo, 2, '.', '')); ?></th>
            </tr>
            </tfoot>
        </table>
    <?php endif; ?>
