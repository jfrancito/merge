...
<html lang="es">
<head>
	<title>Planilla de Movilidad Consolidada (<?php echo e($feplanillaentrega->SERIE); ?>-<?php echo e($feplanillaentrega->NUMERO); ?>) </title>
...
<body>
	...
	<div class="menu">
	    ...
	    <div class="right">
	    		...
	    		<h3>N° <?php echo e($feplanillaentrega->SERIE); ?>-<?php echo e($feplanillaentrega->NUMERO); ?></h3> 
	    </div>
	</div>
    </header>
    <section>
			    ...
			    <div class="det1">
					...
					<table class="tcab">
					    <tr>
					      ...
					      <td><b> : </b><?php echo e(ucwords(strtolower(preg_replace('/^\(\d+\)\s*/', '', $feplanillaentrega->TXT_PERIODO)))); ?></td>
					    </tr>
					    <tr>
					      <td class="primertab"><b>FECHA EMISION</b></td>
					      <td><b> : </b><?php echo e(date_format(date_create($feplanillaentrega->FEC_EMISION), 'd/m/Y')); ?></td>
					    </tr>
						<tr>
					      <td class="primertab"><b>DNI</b></td>
					      <td><b> : </b><?php echo e($dni); ?></td>
					    </tr>	 
						<tr>
					      <td class="primertab"><b>NOMBRE</b></td>
					      <td><b> : </b><?php echo e($nombre); ?></td>
					    </tr>	

						<tr>
					      <td class="primertab"><b>LUGAR DE TRABAJO</b></td>
					      <td><b> : </b><?php echo e(ucwords(strtolower($lugares_trabajo->DIRECCIONES_CONCATENADAS))); ?></td>
					    </tr>
						<tr>
					      <td class="primertab" style="vertical-align: top;"><b>GLOSA</b></td>
					      <td><b> : </b>
							<?php $__currentLoopData = $planillamovilidadglosas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $glosa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							    <?php echo e(ucwords(strtolower($glosa->TXT_GLOSA))); ?>
