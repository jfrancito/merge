                        ...
                        <div class='filtrotabla row'>
                            <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                 <div class="input-group">
                                                    <?php echo Form::select('usuario_select', $listausuario, '',
                                                   [
                                                     'class'       => 'form-control control select2' ,
                                                     'id'          => 'usuario_select',
                                                     'data-aw'     => '1',
                             ...
                             <div class="listadetalleajax"></div>
                                ...
                                <?php echo $__env->make('valerendir.ajax.listamodalpersonalaprueba', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div>
                </div>
             </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/vale/registropersonalaprueba.js?v='.$version)); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
