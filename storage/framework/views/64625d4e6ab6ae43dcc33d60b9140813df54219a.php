      ...
      <ul class="nav nav-tabs">
        ...
        <div class="tab-content">
                ...
                <div id="pendientes" class="tab-pane cont active">
                   <?php echo $__env->make('valerendirreembolso.ajax.listamodalvalerendirautorizapendientereembolso', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
                <div id="autorizados" class="tab-pane cont">
                   <?php echo $__env->make('valerendirreembolso.ajax.listamodalvalerendirautorizadoreembolso', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
                 <div id="rechazados" class="tab-pane cont">
                   <?php echo $__env->make('valerendirreembolso.ajax.listamodalvalerendirrechazadoautorizadoreembolso', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
