...
<table table id="tablaValeRendirRechazado" class="table table-striped table-borderless" style="font-style: italic;">
  <thead style="background-color: #1d3a6d; color: white;">
    ...
    <?php if($item['TXT_CATEGORIA_ESTADO_VALE'] === 'RECHAZADO' && strtoupper(trim($item['USUARIO_LOGUEADO'])) === strtoupper(trim($usuario_merge))): ?>
        ...
        <tr data_vale_rendir="<?php echo e($item['ID']); ?>">
            ...
            <td class="align-middle text-center">
              <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                    ...
                    <?php else: ?>
                        <span class="badge badge-custom-danger mb-4"><?php echo e($item['TXT_CATEGORIA_ESTADO_VALE']); ?></span>
                    <?php endif; ?>
