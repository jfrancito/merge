...
<?php $__env->startSection('section'); ?>
  <div class="be-content contenido cfedocumento">
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                          ...
                          <div class='row'>
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                  <div class="form-group">
                                    <label class="col-sm-12 control-label labelleft negrita" >Pago :</label>
                                    <div class="col-sm-12 abajocaja" >
                                      <?php echo Form::select( 'operacion_id', $combo_operacion, $operacion_id,
                                                        [
                                                          'class'       => 'select2 form-control control input-xs combo' ,
                                                          'id'          => 'operacion_id',
                                                          'data-aw'     => '1',
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('entregadetraccion.ajax.mergelistadetraccion', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
    ...
    <?php echo $__env->make('entregadetraccion.modal.mregistrorequerimiento', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('script'); ?>
  ...
  <script src="<?php echo e(asset('public/js/comprobante/entregabledetraccion.js?v='.$version)); ?>" type="text/javascript"></script>
