...
<html lang="<?php echo e(app()->getLocale()); ?>">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/meta.css?v='.$version.'.'.time())); ?> "/>
  ...
  <body class='fuente-muktabold libre-baskerville-regular'>
    ...
    <script src="<?php echo e(asset('public/js/general/gmeta.js?v='.$version.'.'.time())); ?>" type="text/javascript"></script>
