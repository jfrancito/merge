...
<?php $__env->startSection('section'); ?>
    <div class="be-content valerendirprincipal">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-default panel-table">
                        <div class="panel-heading">Lista Vale a Rendir - Autoriza
                        </div>
                           <div class='listajax'>    
                                <?php echo $__env->make('valerendirreembolso.ajax.listamodalvalerendirautorizareembolso', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
                    </div>
                </div>
            </div>
        ...
        <?php echo $__env->make('valerendirreembolso.modal.detallerendirreembolso', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content shadow-lg border-0 rounded-3" 
              ...
              <div class="modal-header py-2" 
                   style="background: linear-gradient(135deg, #dc3545, #c82333); color: white; border-top-left-radius: 15px; border-top-right-radius: 15px;">
                <h5 class="modal-title d-flex align-items-center" id="glosaModalLabel" style="font-size: 1.9rem;">
                  <i class="mdi mdi-alert-circle-outline mr-2"></i> Motivo de Rechazo
                </h5>
              ...
              <div class="modal-body pb-2 px-3">
                <div class="alert shadow-sm p-3 mb-0" 
                     style="background-color: #ffffff; color: #721c24; border-left: 4px solid #dc3545; border-radius: 8px;">
                  <strong class="d-block mb-2">Motivo:</strong>
                  <p id="glosaRechazoMessage" class="mb-0" 
...
<script src="<?php echo e(asset('public/js/valerendirreembolso/valerendirreembolso.js?v='.$version)); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
