                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'anio_asiento', isset($array_anio) ? $array_anio : [], '',
                                                  [
                                                    'class'       => 'slim',
                                                    'id'          => 'anio_asiento',
                                                    'data-aw'     => '1'
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ajax_anio_asiento">
                        <div class="form-group">
                            <label class="col-sm-12 control-label labelleft negrita">Periodo
                                :</label>
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'periodo_asiento', isset($array_periodo) ? $array_periodo : [], '',
                                                  [
                                                    'class'       => 'slim',
                                                    'id'          => 'periodo_asiento',
                                                    'data-aw'     => '2',
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'moneda_asiento', isset($combo_moneda_asiento) ? $combo_moneda_asiento : [], '',
                                                  [
                                                    'class'       => 'slim',
                                                    'id'          => 'moneda_asiento',
                                                    'data-aw'     => '4',
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'tipo_asiento', isset($combo_tipo_asiento) ? $combo_tipo_asiento : [], '',
                                                  [
                                                    'class'       => 'slim',
                                                    'id'          => 'tipo_asiento',
                                                    'data-aw'     => '7',
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'tipo_documento_asiento', isset($combo_tipo_documento) ? $combo_tipo_documento : [], '',
                                                  [
                                                    'class'       => 'slim',
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'tipo_documento_ref', isset($combo_tipo_documento) ? $combo_tipo_documento : [], '',
                                                  [
                                                    'class'       => 'slim',
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte">
                    <div class="form-group">
                        <label class="col-sm-12 control-label labelleft negrita">Tipo
                            ...
                            :</label>
                        <div class="col-sm-12 abajocaja">
                            <?php echo Form::select( 'tipo_descuento_asiento', isset($combo_descuento) ? $combo_descuento : [], '',
                                              [
                                                'class'       => 'slim',
                    ...
                    <div class="col-md-12" style="background: white;">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja">
                                    <?php echo Form::select( 'nivel', isset($combo_nivel_pc) ? $combo_nivel_pc : [], '6',
                                                      [
                                                        'class'       => 'slim' ,
                                                        'id'          => 'nivel',
                                                        'data-aw'     => '1',
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja">
                                    <?php echo Form::select( 'partida_id', isset($combo_partida) ? $combo_partida : [], '',
                                                      [
                                                        'class'       => 'slim' ,
                                                        'id'          => 'partida_id',
                                                        'data-aw'     => '2',
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 ajax_nivel">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja">
                                    <?php echo Form::select( 'cuenta_contable_id', isset($combo_cuenta) ? $combo_cuenta : [], '',
                                                      [
                                                        'class'       => 'slim' ,
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja">
                                    <?php echo Form::select( 'tipo_igv_id', isset($combo_tipo_igv) ? $combo_tipo_igv : [], '',
                                                      [
                                                        'class'       => 'slim' ,
                                                        'id'          => 'tipo_igv_id',
                                                        'data-aw'     => '4'
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja">
                                    <?php echo Form::select( 'porc_tipo_igv_id', isset($combo_porc_tipo_igv) ? $combo_porc_tipo_igv : [], '',
                                                      [
                                                        'class'       => 'slim' ,
                                                        'id'          => 'porc_tipo_igv_id',
                                                        'data-aw'     => '4'
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja">
                                    <?php echo Form::select( 'activo', isset($combo_activo) ? $combo_activo : [], '1',
                                                      [
                                                        'class'       => 'slim' ,
                                                        'id'          => 'activo',
                                                        'data-aw'     => '5',
