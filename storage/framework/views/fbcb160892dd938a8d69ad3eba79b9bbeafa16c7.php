                      ...
                      <td class="rigth">
                        <div class="btn-group btn-hspace">
                          ...
                          <ul role="menu" class="dropdown-menu pull-right">
                            <li>
                              <a href="<?php echo e(url('/aprobar-comprobante-administracion-pg/'.$idopcion.'/'.$item->DOCUMENTO_ITEM.'/'.substr($item->ID_DOCUMENTO, 0,7).'/'.Hashids::encode(substr($item->ID_DOCUMENTO, -9)))); ?>">
