            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Comprobante Reparable<span
                                    class="panel-subtitle">Comprobante Reparable</span></div>
                        <div class="panel-body">
                            <?php if($fedocumento->IND_REPARABLE==2 && $rol->ind_uc != 1): ?>
                                <div class="tab-container">
                                    ...
                                    <div class="tab-content">
                                        <div id="aprobar" class="tab-pane active cont">
                                            <div class="panel panel-default panel-border-color panel-border-color-primary">
                                                <div class="panel-heading panel-heading-divider">Aprobar Comprobante
                                                    Reparable<span class="panel-subtitle">Aprobar un Comprobante Contabilidad</span>
                                                </div>
                                                <div class="panel-body">
                                                    <form method="POST" id='formpedidoreparable'
                                                          action="<?php echo e(url('/aprobar-comprobante-contabilidad-reparable/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>"
                                                        ...
                                                        <?php echo $__env->make('comprobante.form.formaprobarcontreparable', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                        <div class="row xs-pt-15">
                                                            ...
                                                            <div class="col-xs-6">
                                                                <p class="text-right">
                                                                    <a href="<?php echo e(url('/gestion-de-comprobantes-reparable/'.$idopcion)); ?>">
                                                                        <button type="button"
                                                                    ...
                                                                    <button type="button"
                                                                            class="btn btn-space btn-primary btnaprobarcomporbatntereparable">
                                                                        Guardar
                                                                    </button>
                                                                </p>
                                                            </div>
                                        ...
                                        <div id="observar" class="tab-pane cont">
                                            <div class="panel panel-default panel-border-color panel-border-color-primary">
                                                <div class="panel-heading panel-heading-divider">Observar
                                                    Comprobante<span class="panel-subtitle">Observar un Comprobante Reparable</span>
                                                </div>
                                                <div class="panel-body">

                                                    <form method="POST" id='formpedidoobservar'
                                                          action="<?php echo e(url('/agregar-observacion-contabilidad-reparable/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>"
                                                          style="border-radius: 0px;"
                                                          class="form-horizontal group-border-dashed">
                                                        <?php echo e(csrf_field()); ?>
                                                        ...
                                                        <?php echo $__env->make('comprobante.form.formobservarreparable', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                        <div class="row xs-pt-15">
                                                            <div class="col-xs-6">
                                                                <div class="be-checkbox">
                            ...
                            <?php else: ?>
                                ...
                                <form method="POST" id='formpedido'
                                      action="<?php echo e(url('/reparable-comprobante-uc/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>"
                                    ...
                                    <?php echo $__env->make('comprobante.form.formmitigarreparable', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </form>
...
*/
        ...
        <?php $__currentLoopData = $archivospdf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            nombre_archivo = '<?php echo e($item->NOMBRE_ARCHIVO); ?>';
                ...
                initialPreviewConfig: [
                    {
                        ...
                        downloadUrl: "<?php echo e(route('serve-file', ['file' => ''])); ?>" + nombre_archivo
