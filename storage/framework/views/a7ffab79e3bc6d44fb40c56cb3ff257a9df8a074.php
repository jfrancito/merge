<div class="panel panel-default panel-table">
    ...
    <div class="panel-body selectfiltro">
        <div class="filtrotabla">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja">
                                    <?php echo Form::select('cliente_select', $listausuarios, $usuario_autoriza_predeterminado, [
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja">
                                    <?php echo Form::select('tipo_motivo', $listausuarios2, '', [
                                        'class'   => 'form-control control select2',
                                        'id'      => 'tipo_motivo',
                                        'data-aw' => '1'
                                    ]); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja">
                                    <?php echo Form::select('cod_moneda', $listausuarios4, '', [
                                        'class'   => 'form-control control select2',
                                        'id'      => 'cod_moneda',
                                        'data-aw' => '1'
                                    ]); ?>
            ...
            <div class="container">
                ...
                <div id="vale_rendir_detalle" style="display: none;">
                    ...
                    <div class="row" style="gap:15px; flex-wrap:wrap; align-items:flex-start;">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 input-group xs-mb-12">
                                    <?php echo Form::select('destino', $listausuarios3, '', [
                                        'class'   => 'form-control control select2',
                                        'id'      => 'destino',
                                        'data-aw' => '1',
                                        'style'   => 'height:38px'
                        ...
                        <!-- Hidden Inputs -->
                        <input type="hidden" id="nom_centro" value="<?php echo e($nom_centro); ?>">
                        <input type="hidden" id="importeDestinos" value="<?php echo e(json_encode($importeDestinos)); ?>">
                       ...
                       <div class="col-xs-12">
                         ...
                         <?php echo $__env->make('valerendir.ajax.listamodaldetalleregistroimporte', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="listajax">
                <?php echo $__env->make('valerendir.ajax.listamodalvalerendir', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
