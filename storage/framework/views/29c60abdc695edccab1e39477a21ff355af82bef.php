...
<body>
    ...
    <div class="pagina salto">
        <p class="empresa"><?php echo e($nom_empr); ?></p>
        <hr class="linea-solida">
        <h1><?php echo e($txt_categoria_operacion_caja); ?> - CAJA</h1>
        <p class="voucher">Voucher N° <?php echo e($cod_operacion_caja); ?></p>

        <table>
            <tr>
                <td class="label">Caja/Bancos:</td>
                <td class="value"><?php echo e($txt_categoria_moneda); ?> / <?php echo e($txt_caja_banco); ?></td>
                <td class="label">Fecha Operación:</td>
                <td><?php echo e($fec_operacion); ?></td>
            </tr>
            <tr>
                <td class="label">Titular:</td>
                <td class="value"><?php echo e($txt_empr_afecta); ?></td>
                <td class="label">Fecha Registro:</td>
                <td><?php echo e($fec_operacion); ?></td>
            </tr>
            <tr>
                <td class="label">Cuenta:</td>
                <td class="value"><?php echo e($cod_cultivo_afecta); ?></td>
                <td class="label">Medio Pago:</td>
                <td><?php echo e($txt_categoria_medio_pago); ?></td>
            </tr>
            <tr>
                <td class="label">Cheque:</td>
                <td class="value"><?php echo e($nro_cheque); ?></td>
                <td class="label">Moneda:</td>
                <td><?php echo e($txt_categoria_moneda); ?></td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                ...
                <td><?php echo e($txt_caja_banco); ?></td>
            </tr>
            <tr>
                <td class="label">Glosa:</td>
                <td class="glosa"><?php echo nl2br(e($txt_glosa)); ?></td>
            </tr>
            <tr>
                <td class="label">Descripción:</td>
                <td><?php echo e($txt_descripcion); ?></td>
            </tr>
            <tr>
                <td class="label">
                    <?php if($cod_categoria_moneda == "MON0000000000001"): ?>
                        <?php if($can_debe_mn != 0): ?>
                            Importe:
                        <?php else: ?>
                            Pago:
                        <?php endif; ?>
                    <?php else: ?>
                        <?php if($can_debe_me != 0): ?>
                            Importe:
                        <?php else: ?>
                            Pago:
                        <?php endif; ?>
                ...
                <td>
                    <?php if($cod_categoria_moneda == "MON0000000000001"): ?>
                        <?php if($can_debe_mn != 0): ?>
                            <?php  $importe = $can_debe_mn;  ?>
                            S/. <?php echo e(number_format($importe, 2)); ?>

                        <?php else: ?>
                            <?php  $importe = $can_haber_mn;  ?>
                            S/. <?php echo e(number_format($importe, 2)); ?>

                        <?php endif; ?>
                    <?php else: ?>
                        <?php if($can_debe_me != 0): ?>
                            <?php  $importe = $can_debe_me;  ?>
                            $. <?php echo e(number_format($importe, 2)); ?>

                        <?php else: ?>
                            <?php  $importe = $can_haber_me;  ?>
                            $. <?php echo e(number_format($importe, 2)); ?>
            ...
            <tr>
                ...
                <td><?php echo e($texto_importe); ?></td>
            </tr>
        </table>

        <div class="firma">
            <div class="linea-firma"></div>
            <p><?php echo e($txt_empr_afecta); ?></p>
            <p>DNI: <?php echo e($nro_doc); ?></p>
        </div>
    </div>

<!-- SEGUNDA PAGINA -->
    <div class="pagina">
        <div class="empresa"><?php echo e($nom_empr); ?></div>
        <hr class="linea-solida">
    ...
    <table style="width:100%; margin-top:15px; font-size:11px; border-collapse:collapse;">
        ...
        <tr>
            ...
            <td style="text-align:right; white-space:nowrap; font-size:12px;">
                <?php echo e(\App\Helpers\NumeroALetras::fechaBonita($fec_operacion)); ?>
        ...
        <div style="margin-top:20px; font-size:12px;">
            ...
            <strong style="font-weight:bold;"><?php echo e($txt_empr_afecta); ?></strong>
        </span>
        </div>
        ...
        <!-- DNI -->
            ...
            <span style="display:inline-block; border-bottom:1px dotted #000; width:40%; text-align:center;">
                <strong style="font-weight:bold; font-size:13px;" ><?php echo e($nro_doc); ?></strong>
            </span> ,
                 ...
                 <strong style="font-weight:bold;">
                  <?php if($cod_categoria_moneda == "MON0000000000001"): ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php echo e($txt_categoria_moneda); ?>
        ...
        <table style="width:100%; margin-top:30px; border-collapse:collapse;">
            <tr>
                ...
                <td style="width:70%; text-align:center; vertical-align:bottom; padding-right:10px;">
                    ...
                    <p style="margin:0;"><?php echo e($txt_empr_afecta); ?></p>
                    <p style="margin:0;">DNI: <?php echo e($nro_doc); ?></p>
                </td>
