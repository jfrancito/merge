                    ...
                    <tr>
                        <td style="padding: 50px 50px 40px 50px; color: #4a4a4a; line-height: 1.8;">
                            <p style="font-size: 18px; margin-bottom: 30px; color: #1f2a50;">
                                Estimado(a), <strong><?php echo e($manager_name); ?></strong>
                            </p>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="40%" style="padding-bottom: 15px;">
                                                    ...
                                                    <div style="font-size: 18px; color: #1e293b; font-weight: 800;"><?php echo e($pedido_id); ?></div>
                                                </td>
                                                <td width="60%" style="padding-bottom: 15px;">
                                                    ...
                                                    <div style="font-size: 15px; color: #1e293b; font-weight: 600;"><?php echo e($solicita_name); ?></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="border-top: 1px solid #e2e8f0; padding-top: 15px;">
                                                    ...
                                                    <div style="font-size: 14px; color: #334155; font-style: italic;"><?php echo e($glosa ?: 'Sin detalles adicionales'); ?></div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td style="background-color: #f8fafc; padding: 30px; text-align: center; border-top: 1px solid #e2e8f0;">
                            ...
                            <p style="margin: 10px 0 0 0; font-size: 11px; color: #94a3b8; font-weight: 700;">
                                &copy; <?php echo e(date('Y')); ?> INDUAMERICA. All Rights Reserved.
                            </p>
                        </td>
                    </tr>
                </table>
