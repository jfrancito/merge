            ...
            <div class="col-sm-12">
                <div class="panel panel-default panel-border-color panel-border-color-success">
                    ...
                    <div class="panel-body">
                      <?php echo $__env->make('comprobante.lista.detallecomprobanteadministradorcontrato', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
   ...
   <script src="<?php echo e(asset('public/lib/jquery.niftymodals/dist/jquery.niftymodals.js')); ?>" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        <?php $__currentLoopData = $array_guias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            ...
            $("#file-<?php echo e($item['COD_DOCUMENTO_CTBLE']); ?>").fileinput({
              theme: 'fa5',
              language: 'es',
