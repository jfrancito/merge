                ...
                <div class="col-sm-12">
                    ...
                    <div class="tab-container">
                      <ul class="nav nav-tabs">
                        ...
                        <li><a href="#valependiente" data-toggle="tab"><b>VALES PENDIENTES (<?php echo e(count($listarValePendientes)); ?>)</b></a></li>
                        <li><a href="#liquidaciones" data-toggle="tab"><b>LIQUIDACIONES SIN PROCESAR (<?php echo e(count($listarLiquidacionesPendientes)); ?>)</b></a></li>
                        <li><a href="#documentos" data-toggle="tab"><b>DOCUMENTOS CDR/XML (<?php echo e(count($listarDocumentoXML_CDR)); ?>)</b></a></li>
                         <li><a href="#listanegra" data-toggle="tab"><b>PROVEEDORES LISTA NEGRA (<?php echo e(count($listarlistanegra)); ?>)</b></a></li>
                      </ul>
                      <div class="tab-content">
                        <div id="crearvale" class="tab-pane active cont">
                            <?php echo $__env->make('valerendir.tab.creartab', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                        <div id="valependiente" class="tab-pane cont">
                            <?php echo $__env->make('valerendir.ajax.listamodalvalespendientes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
                        </div>
                        <div id="liquidaciones" class="tab-pane cont">
                            <?php echo $__env->make('valerendir.ajax.listamodalliquidacionessinprocesar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
                        </div>
                        <div id="documentos" class="tab-pane cont">
                            <?php echo $__env->make('valerendir.ajax.listamodaldocumentos_xml_cdr', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
                        </div>
                         <div id="listanegra" class="tab-pane cont">
                            <?php echo $__env->make('valerendir.ajax.listamodallistanegraproveedores', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
                        </div>
                      </div>
                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        var importeDestinos = <?php echo json_encode($importeDestinos, JSON_UNESCAPED_UNICODE); ?>;
        var areacomercial = <?php echo json_encode(strtoupper($areacomercial ?? '')); ?>;
    </script>
    ...
    <script src="<?php echo e(asset('public/js/vale/valerendir.js?v='.$version)); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
