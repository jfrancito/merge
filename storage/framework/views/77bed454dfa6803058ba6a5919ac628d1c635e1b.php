                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'anio_asiento_reparable', $array_anio, '',
                                                  [
                                                    'class'       => 'slim',
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ajax_anio_asiento_reparable">
                        <div class="form-group">
                            <label class="col-sm-12 control-label labelleft negrita">Periodo
                                :</label>
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'periodo_asiento_reparable', $array_periodo, '',
                                                  [
                                                    'class'       => 'slim',
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'moneda_asiento_reparable', $combo_moneda_asiento, 'MON0000000000001',
                                                  [
                                                    'class'       => 'slim',
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'tipo_asiento_reparable', $combo_tipo_asiento, '',
                                                  [
                                                    'class'       => 'slim',
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'tipo_documento_asiento_reparable', $combo_tipo_documento, '',
                                                  [
                                                    'class'       => 'slim',
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'tipo_documento_ref_reparable', $combo_tipo_documento, '',
                                                  [
                                                    'class'       => 'slim',
