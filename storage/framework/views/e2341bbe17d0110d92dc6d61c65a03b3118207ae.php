            ...
            <ul role="menu" class="dropdown-menu pull-right">
              <li>
                <?php if(ltrim(rtrim($item->COD_ESTADO)) == ''): ?> 
                    <a href="<?php echo e(url('/detalle-comprobante-contrato-proveedor/'.$procedencia.'/'.$idopcion.'/'.substr($item->COD_DOCUMENTO_CTBLE, 0,7).'/'.Hashids::encode(substr($item->COD_DOCUMENTO_CTBLE, -9)))); ?>">
                      Registro XML
                    </a>
                <?php else: ?>
                  ...
                  <?php endif; ?>
                <?php endif; ?>
                <a href="<?php echo e(url('/descargar-comprobante-contrato-proveedor/'.$procedencia.'/'.$idopcion.'/'.substr($item->COD_DOCUMENTO_CTBLE, 0,7).'/'.Hashids::encode(substr($item->COD_DOCUMENTO_CTBLE, -9)))); ?>">
                  Descargar Contrato
                </a>
