              ...
              <div class="panel panel-default panel-border-color panel-border-color-success">
                ...
                <div class="panel-body">
                 <div class='filtrotabla row'>
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('comprobante.ajax.mergelistaareaadministracion', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('script'); ?>
  ...
  <script src="<?php echo e(asset('public/js/comprobante/administracion.js?v='.$version)); ?>" type="text/javascript"></script>
