                            ...
                            <div class='filtrotabla row'>
                                <div class="col-xs-12">
                                    ...
                                    <form method="POST"
                                          id="formdescargar"
                                          target="_blank"
                                          action="<?php echo e(url('/obtener-reporte-compras-envases-sede-excel')); ?>"
...
<input type="hidden" name="device_info" id='device_info'>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 cajareporte">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <?php echo Form::select( 'empresas', $combo_empresa, $empresa_defecto,
                                                                      [
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 cajareporte">
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label labelleft negrita">FAMILIA
                                                    :</label>
                                                <div class="col-sm-12 abajocaja">
                                                    <?php echo Form::select( 'familia', $combo_familia, $familia_defecto,
                                                                      [
                                                                        'class'       => 'select2 form-control control input-xs' ,
                                                                        'id'          => 'familia',
                                                                        'data-aw'     => '4'
                            ...
                            <div class='listajax'>
                                <?php echo $__env->make('reporte.logistica.ajax.alistareportecomprasenvasessede', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/reporte/reportecomprasenvasessede.js?v='.$version)); ?>"
            type="text/javascript"></script>
