                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000010394'): ?> panel-border-color-danger <?php else: ?> <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000007086'): ?> panel-border-color-success <?php else: ?> panel-border-color-info <?php endif; ?> <?php endif; ?>">
                        <div class="panel-heading">CUENTAS POR COBRAR / PAGAR - SALDOS
                            ...
                            <span class="panel-subtitle"><?php echo e(Session::get('empresas')->NOM_EMPR); ?> </span>
                            ...
                            <div class='filtrotabla row'>
                                <div class="col-xs-12">
                                    ...
                                    <form method="POST"
                                          id="formdescargar"
                                          target="_blank"
                                          action="<?php echo e(url('/obtener-reporte-cuentas-saldo-excel')); ?>"
...
<input type="hidden" name="device_info" id='device_info'>
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <?php echo Form::select( 'centro', $combo_centro, array(),
                                                                      [
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <?php echo Form::select( 'tipocontrato', $combo_tipo_contrato, array(),
                                                                      [
                                                                        'class'       => 'select2 form-control control input-xs' ,
                                                                        'id'          => 'tipocontrato',
                                                                        'data-aw'     => '2',
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <input type="number"
                                                           ...
                                                           data-aw="1"
                                                           value="<?php echo e($tipo_cambio->CAN_VENTA); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <input type="number"
                                                           ...
                                                           class="form-control input-sm"
                                                           data-aw="1"
                                                           value="<?php echo e($tipo_cambio->CAN_COMPRA); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class='listajax'>
                                <?php echo $__env->make('reporte.administracion.ajax.alistareportecuentasaldo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/reporte/reportecuentasaldo.js?v='.$version)); ?>" type="text/javascript"></script>
