    ...
    <?php 
     ...
     ?>
        <tr>
            ...
            <td style="text-align: right;"><?php echo e(isset($result["CHICLAYO"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($result["RIOJA"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($result["BELLAVISTA"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($result["MPSA"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($result["VES"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($result["ADUANAS"]["STK_50"]) ? 
                                            number_format($result["ADUANAS"]["STK_50"], 2, '.', '') : '0.00'); ?></td>
            <td style="text-align: right;"><?php echo e(isset($result["ADUANAS"]["COSTO_TOTAL"]) ? 
                                            number_format($result["ADUANAS"]["COSTO_TOTAL"], 2, '.', '') : '0.00'); ?></td> 
            <td style="text-align: right;"><?php echo e(isset($result["EN TRANSITO"]["STK_50"]) ? 
                                            number_format($result["EN TRANSITO"]["STK_50"], 2, '.', '') : '0.00'); ?></td>
            <td style="text-align: right;"><?php echo e(isset($result["EN TRANSITO"]["COSTO_TOTAL"]) ? 
    ...
    <?php    
     ...
     ?>    
         ...
         <tr>
            ...
            <td style="text-align: right;"><?php echo e(isset($totales["CHICLAYO"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($totales["RIOJA"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($totales["BELLAVISTA"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($totales["MPSA"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($totales["VES"]["STK_50"]) ? 
            ...
            <td style="text-align: right;"><?php echo e(isset($totales["ADUANAS"]["STK_50"]) ? 
                                            number_format($totales["ADUANAS"]["STK_50"], 2, '.', '') : '0.00'); ?></td>
            <td style="text-align: right;"><?php echo e(isset($totales["ADUANAS"]["COSTO_TOTAL"]) ? 
                                            number_format($totales["ADUANAS"]["COSTO_TOTAL"], 2, '.', '') : '0.00'); ?></td> 
            <td style="text-align: right;"><?php echo e(isset($totales["EN TRANSITO"]["STK_50"]) ? 
                                            number_format($totales["EN TRANSITO"]["STK_50"], 2, '.', '') : '0.00'); ?></td>
            <td style="text-align: right;"><?php echo e(isset($totales["EN TRANSITO"]["COSTO_TOTAL"]) ? 
    ...
    <?php 
     ...
     ?>
        <tr>
            ...
            <td style="text-align: right;"><?php echo e(isset($result["BELLAVISTA"]["COSTO_TOTAL"]) ? 
                                            number_format($result["BELLAVISTA"]["COSTO_TOTAL"], 2, '.', '') : '0.00'); ?></td>  
            <td style="text-align: right;"><?php echo e(isset($result["LIMA"]["STK_50"]) ? 
    ...
    <?php   
     ...
     ?>    
         ...
         <tr>
            ...
            <td style="text-align: right;"><?php echo e(isset($totales["BELLAVISTA"]["COSTO_TOTAL"]) ? 
                                            number_format($totales["BELLAVISTA"]["COSTO_TOTAL"], 2, '.', '') : '0.00'); ?></td>  
            <td style="text-align: right;"><?php echo e(isset($totales["LIMA"]["STK_50"]) ? 
