<form method="POST" id='formpedido' action="<?php echo e(url('/pago-comprobante-tesoreria-estiba/'.$idopcion.'/'.$linea.'/'.$fedocumento->ID_DOCUMENTO)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
