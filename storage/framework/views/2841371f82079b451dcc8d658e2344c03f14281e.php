                ...
                <div class="panel panel-default panel-border-color panel-border-color-success">
                    <div class="panel-heading">
                      ...
                      <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="menudespacho"
                              ...
                              <li>
                                <a href="<?php echo e(url('/comprobante-masivo-excel-op')); ?>" 
                                   class='tn btn-secondary botoncabecera tooltipcss opciones'
                                   target="_blank"
                                   id="descargarcomprobantemasivoexcelop" 
                                   data-href="<?php echo e(url('/comprobante-masivo-excel-op')); ?>"
                               ...
                               <li>
                                <a href="<?php echo e(url('/pedido-masivo-excel-op')); ?>" 
                                   class='tn btn-secondary botoncabecera tooltipcss opciones'
                                   target="_blank"
                                   id="descargarpedidomasivoexcelop" 
                                   data-href="<?php echo e(url('/pedido-masivo-excel-op')); ?>"
                                   title="Descargar excel" style="width:100%">
                                   <span class="tooltiptext">Descargar excel pedido</span>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive listajax" style="margin-top: 20px;">
                            <?php echo $__env->make('ordenpedido.reporte.alistareporteordenpedido', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
