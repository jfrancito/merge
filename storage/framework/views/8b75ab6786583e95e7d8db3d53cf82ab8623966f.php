...
<body>
    ...
    <div class="debug-info" style="display:none;">
        ...
        &nbsp;&nbsp;• Existe: <?php echo e($debug['archivo_existe'] ? '✅ SÍ' : '❌ NO'); ?><br>
        &nbsp;&nbsp;• Legible: <?php echo e($debug['es_legible'] ? '✅ SÍ' : '❌ NO'); ?><br>
        &nbsp;&nbsp;• Tamaño: <span style="color: #28a745;"><?php echo e(number_format($debug['tamaño'])); ?> bytes (<?php echo e(number_format($debug['tamaño'] / 1024 / 1024, 2)); ?> MB)</span><br><br>
        
        <strong>🌐 URLs y Rutas:</strong><br>
        &nbsp;&nbsp;• URL pública: <a href="<?php echo e($debug['ruta_publica']); ?>" target="_blank"><?php echo e($debug['ruta_publica']); ?></a><br>
        &nbsp;&nbsp;• Ruta física: <code><?php echo e($debug['ruta_fisica']); ?></code><br>
        &nbsp;&nbsp;• Permisos: <code><?php echo e($debug['permisos']); ?></code><br><br>
        
        <strong>🔧 Diagnóstico:</strong><br>
        &nbsp;&nbsp;• Servidor: Laravel <?php echo e(app()->version()); ?> en <?php echo e(PHP_OS); ?><br>
        &nbsp;&nbsp;• PHP: <?php echo e(PHP_VERSION); ?><br>
        &nbsp;&nbsp;• User Agent: <span id="userAgent">Detectando...</span><br><br>
        
        <strong>💡 Acciones de prueba:</strong><br>
        &nbsp;&nbsp;1. <a href="<?php echo e($debug['ruta_publica']); ?>" target="_blank" style="color: #007bff; font-weight: bold;">🎬 Abrir video directamente</a><br>
    ...
    <div class="main-container">
        <div class="video-wrapper">
            ...
            <!-- Video o Error -->
            <?php if(isset($infoVideo) && $infoVideo['existe']): ?>
                <!-- Video Container -->
                <div class="video-container" id="videoContainer">
                    <video 
                        ...
                        data-src="<?php echo e($rutaVideo); ?>"
                    >
                        <source src="<?php echo e($rutaVideo); ?>#t=0.1" type="video/mp4">
                        <source src="<?php echo e($rutaVideo); ?>" type="video/mp4">
                        <source src="<?php echo e($rutaVideo); ?>" type="video/webm">
                        <p>
                            Tu navegador no soporta el elemento video HTML5.<br>
                            <a href="<?php echo e($rutaVideo); ?>" target="_blank" style="color: #007bff;">👉 Descargar y ver video externamente</a>
                        </p>
                    </video>
                ...
                <div class="video-info" style="display: none;">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo e($infoVideo['nombre']); ?></div>
                        </div>
                        <div class="info-item">
                            <i class="fa fa-hdd-o"></i>
                            <div class="info-label">Tamaño</div>
                            <div class="info-value"><?php echo e(number_format($infoVideo['tamaño'] / 1024 / 1024, 2)); ?> MB</div>
                        </div>
                        <div class="info-item">
                ...
                <div class="video-controls" style="display: none;">
                    ...
                    <a href="<?php echo e($rutaVideo); ?>" download="<?php echo e($infoVideo['nombre']); ?>" class="btn-custom">
            ...
            <?php else: ?>
                ...
                <div class="video-error">
                    ...
                    <p><strong>Archivo esperado:</strong> <code><?php echo e(public_path('firmas/liquidaciongastos.mp4')); ?></code></p>
                    <p><strong>Tamaño esperado:</strong> Mayor a 0 bytes</p>
                    <a href="<?php echo e(url()->current()); ?>" class="btn-retry">
                        <i class="fa fa-refresh"></i> Reintentar Carga
                    </a>
                </div>
            <?php endif; ?>
    ...
    <script>
        ...
        let debugMode = <?php echo e(config('app.debug') ? 'true' : 'false'); ?>;
        ...
        async function testVideoUrl() {
            const videoUrl = '<?php echo e($rutaVideo); ?>';
        ...
        function downloadVideo() {
            ...
            link.href = videoUrl;
            link.download = '<?php echo e($infoVideo["nombre"] ?? "liquidaciongastos.mp4"); ?>';
