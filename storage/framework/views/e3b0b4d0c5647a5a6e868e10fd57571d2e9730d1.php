            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Lista de Roles
                  <div class="tools">
                    <a href="<?php echo e(url('/agregar-rol/'.$idopcion)); ?>" data-toggle="tooltip" data-placement="top" title="Crear Rol">
                          ...
                          <td class="rigth">
                            <div class="btn-group btn-hspace">
                              ...
                              <ul role="menu" class="dropdown-menu pull-right">
                                <li>
                                  <a href="<?php echo e(url('/modificar-rol/'.$idopcion.'/'.Hashids::encode(substr($item->id, -8)))); ?>">
                                    Modificar
                                  </a>  
                                </li>
                              </ul>
