                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="<?php echo e(url('/aprobar-comprobante-contabilidad-estiba-oca/'.$idopcion.'/'.$lote)); ?>"
                                                ...
                                                <?php echo $__env->make('comprobante.form.formaprobarcontestibamoca', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
                ...
                initialPreviewConfig: [
                    {
                        ...
                        downloadUrl: "<?php echo e(route('serve-fileordencompraanticipo', ['file' => ''])); ?>" + nombre_archivo
        ...
        let initialPreview = <?php echo $initialPreview; ?>;
        let initialPreviewConfig = <?php echo $initialPreviewConfig; ?>;
        $("#input-24").fileinput({
