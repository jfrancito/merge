        ...
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">PENDIENTES
            ...
            <div class="chart-legend">
              <a href="<?php echo e(url($urllqa)); ?>" class="btn btn-rounded btn-space btn-primary dasboark">Ir Aprobar</a>
            </div>
            <span class="count-das"><?php echo e($count_x_aprobar_lqa); ?></span>
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-12 col-md-4">
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">OBSERVADOS
            ...
            <div class="chart-legend">
              <a href="<?php echo e(url($urllqa.'&tab_id=observado')); ?>" class="btn btn-rounded btn-space btn-primary dasboark">Ir Observados</a>
            </div>
            <span class="count-das"><?php echo e($count_observados_lqa); ?></span>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-md-4">
        <div class="panel panel-default panel-contrast">
          <div class="panel-heading" style="background: #1d3a6d;color: #fff;">OBSERVACIONES LEVANTADAS
            ...
            <div class="chart-legend">
              <a href="<?php echo e(url($urllqa.'&tab_id=observadole')); ?>" class="btn btn-rounded btn-space btn-primary dasboark">Ir Observados</a>
            </div>
            <span class="count-das"><?php echo e($count_observadoslqa_le); ?></span>
          </div>
        </div>
      </div>
      <?php endif; ?>
