                 ...
                 <div class='filtrotabla row'>
                      ...
                      <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                          <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja" >
                              <?php echo Form::select( 'estadopago_id', $combo_estado, array($estadopago_id),
                                                [
                                                  'class'       => 'select2 form-control control input-sm' ,
                                                  'id'          => 'estadopago_id',
                                                  'required'    => '',
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('comprobante.ajax.mergelistatesoreria', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('script'); ?>
  ...
  <script src="<?php echo e(asset('public/js/comprobante/tesoreria.js?v='.$version)); ?>" type="text/javascript"></script>
