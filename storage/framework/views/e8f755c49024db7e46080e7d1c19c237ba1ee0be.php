            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading"><?php echo e($titulo); ?>
                        ...
                        <div class='sec_estiba ocultar'>
                          ...
                          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte ajax_proveedor">
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <?php echo Form::select( 'proveedor_id', $combo_proveedor, array($proveedor_id),
                                                    [
                                                      'class'       => 'select2 form-control control input-sm' ,
                                                      'id'          => 'proveedor_id',
                                                      'required'    => '',
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('comprobante.ajax.mergelistaadministrador', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
