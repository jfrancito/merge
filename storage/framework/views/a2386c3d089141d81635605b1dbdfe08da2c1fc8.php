    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">USUARIO<span class="panel-subtitle">Modificar Usuario : <?php echo e($usuario->nombre); ?></span></div>
          <div class="panel-body">


            <form method="POST" action="<?php echo e(url('/modificar-usuario/'.$idopcion.'/'.Hashids::encode(substr($usuario->id, -8)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed"> 
...
<input type="hidden" name="device_info" id='device_info'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      ...
                      <input  type="text"
                              id="nombre" name='nombre' value="<?php echo e(old('nombre',$usuario->nombre)); ?>" placeholder="Nombre del Personal"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input  type="text"
                          id="name" name='name' value="<?php echo e(old('name',$usuario->name)); ?>" placeholder="Usuario"
                          required = ""
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label">Clave (<?php echo e(Crypt::decrypt($usuario->password)); ?>)</label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <?php echo Form::select( 'rol_id', $comborol, array(),
                                    [
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <div class="be-radio has-success inline">
                    <input type="radio" value='1' <?php if($usuario->activo == 1): ?> checked <?php endif; ?> name="activo" id="rad6">
                    <label for="rad6">Activado</label>
                  </div>
                  <div class="be-radio has-danger inline">
                    <input type="radio" value='0' <?php if($usuario->activo == 0): ?> checked <?php endif; ?> name="activo" id="rad8">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">Perfiles<span class="panel-subtitle">Perfiles del usuario : <?php echo e($usuario->nombre); ?></span></div>
          <div class="panel-body">
                  ...
                  <div class="panel-body listadoperfiles">
                    <table id="tableperfiles" class="table table-striped table-hover table-fw-widget">
                      ...
                      <tbody>
                        ...
                        <?php $__currentLoopData = $empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemempresa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php $__currentLoopData = $centros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemcentro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($itemcentro->COD_CENTRO=='CEN0000000000001'): ?>
                              <tr>
                                <td>
                                  <?php echo e($itemempresa->NOM_EMPR); ?>

                                </td>
                                <td>
                                  <div class="text-center be-checkbox be-checkbox-sm">
                                    <input  type="checkbox"
                                            class="<?php echo e($itemempresa->COD_EMPR); ?><?php echo e($itemcentro->COD_CENTRO); ?>"
                                            id="1<?php echo e($itemempresa->COD_EMPR); ?><?php echo e($itemcentro->COD_CENTRO); ?>"
                                            <?php if($funcion->funciones->tiene_perfil($itemempresa->COD_EMPR,$itemcentro->COD_CENTRO,$usuario->id)): ?> checked <?php endif; ?>
                                    >
                                    <label  for="1<?php echo e($itemempresa->COD_EMPR); ?><?php echo e($itemcentro->COD_CENTRO); ?>"
                                            data-idempresa = "<?php echo e($itemempresa->COD_EMPR); ?>"
                                            data-idcentro = "<?php echo e($itemcentro->COD_CENTRO); ?>"
                                            data_idusuario = "<?php echo e($usuario->id); ?>"
                                            class = "checkbox"                    
                                            name="<?php echo e($itemempresa->COD_EMPR); ?><?php echo e($itemcentro->COD_CENTRO); ?>"
                                      ></label>
                                  </div>
