<div class="panel panel-default box-seccion shadow-soft">
    <div class="panel-heading subheader-seccion">
        <i class="mdi mdi-format-list-bulleted"></i> <?php echo e(isset($es_servicio) && $es_servicio ? 'Servicios de Pedidos Seleccionados' : 'Productos de Consolidados Seleccionados'); ?>

        <div class="pull-right" style="margin-top: -5px;">
             <button class="btn btn-danger btn-sm btn-eliminar-seleccionados shadow-soft" title="Eliminar seleccionados">
                <i class="mdi mdi-delete"></i> <?php echo e(isset($es_servicio) && $es_servicio ? 'Eliminar Servicios' : 'Eliminar Productos'); ?>

            </button>
        </div>
    </div>
    <div class="panel-body">
        <table id="table-productos-seleccionados" class="table table-striped table-hover table-fw-widget listatabla" data-tipo="<?php echo e(isset($es_servicio) && $es_servicio ? 'S' : 'M'); ?>">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(isset($es_servicio) && $es_servicio ? 'ID PEDIDO' : 'ID CONSOLIDADO'); ?></th>
                    <th>CÓDIGO</th>
                    <th>PRODUCTO</th>
                    ...
                    <?php if(!(isset($es_servicio) && $es_servicio)): ?>
                    <th>FAMILIA</th>
                    <?php endif; ?>
                </tr>
            </thead>
            <tbody>
                <?php $__currentLoopData = $lista_detalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php 
                ...
                <tr>
                    <td class="text-center">
                        <div class="be-checkbox be-checkbox-sm inline">
                            <input class="check-producto" type="checkbox" id="check-<?php echo e($cod_producto); ?>-<?php echo e($index); ?>">
                            <label for="check-<?php echo e($cod_producto); ?>-<?php echo e($index); ?>"></label>
                        </div>
                    </td>
                    <td class="text-center"><?php echo e($index + 1); ?></td>
                    <td class="font-bold"><?php echo e($id_pedido_consolidado); ?></td>
                    <td class="text-primary"><?php echo e($cod_producto); ?></td>
                    <td><?php echo e($nom_producto); ?></td>
                    <td class="text-center"><?php echo e($nom_medida); ?></td>
                    <td class="text-center">
                        <?php if($sin_cantidad): ?>
                        ...
                        <?php else: ?>
                            <input type="number" 
                                   ...
                                   value="<?php echo e(number_format($cantidad_val, 2, '.', '')); ?>" 
                                   step="0.01" 
                                   min="0.01"
                                   data-max-cantidad="<?php echo e(isset($item->SALDO_PENDIENTE) ? $item->SALDO_PENDIENTE : $cantidad_val); ?>"
                        ...
                        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px;">
                            <div class="input-group" style="width: 110px; margin: 0;">
                                ...
                                <input type="number" 
                                       ...
                                       value="<?php echo e(number_format($precio, 2, '.', '')); ?>" 
                                       step="0.01" 
                                       min="0"
                                       style="height: 32px !important; font-weight: 700;"
                                       data-cantidad="<?php echo e($cantidad_val); ?>"
                                       data-id-consolidado="<?php echo e($id_pedido_consolidado); ?>"
                                       data-breakdown="<?php echo e(json_encode(isset($item->BREAKDOWN) ? $item->BREAKDOWN : [['id' => $id_pedido_consolidado, 'cant' => $cantidad_val]])); ?>"
                                       data-cod-producto="<?php echo e(trim($cod_producto)); ?>"
                                       data-nom-producto="<?php echo e($nom_producto); ?>"
                                       data-cod-medida="<?php echo e($cod_medida); ?>"
                                       data-nom-medida="<?php echo e($nom_medida); ?>"
                                       data-cod-familia="<?php echo e($cod_familia); ?>"
                                       data-nom-familia="<?php echo e($nom_familia); ?>"
                                       data-precio-compra-anterior="<?php echo e(isset($item->PRECIO_COMPRA_ANTERIOR) ? number_format($item->PRECIO_COMPRA_ANTERIOR, 2, '.', '') : '0.00'); ?>">
                            </div>
                    ...
                    <td class="text-center">
                        <div class="input-group" style="width: 110px; margin: 0 auto;">
                            ...
                            <input type="number" 
                                   ...
                                   value="<?php echo e(number_format($precio * 1.18, 2, '.', '')); ?>" 
                                   step="0.01" 
                                   min="0"
