            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Revision de Comprobante (<?php echo e($cuartacategoria->ID_DOCUMENTO); ?>)</div>
                            ...
                            <div class="tab-content">
                                <div id="aprobar" class="tab-pane active cont">
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        <div class="panel-heading panel-heading-divider">Aprobar 4ta Categoria
                                            Contabilidad<span class="panel-subtitle">Aprobar una 4ta Categoria Contabilidad</span>
                                        </div>
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="<?php echo e(url('/aprobar-renta-cuarta-contabilidad/'.$idopcion.'/'.Hashids::encode(substr($cuartacategoria->ID_DOCUMENTO, -8)))); ?>"
...
<input type="hidden" name="device_info" id='device_info'>
                                                ...
                                                <?php echo $__env->make('cuartacategoria.form.formaprobarcontcc', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                <div class="row xs-pt-15">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <p class="text-right">
                                                            <a href="<?php echo e(url('/gestion-de-aprobar-cuarta-categoria/'.$idopcion)); ?>">
                                                                <button type="button"
                                                                        class="btn btn-space btn-danger btncancelar">
                                                                    Cancelar
                                                                </button>
                                                            </a>
                                                            <button type="button" data-url="<?php echo e(url('/aprobar-renta-cuarta-contabilidad/'.$idopcion.'/'.Hashids::encode(substr($cuartacategoria->ID_DOCUMENTO, -8)))); ?>"
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="POST" id='formpedidorechazar'
                                                  action="<?php echo e(url('/agregar-extorno-contabilidad-rc/'.$idopcion.'/'.Hashids::encode(substr($cuartacategoria->ID_DOCUMENTO, -8)))); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
...
<input type="hidden" name="device_info" id='device_info'>
                                                ...
                                                <?php echo $__env->make('cuartacategoria.form.formrechazocont', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/comprobante/cuartacategoria.js?v='.$version)); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
