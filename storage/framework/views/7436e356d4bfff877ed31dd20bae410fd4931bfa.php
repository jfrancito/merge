                    ...
                    <div class="tab-container">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="ordenpedidoadm" class="tab-pane fade in active cont">
                                <div class='listajax'>    
                                    <?php echo $__env->make('ordenpedido.ajax.alistaordenpedidoapruebaadministracion', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                            </div>
...
<script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        // Inicializar tablas de aprobación administración
        if (typeof inicializarTablasAprobacionAdm === 'undefined') {
            window.inicializarTablasAprobacionAdm = function() {
                var config = {
                    "pageLength": 10,
                ...
                if ($.fn.DataTable.isDataTable('#table-pedidos-adm-pendientes')) {
                    $('#table-pedidos-adm-pendientes').DataTable().destroy();
                }
                if ($.fn.DataTable.isDataTable('#table-pedidos-adm-aprobados')) {
                    $('#table-pedidos-adm-aprobados').DataTable().destroy();
                }
                if ($.fn.DataTable.isDataTable('#table-pedidos-adm-rechazados')) {
                    $('#table-pedidos-adm-rechazados').DataTable().destroy();
                }

                $('#table-pedidos-adm-pendientes, #table-pedidos-adm-aprobados, #table-pedidos-adm-rechazados').dataTable(config);
            };
        }
