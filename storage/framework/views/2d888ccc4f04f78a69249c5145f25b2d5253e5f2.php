                  ...
                  <?php  $NOMBRE_OSIRIS =  $funcion->funciones->cuenta_osiris_lic($item->ID_DOCUMENTO)  ?>
                    <tr data_requerimiento_id = "<?php echo e($item->ID_DOCUMENTO); ?>">
                      ...
                      <td class="cell-detail sorting_1" style="position: relative;">
                        ...
                        <span><b>ZONA : </b> <?php echo e($zona); ?></span>
                      </td>
                      <td class="cell-detail sorting_1" style="position: relative;">
                      ...
                      <td class="cell-detail sorting_1" style="position: relative;">
                        <?php if($item->OPERACION == 'DOCUMENTO_INTERNO_COMPRA'): ?>
                          <span ><b>U. CONTACTO: </b><?php echo e(date_format(date_create($item->fecha_pa), 'd-m-Y h:i:s')); ?></span>
                          <span style="font-size: 18px;"><b>JEFE ACOPIO: </b><?php echo e(date_format(date_create($item->fecha_uc), 'd-m-Y h:i:s')); ?></span>
                        <?php else: ?>
                      ...
                      <td class="rigth">
                        <div class="btn-group btn-hspace">
                          ...
                          <ul role="menu" class="dropdown-menu pull-right">
                            <li>
                              <a href="<?php echo e(url('/aprobar-comprobante-administracion-estiba/'.$idopcion.'/'.$item->ID_DOCUMENTO)); ?>">
