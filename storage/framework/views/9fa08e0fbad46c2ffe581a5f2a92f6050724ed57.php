            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                  ...
                  <div class="tools tooltiptop">
                      <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="menudespacho"
                              ...
                              <li>
                                <a href="<?php echo e(url('/comprobante-masivo-excel-lg')); ?>" 
                                   class='tn btn-secondary botoncabecera tooltipcss opciones'
                                   target="_blank"
                                   id="descargarcomprobantemasivoexcel" 
                                   data-href="<?php echo e(url('/comprobante-masivo-excel-lg')); ?>"
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('liquidaciongasto.ajax.alistalgvalidado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
