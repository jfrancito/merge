            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
              <div class="panel panel-default panel-contrast">
                ...
                <div class="panel-body panel-body-contrast">
                  <form method="POST" action="<?php echo e(url('subir-xml-cargar-datos-contrato-proveedor/'.$idopcion.'/'.substr($ordencompra->COD_DOCUMENTO_CTBLE, 0,7).'/'.Hashids::encode(substr($ordencompra->COD_DOCUMENTO_CTBLE, -9)))); ?>" name="formcargardatos" id="formcargardatos" enctype="multipart/form-data" >
...
<input type="hidden" name="device_info" id='device_info'>
          ...
          <?php if(count($fedocumento)>0): ?>
            <form method="POST" action="<?php echo e(url('validar-xml-contrato-proveedor/'.$idopcion.'/'.substr($ordencompra->COD_DOCUMENTO_CTBLE, 0,7).'/'.Hashids::encode(substr($ordencompra->COD_DOCUMENTO_CTBLE, -9)))); ?>" name="formguardardatos" id="formguardardatos" enctype="multipart/form-data" >
             <?php echo e(csrf_field()); ?>
                    ...
                    <div class="panel-body panel-body-contrast">
                      <table class="table table-condensed table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td><b>Total</b></td>
                              <td><p class='subtitulomerge'><?php echo e(number_format($ordencompra->CAN_TOTAL+$ordencompra->CAN_PERCEPCION, 4, '.', ',')); ?></p></td>
                              <td>
                                <div class='subtitulomerge <?php if($fedocumento->ind_total == 1): ?> msjexitoso <?php else: ?> msjerror <?php endif; ?>'>
                                    <!-- <b><?php echo e(number_format($fedocumento->TOTAL_VENTA_ORIG+$fedocumento->PERCEPCION+$fedocumento->MONTO_RETENCION, 4, '.', ',')); ?></b> -->
...
<!--                                   <?php if($tp->CODIGO_SUNAT == 'CRE'): ?>
                                    A <?php echo e($fedocumento->FORMA_PAGO_DIAS); ?> DIAS
                                  <?php endif; ?> -->
                                </div>
                              </td>
                            </tr>
                                  ...
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 20px;">
                                      ...
                                      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-12 abajocaja" >
                                              <input type="text" name="monto_detraccion" id='monto_detraccion' class="form-control control input-sm importe" value = '<?php echo e($fedocumento->MONTO_DETRACCION); ?>'>
                                          </div>
                                        </div>
                                      </div>
                            ...
                            <div class="row">
                                  ...
                                  <?php $__currentLoopData = $tarchivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                      <div class="form-group sectioncargarimagen">
                                          <label class="col-sm-12 control-label"><b><?php echo e($item->NOM_CATEGORIA_DOCUMENTO); ?> (<?php echo e($item->TXT_FORMATO); ?>)</b></label>
                                          <div class="col-sm-12">
                                              <div class="file-loading">
                                                  <input 
                                                  id="file-<?php echo e($item->COD_CATEGORIA_DOCUMENTO); ?>" 
