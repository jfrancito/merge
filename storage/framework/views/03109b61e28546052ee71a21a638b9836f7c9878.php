  ...
  <div class="panel-body panel-body-contrast">
    <table class="table table-condensed table-striped">
      ...
      <tbody>
          <tr>
            <td><b>RUC</b></td>
            <td><p class='subtitulomerge'><?php echo e($empresa_sel->NRO_DOCUMENTO); ?></p></td>
          ...
          <tr>
            ...
            <td  colspan="2" class=""><b><?php echo e($fedocumento->MONTO_DETRACCION_RED); ?></b></td>
          </tr>

          <tr>
            <td><b>RETENCION IGV</b></td>
            <td  colspan="2" class=""><b><?php echo e($fedocumento->MONTO_RETENCION); ?></b></td>
          </tr>
      </tbody>
    </table>
  </div>
