          ...
          <div class="panel panel-default filtros-box">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label>Centro</label>
                            <?php echo Form::select('centro_id', $combo_centro, $centro_id,
            ...
            <div id="contenedor-lista-consolidado" style="display: none;">
                <?php echo $__env->make('ordenpedido.consolidado.listaordenconsolidado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
