<html>
    ...
    <table>
        ...
        <tr class="<?php echo e($index % 2 == 0 ? 'row-even' : 'row-odd'); ?>">
            <td class="cell-text"><?php echo e($item->CLASIFICACION_MK); ?></td>
            <td class="cell-text"><?php echo e($item->GRUPO_MK_NOMBRE); ?></td>
            <td class="cell-center"><?php echo e(date_format(date_create($item->FEC_VENTA), 'm-Y')); ?></td>
            <td class="cell-center"><?php echo e(date_format(date_create($item->FEC_VENTA), 'd-m-Y')); ?></td>
            ...
            <td class="cell-center"><?php echo e($item->SERIE); ?> - <?php echo e(str_pad($item->NUMERO, 7, "0", STR_PAD_LEFT)); ?></td>
            <td class="cell-text"><?php echo e($item->RZ_PROVEEDOR); ?></td>
            <td class="cell-text-force"><?php echo e($item->RUC_PROVEEDOR); ?></td>
            <td class="cell-center"><?php echo e($item->TXT_CATEGORIA_MONEDA); ?></td>
            <td class="cell-text"><?php echo e($item->PRODUCTO); ?></td>
            <td class="cell-number">
                <?php if($item->ID_TIPO_DOC == '01'): ?>
                    <?php echo e(number_format($item->VAL_SUBTOTAL_ORIG, 2, '.', '')); ?>

                <?php else: ?>
                    <?php echo e(number_format($item->SUB_TOTAL_VENTA_ORIG, 2, '.', '')); ?>

                <?php endif; ?>
            </td>
            <td class="cell-number">
                <?php if($item->ID_TIPO_DOC == '01'): ?>
                    <?php echo e(number_format($item->VAL_IGV_ORIG, 2, '.', '')); ?>

                <?php else: ?>
                    <?php echo e(number_format($item->VALOR_IGV_ORIG, 2, '.', '')); ?>

                <?php endif; ?>
            </td>
            <td class="cell-number">
                <?php if($item->ID_TIPO_DOC == '01'): ?>
                    <?php echo e(number_format($item->VAL_VENTA_ORIG, 2, '.', '')); ?>

                <?php else: ?>
                    <?php echo e(number_format($item->TOTAL_VENTA_ORIG, 2, '.', '')); ?>

                <?php endif; ?>
            </td>
            <td class="cell-text"><?php echo e($item->AREA); ?></td>
            <td class="cell-text"><?php echo e($item->TXT_CONTACTO_N); ?></td>
            <td class="cell-text"><?php echo e($item->UBICACION_MK); ?></td>
            <td class="cell-text-force"><?php echo e($item->NRO_CUENTA); ?></td>
        </tr>
