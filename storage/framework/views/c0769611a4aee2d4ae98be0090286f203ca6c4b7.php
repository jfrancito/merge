...
<form method="POST" action="<?php echo e(url('/configurar-datos-contacto/'.Hashids::encode(substr($usuario->id, -8)))); ?>">
		    ...
		    <div class="col-md-12">
		        ...
		        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		              <div class="form-group">
                        ...
                        <input  type="text"
                                id="nombre" name='nombre' value="<?php echo e($usuario->nombre_contacto); ?>" placeholder="Nombre"
                                required = ""
		        ...
		        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		              <div class="form-group">
		                ...
		                <div class="col-sm-12 abajocaja" >
                        <input  type="text"
                                id="lblcelular" name='lblcelular' value="<?php echo e($usuario->celular_contacto); ?>" placeholder="Ingrese su celular"
                                required = ""
		        ...
		        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		              <div class="form-group">
		                ...
		                <div class="col-sm-12 abajocaja" >
                        <input  type="email"
                                id="lblemail" name='lblemail' value="<?php echo e($usuario->email); ?>" placeholder="Ingresa tu correo electronico"
                                required = ""
                                autocomplete="off" 
                                class="form-control textpucanegro fuente-recoleta-regular input-sm"
                                data-aw="1"/>
