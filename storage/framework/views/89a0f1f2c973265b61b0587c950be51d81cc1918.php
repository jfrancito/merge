            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Revision de Comprobante (<?php echo e($contratoanticipo->ID_DOCUMENTO); ?>)</div>
                            ...
                            <div class="tab-content">
                                <div id="aprobar" class="tab-pane active cont">
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        <div class="panel-heading panel-heading-divider">Aprobar Contrato Acopio
                                            Contabilidad<span class="panel-subtitle">Aprobar un Contrato Acopio</span>
                                        </div>
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="<?php echo e(url('/aprobar-contrato-acopio-acopio/'.$idopcion.'/'.Hashids::encode(substr($contratoanticipo->ID_DOCUMENTO, -8)))); ?>"
                                                ...
                                                <?php echo $__env->make('contratoacopio.form.formaprobaracopiocc', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                <div class="row xs-pt-15">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <p class="text-right">
                                                            <a href="<?php echo e(url('/gestion-de-aprobar-contrato-acopio/'.$idopcion)); ?>">
                                                                <button type="button"
                                                                        class="btn btn-space btn-danger btncancelar">
                                                                    Cancelar
                                                                </button>
                                                            </a>
                                                            <button type="button" data-url="<?php echo e(url('/aprobar-contrato-acopio-acopio/'.$idopcion.'/'.Hashids::encode(substr($contratoanticipo->ID_DOCUMENTO, -8)))); ?>"
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="POST" id='formpedidorechazar'
                                                  action="<?php echo e(url('/agregar-extorno-acopio-ca/'.$idopcion.'/'.Hashids::encode(substr($contratoanticipo->ID_DOCUMENTO, -8)))); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <?php echo $__env->make('contratoacopio.form.formrechazoacopio', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
