        ...
        <tbody>
            ...
            <tr>
                <td class="text-center">
                    <div class="xs-check">
                        <input id="check-<?php echo e($item->ID_PEDIDO_CONSOLIDADO_GENERAL); ?>" 
                               type="checkbox" 
                               name="id_pedido_consolidado_general[]" 
                               class="check-consolidado" 
                               value="<?php echo e($item->ID_PEDIDO_CONSOLIDADO_GENERAL); ?>"
                               data-familia="<?php echo e($item->NOM_CATEGORIA_FAMILIA); ?>">
                        <label for="check-<?php echo e($item->ID_PEDIDO_CONSOLIDADO_GENERAL); ?>"></label>
                    </div>
                </td>
                <td class="font-bold"><?php echo e($item->ID_PEDIDO_CONSOLIDADO_GENERAL); ?></td>
