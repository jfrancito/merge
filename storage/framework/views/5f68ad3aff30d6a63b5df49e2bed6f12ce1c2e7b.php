    ...
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">Revision de Comprobante (<?php echo e($ordencompra->COD_DOCUMENTO_CTBLE); ?>)</div>
                ...
                <div id="aprobar" class="tab-pane active cont">
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                      <form method="POST" id='formpedido' action="<?php echo e(url('/aprobar-comprobante-uc-contrato/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_DOCUMENTO_CTBLE, 0,7).'/'.Hashids::encode(substr($ordencompra->COD_DOCUMENTO_CTBLE, -9)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

<input type="hidden" name="device_info" id='device_info'>

                        <?php echo $__env->make('comprobante.form.formaprobarcontrato', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <div id="observar" class="tab-pane cont">
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                      <form method="POST" id='formpedidoobservar' action="<?php echo e(url('/agregar-observacion-uc-contrato/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_DOCUMENTO_CTBLE, 0,7).'/'.Hashids::encode(substr($ordencompra->COD_DOCUMENTO_CTBLE, -9)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                            <?php echo e(csrf_field()); ?>

<input type="hidden" name="device_info" id='device_info'>

                        <?php echo $__env->make('comprobante.form.formobservaruccontrato', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                      </form>
                    </div>
                  </div>
                </div>
    ...
    <?php echo $__env->make('comprobante.modal.mmodificararchivo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
  </div>
</div>
    ...
    <script type="text/javascript">
        ...
        <?php $__currentLoopData = $archivospdf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          $('#file-'+<?php echo e($index); ?>).fileinput({
            theme: 'fa5',
            language: 'es',
            initialPreview: ["<?php echo e(route('serve-filecontrato', ['file' => ''])); ?>" + nombre_archivo],
            initialPreviewAsData: true,
            initialPreviewFileType: 'pdf',
            initialPreviewConfig: [
                {type: "pdf", caption: nombre_archivo, downloadUrl: "<?php echo e(route('serve-filecontrato', ['file' => ''])); ?>" + nombre_archivo} // Para mostrar el botón de descarga
            ]
          });
        ...
        <?php $__currentLoopData = $array_guias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          var nombre_archivo = '<?php echo e($item['COD_DOCUMENTO_CTBLE']); ?>';
          $('#file-'+nombre_archivo).fileinput({
            theme: 'fa5',
            language: 'es',
            initialPreview: ["<?php echo e(route('serve-filecontrato-sg', ['file' => ''])); ?>" + nombre_archivo],
            initialPreviewAsData: true,
            initialPreviewFileType: 'pdf',
            initialPreviewConfig: [
                {type: "pdf", caption: nombre_archivo, downloadUrl: "<?php echo e(route('serve-filecontrato-sg', ['file' => ''])); ?>" + nombre_archivo} // Para mostrar el botón de descarga
            ]
          });
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        var rutaoc = '<?php echo e($rutaorden); ?>';
        if(rutaoc==''){
          var nombre_archivo = '<?php echo e($ordencompra->COD_DOCUMENTO_CTBLE); ?>';
           $('#file-'+nombre_archivo).fileinput({
              theme: 'fa5',
              language: 'es',
              allowedFileExtensions: ['pdf'],
        ...
        <?php $__currentLoopData = $tarchivos_g; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          var nombre_archivo = '<?php echo e($item->COD_ORDEN); ?>';
          $('#file-'+nombre_archivo).fileinput({
            theme: 'fa5',
            language: 'es',
            initialPreview: ["<?php echo e(route('serve-filecontrato-sg', ['file' => ''])); ?>" + nombre_archivo],
