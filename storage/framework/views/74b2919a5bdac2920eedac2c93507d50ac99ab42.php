                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                    <?php echo Form::select( 'periodo_id', $combo_periodo, array($periodo_id),
                                                      [
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                              <div class="form-group">
                                <label class="col-sm-12 control-label labelleft" style="text-align: left;">PROVEEDOR :</label>
                                <div class="col-sm-12 abajocaja" >
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('cpe.ajax.alistasirecompras', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
