                    ...
                    <div class="panel panel-default panel-border-color panel-border-color-success">
                        <div class="panel-heading"><?php echo e($titulo); ?>
                            ...
                            <div class="tools tooltiptop">
                                ...
                                <div class="dropdown">
                                    <a href="#"
                                       class="btn btn-secondary botoncabecera tooltipcss opciones buscardocumentoadmin">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="menudespacho"
                                      ...
                                      <li>
                                          <a href="<?php echo e(url('/comprobante-masivo-tesoreria-comision-excel')); ?>" 
                                             class='tn btn-secondary botoncabecera tooltipcss opciones'
                                             target="_blank"
                                             id="descargarcomprobantemasivotesoreriracomisionexcel" 
                                             data-href="<?php echo e(url('/comprobante-masivo-tesoreria-comision-excel')); ?>"
                                             title="Descargar excel" style="width:100%">
                                             <span class="tooltiptext">Descargar excel Comision</span>
                                             Descargar excel Comision
                                          </a>
                                      </li>
                                  </ul>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 cajareporte">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 abajocaja">
                                            <?php echo Form::select( 'banco_id', $combo_banco, array($banco_id),
                                                              [
                        ...
                        <div class='listajax'>
                            <?php echo $__env->make('comision.ajax.alistacomisionadministrador', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/comprobante/comision.js?v='.$version)); ?>" type="text/javascript"></script>
