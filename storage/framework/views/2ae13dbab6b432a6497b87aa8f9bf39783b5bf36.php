                    ...
                    <div class="col-md-8">
                        ...
                        <div style="display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
                            <span
                                ...
                                <i class="fa fa-tag me-1"></i> ID: <b><?php echo e($id_cotizacion); ?></b>
                            </span>
                            <span
                                style="font-size: 15px; color: rgba(255,255,255,0.9); font-weight: 500; background: rgba(255,255,255,0.1); padding: 4px 12px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.2);">
                                <i class="fa fa-calendar me-1"></i> Fecha: <b><?php echo e($fecha); ?></b>
                            </span>
                            <span
                                style="font-size: 15px; color: rgba(255,255,255,0.9); font-weight: 500; background: rgba(255,255,255,0.1); padding: 4px 12px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.2);">
                                <i class="fa fa-money me-1"></i> Moneda: <b><?php echo e($moneda); ?></b>
                            </span>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p style="font-size: 15px; font-weight: 600; color: #555;"><?php echo e($ruc); ?></p>
                                </div>
                                <div class="col-sm-6">
                                    <label class="text-muted small fw-bold text-uppercase d-block"
                                        style="margin-bottom: 2px;">Tipo de Pago</label>
                                    <p style="font-size: 15px; font-weight: 600; color: #555;"><?php echo e($tipo_pago); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div
                            ...
                            <h3 style="font-size: 36px; font-weight: 800; color: #1d3a6d; margin: 0;">
                                <span
                                    style="font-size: 20px; vertical-align: middle; margin-right: 5px;"><?php echo e($moneda == 'SOLES' ? 'S/' : '$'); ?></span><?php echo e($total); ?>

                            </h3>
                            <div style="margin-top: 15px;">
                                <span class="label <?php echo e($estado == 'GENERADO' ? 'label-primary' : 'label-success'); ?>"
                        ...
                        <div style="margin-top: 20px; display: flex; gap: 10px; justify-content: center;">
                            <?php if($cotizacion->COD_ESTADO != 'ETM0000000000005'): ?>
                                <button class="btn btn-warning editar-cotizacion" data-id="<?php echo e($id_cotizacion); ?>"
                                    style="flex: 1; border-radius: 8px; font-weight: 700; padding: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                                    <i class="fa fa-edit"></i> EDITAR
                                </button>
                                <button class="btn btn-success aprobar-cotizacion" data-id="<?php echo e($id_cotizacion); ?>"
                                    style="flex: 1; border-radius: 8px; font-weight: 700; padding: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                                    <i class="fa fa-check"></i> APROBAR
                                </button>
                            <?php endif; ?>
                            <!-- El botón ELIMINAR se queda siempre visible, incluso si está Aprobada -->
                            <button class="btn btn-danger eliminar-cotizacion" data-id="<?php echo e($id_cotizacion); ?>" data-estado="<?php echo e($cotizacion->COD_ESTADO); ?>"
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped mb-0">
                            ...
                            <tbody style="color: #444;">
                                <?php $__currentLoopData = $lista_detalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $det): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center fw-bold text-muted"><?php echo e($index + 1); ?></td>
                                        <td>
                                            <div style="font-weight: 700; color: #1d3a6d; font-size: 14px;">
                                                <?php echo e($det->NOM_PRODUCTO); ?>

                                            </div>
                                            <span class="text-muted small">COD: <?php echo e($det->COD_PRODUCTO); ?></span>
                                        </td>
                                        <td>
                                            <span class="label label-outline"
                                                style="border: 1px solid #d1d3e2; color: #5a5c69; font-weight: 600; padding: 3px 10px;">
                                                <?php echo e($det->NOM_CATEGORIA_FAMILIA); ?>

                                            </span>
                                        </td>
                                        <td class="text-center"><?php echo e($det->NOM_CATEGORIA_MEDIDA); ?></td>
                                        <td class="text-center">
                                            <b
                                                style="font-size: 15px; color: #333;"><?php echo e(number_format($det->CANTIDAD, 2)); ?></b>
                                        </td>
                                        <td class="text-center"><?php echo e(number_format($det->CAN_PRECIO, 2)); ?></td>
                                        <td class="text-center" style="color: #28a745; font-weight: 600;">
                                            <?php echo e(number_format($det->CAN_PRECIO_IGV, 2)); ?>

                                        </td>
                                        <td class="text-center fw-bold" style="padding-right: 25px; color: #1d3a6d;">
                                            <?php echo e(number_format($det->CANTIDAD * $det->CAN_PRECIO, 2)); ?>
                        ...
                        <div class="panel panel-default shadow-soft"
                            ...
                            <div class="panel-body">
                                <div
                                    ...
                                    <?php echo $cotizacion->TXT_OBSERVACION ? nl2br(e($cotizacion->TXT_OBSERVACION)) : '<i>Sin observaciones registradas.</i>'; ?>
                    ...
                    <div class="col-md-5">
                        <div class="panel panel-default shadow-soft"
                            ...
                            <div class="panel-heading" style="background: #fff; font-weight: 700; color: #28a745;">
                                <i class="fa fa-paperclip"></i> DOCUMENTOS ADJUNTOS (<?php echo e(count($archivos)); ?>)
                            </div>
                            <div class="panel-body">
                                <?php if(count($archivos) > 0): ?>
                                    <div class="list-group" style="margin-bottom: 0;">
                                        <?php $__currentLoopData = $archivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(url('/descargar-archivo-informe/' . base64_encode($arch->URL_ARCHIVO))); ?>"
                                                ...
                                                <div
                                                    ...
                                                    <div style="display: flex; align-items: center;">
                                                        ...
                                                        <span
                                                            style="font-weight: 600; color: #444; font-size: 13px;"><?php echo e($arch->NOMBRE_ARCHIVO); ?></span>
                                                    </div>
