<?php $__env->startSection('style'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('public/lib/datatables/css/dataTables.bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/lib/datatables/css/responsive.dataTables.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/lib/datetimepicker/css/bootstrap-datetimepicker.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/lib/select2/css/select2.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/lib/bootstrap-slider/css/bootstrap-slider.css')); ?>">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-default panel-table">
                    ...
                    <div class="listajax">
                            <?php echo $__env->make('valerendir.firma.listamodalfirmaprincipal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div> 
                </div>
            </div>
        </div>
...
<script src="<?php echo e(asset('public/js/vale/valefirma.js?v='.$version)); ?>" type="text/javascript"></script>
