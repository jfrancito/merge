            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                ...
                <div class="panel-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <div data-min-view="2" 
                                       ...
                                       style='padding: 0px 0;margin-top: -3px;'>
                                    <input type='text' class="form-control control input-sm" id='fecha_inicio' name='fecha_inicio' value="<?php echo e($fechainicio); ?>" placeholder="Fecha Inicio" autocomplete="off"/>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <div data-min-view="2" 
                                       ...
                                       class='input-group date datetimepicker pickerfecha'
                                       style='padding: 0px 0;margin-top: -3px;'>
                                    <input type='text' class="form-control control input-sm" id='fecha_fin' name='fecha_fin' value="<?php echo e($fechafin); ?>" placeholder="Fecha Fin" autocomplete="off"/>
                                    <span class="input-group-addon btn btn-primary">
                                      <i class="icon-th mdi mdi-calendar"></i>
                                    </span>
                                  </div>
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('entregadocumento.ajax.listafoliosdocumentos', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
