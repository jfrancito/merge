    ...
    <?php $__currentLoopData = $listadatos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr data_requerimiento_id = "<?php echo e($item->id); ?>">
        <td class="cell-detail sorting_1" style="position: relative;">
          ...
          <span><b>PROVEEDOR : </b> <?php echo e($item->TXT_EMPRESA); ?></span>
          <span><b>TOTAL : </b> <?php echo e($item->CAN_TOTAL); ?></span>
          <span><b>DOCUMENTO : </b> <?php echo e($item->TXT_SERIE); ?> - <?php echo e($item->TXT_NUMERO); ?></span>
        ...
        <td class="rigth">
          <div class="btn-group btn-hspace">
            ...
            <ul role="menu" class="dropdown-menu pull-right">
              <li>
                <a href="<?php echo e(url('/observacion-comprobante-uc-liquidacion-compra-anticipo/'.$idopcion.'/'.$item->DOCUMENTO_ITEM.'/'.substr($item->ID_DOCUMENTO, 0,6).'/'.Hashids::encode(substr($item->ID_DOCUMENTO, -10)))); ?>">Observacion</a>  
              </li>
            </ul>
          </div>
        </td>
