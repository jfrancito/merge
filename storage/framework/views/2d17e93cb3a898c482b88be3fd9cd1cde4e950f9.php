            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Revision de Comporbante (<?php echo e($fedocumento->ID_DOCUMENTO); ?>)</div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="<?php echo e(url('/aprobar-comprobante-contabilidad-estiba-dic/'.$idopcion.'/'.$lote)); ?>"
                                                ...
                                                <?php echo $__env->make('comprobante.form.formaprobarcontestibadic', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidoobservar'
                                                  action="<?php echo e(url('/agregar-observacion-contabilidad-estiba/'.$idopcion.'/'.$lote)); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <input type="hidden" name="operacion_id" id="operacion_id"
                                                       value="<?php echo e($fedocumento->OPERACION); ?>">
                                                <?php echo $__env->make('comprobante.form.formobservarestiba', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidoreparable'
                                                  action="<?php echo e(url('/agregar-reparable-contabilidad-estiba-dic/'.$idopcion.'/'.$lote)); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <input type="hidden" name="operacion_id" id="operacion_id"
                                                       value="<?php echo e($fedocumento->OPERACION); ?>">
                                                <?php echo $__env->make('comprobante.form.formreparableestibadic', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidorechazar'
                                                  action="<?php echo e(url('/agregar-extorno-estiba-contabilidad/'.$idopcion.'/'.$lote)); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
            ...
            initialPreviewConfig: [
                {
                    ...
                    downloadUrl: "<?php echo e(route('serve-fileestiba', ['file' => ''])); ?>" + nombre_archivo
