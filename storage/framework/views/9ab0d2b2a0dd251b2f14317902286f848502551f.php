<table id="tablaPropio" 
    ...
    <tr>
        ...
        <th style="text-align: center;">Variedad/Sede</th>
        <th colspan="2" style="text-align: center;">Pacas Chiclayo</th>
        <th colspan="2" style="text-align: center;">Pacas Rioja</th>
        <th colspan="2" style="text-align: center;">Pacas Bellavista</th>
    ...
    <tbody>
    <?php  
        if (!is_array($listapaca) || empty($listapaca)) {
            $listapaca = []; // Asegurar que sea un array vacío si no es válido
        }
