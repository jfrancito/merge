    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider"><?php echo e($titulo); ?><span class="panel-subtitle">Subir Firma</span></div>
          <div class="panel-body">

            <form method="POST" action="<?php echo e(url('/subir-firma/'.$idopcion)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
