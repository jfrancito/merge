...
<?php $__env->startSection('section'); ?>
  <div class="be-content contenido valerendir">
            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                ...
                <div class="panel-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                     <?php echo Form::select(
                                                      'estado_id',
                                                      $combo_estado,
                                                      $estado_id,  // Valor seleccionado por defecto
                                                      [
                                                          'class'       => 'select2 form-control control input-sm',
                                                          'id'          => 'estado_id',
                                                          'required'    => '',
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('valerendir.gestion.alistavalesrendiradmin', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
                  </div>
...
<?php $__env->startSection('script'); ?>
  ...
  <script type="text/javascript">
   ...
   <script src="<?php echo e(asset('public/js/vale/gestionvalerendir.js?v='.$version)); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
