...
<link rel="stylesheet" type="text/css"
    href="<?php echo e(asset('public/lib/material-design-icons/css/material-design-iconic-font.css')); ?> " />
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/analisis/analisis.css?v=' . $version)); ?> " />
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="tab-content main-tab-content">
                    ...
                    <input type="hidden" name="ajax_url" id="ajax_url" value="<?php echo e(url('/actionAjaxDashboards')); ?>">
                            ...
                            <div>
                                <div class="filter-card">
                                    ...
                                    <div class="filter-buttons-container" id="container_f1_ano" data-target="f1_ano"
                                        data-select="single">
                                        <?php $__currentLoopData = $anios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="filter-btn <?php echo e($loop->first ? 'active' : ''); ?>"
                                                data-value="<?php echo e($val); ?>"><?php echo e($label); ?></div>
                            ...
                            <div>
                                <div class="filter-card">
                                    ...
                                    <div class="filter-buttons-container" id="container_f1_mes" data-target="f1_mes">
                                        <?php $__currentLoopData = $meses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="filter-btn active" data-value="<?php echo e($val); ?>"><?php echo e($val); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="filter-card">
                                    ...
                                    <div class="filter-buttons-container" id="container_f1_empresa_id"
                                        ...
                                        <?php $__currentLoopData = $lista_empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="filter-btn active" title="<?php echo e($label); ?>" data-value="<?php echo e($val); ?>">
                                                <?php echo e(strlen($label) > 15 ? substr($label, 0, 15) . '..' : $label); ?>
                            ...
                            <div>
                                <div class="filter-card">
                                    ...
                                    <div class="filter-buttons-container" id="container_f1_moneda_id"
                                        ...
                                        <?php $__currentLoopData = $lista_monedas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="filter-btn <?php echo e(strpos(strtoupper($label), 'SOL') !== false ? 'active' : ''); ?>"
                                                data-value="<?php echo e($val); ?>"><?php echo e($label); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="filter-card">
                                    ...
                                    <div class="filter-buttons-container" id="container_f1_estado_id"
                                        ...
                                        <?php $__currentLoopData = $lista_estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="filter-btn active" data-value="<?php echo e($val); ?>"><?php echo e($label); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="filter-card">
                                    ...
                                    <div class="filter-buttons-container" id="container_f2_mes" data-target="f2_mes"
                                        ...
                                        <div class="view-mes-btns">
                                            <?php $__currentLoopData = $meses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="filter-btn <?php echo e((int) $val == (int) date('n') ? 'active' : ''); ?>"
                                                    data-value="<?php echo e($val); ?>"><?php echo e($val); ?></div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                            ...
                            <div>
                                <div class="filter-card">
                                    ...
                                    <div class="filter-buttons-container" id="container_f2_empresa_id"
                                        ...
                                        <?php $__currentLoopData = $lista_empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="filter-btn active" data-value="<?php echo e($val); ?>">
                                                <?php echo e(strlen($label) > 15 ? substr($label, 0, 15) : $label); ?>
                            ...
                            <div>
                                <div class="filter-card">
                                    ...
                                    <div class="filter-buttons-container" id="container_f2_centro_id"
                                        ...
                                        <?php $__currentLoopData = $lista_centros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="filter-btn active" data-value="<?php echo e($val); ?>">
                                                <?php echo e(strlen($label) > 15 ? substr($label, 0, 15) : $label); ?>
                            ...
                            <div>
                                <div class="filter-card">
                                    ...
                                    <div class="filter-buttons-container" id="container_f2_area_id"
                                        ...
                                        <?php $__currentLoopData = $lista_areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="filter-btn active" data-value="<?php echo e($val); ?>">
                                                <?php echo e(strlen($label) > 15 ? substr($label, 0, 15) : $label); ?>
...
<a href="<?php echo e(url('gestion-de-asistente-liquidacion-compra/jZW')); ?>" class="btn-asistente-ia" target="_blank">
...
<script src="<?php echo e(asset('public/js/analisis/analisisliquidaciongasto.js?v=' . $version)); ?>"
    type="text/javascript"></script>
