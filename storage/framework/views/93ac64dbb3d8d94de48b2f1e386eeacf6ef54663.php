...
<?php $__env->startSection('section'); ?>
    <div class="be-content contenido asientomodelo areacontabilidad">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-success">
                        ...
                        <div class="panel-body">
                            ...
                            <div class='listajax'>
                                <?php echo $__env->make('comprobante.ajax.mergelistacontabilidad', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/comprobante/contabilidad.js?v='.$version)); ?>" type="text/javascript"></script>
