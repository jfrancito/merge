...
<?php $__env->startSection('section'); ?>
    ...
    <div class="be-content contenido reporteordenpedidoestado">
        <div class="main-content container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000010394'): ?> panel-border-color-danger <?php else: ?> <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000007086'): ?> panel-border-color-success <?php else: ?> panel-border-color-info <?php endif; ?> <?php endif; ?>">
                        <div class="panel-heading negrita">Reporte Orden Pedido Estado
                            <div class="tools tooltiptop">
                                <div class="dropdown">
                                    <a href="#" class="tooltipcss opciones buscarreporteordenpedidoestado">
                                        <span class="tooltiptext">Buscar</span>
                                        <span class="icon mdi mdi-search"></span>
                                    </a>
                                    <a href="#" class="tooltipcss opciones descargarreporteordenpedidoestado">
                                        <span class="tooltiptext">Descargar Archivo Excel</span>
                                        <span class="icon mdi mdi--file-excel"></span>
                                    </a>
                                </div>
                            </div>
                            <span class="panel-subtitle negrita"><?php echo e(Session::get('empresas')->NOM_EMPR); ?> </span>
                            ...
                            <div class='filtrotabla row'>
                                <div class="col-xs-12">
                                    <form method="POST"
                                          id="formdescargar"
                                          target="_blank"
                                          action="<?php echo e(url('/descargar-orden-pedido-estado')); ?>"
                                    ...
                                    >
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <?php echo Form::select( 'centro', $combo_centro, '',
                                                                      [
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label labelleft negrita">Año
                                                    :</label>
                                                <div class="col-sm-12 abajocaja">
                                                    <?php echo Form::select( 'anio', $combo_anio, $defecto_anio,
                                                                      [
                                                                        'class'       => 'select2 form-control control input-xs' ,
                                                                        'id'          => 'anio',
                                                                        'data-aw'     => '2',
                                        ...
                                        <div class='ajax_periodo'>
                                            <?php echo $__env->make('ordenpedido.ajax.comboperiodo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        </div>
                                        <input type="hidden" name="idopcion" id='idopcion' value='<?php echo e($id_opcion); ?>'>
                                    </form>
                                </div>
                            </div>
                            <div class='listajax'>
                                <?php echo $__env->make('ordenpedido.ajax.alistareporteordenpedidoestado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/ordenpedido/ordenpedido.js?v='.$version)); ?>"
            type="text/javascript"></script>
