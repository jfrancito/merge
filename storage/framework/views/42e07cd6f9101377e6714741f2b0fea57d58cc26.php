...
<table>
    ...
    <?php $__currentLoopData = $listadetalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td><?php echo e(number_format($item->CANT_ORIGINAL, 2)); ?></td>
            <td><?php echo e(number_format($item->CANT_APROBADA, 2)); ?></td>
            <td><?php echo e(number_format($item->CAN_COMPRADA_ASIGNADA, 2)); ?></td>
            <td><?php echo e(number_format($item->CAN_COMPRADA_DISPONIBLE, 2)); ?> </td>
