    ...
    <div class="row">
      <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading">Revision de Comprobante (<?php echo e($firma->ID_DOCUMENTO); ?>)</div>
                ...
                <div id="aprobar" class="tab-pane active cont">
                      <div class="panel panel-default panel-border-color panel-border-color-primary">
                        ...
                        <div class="panel-body">
                          <form method="POST" id='formpedido' action="<?php echo e(url('/aprobar-firma-administracion/'.$idopcion.'/'.Hashids::encode(substr($firma->ID_DOCUMENTO, -8)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

<input type="hidden" name="device_info" id='device_info'>

                            <?php echo $__env->make('planillamovilidad.form.formaprobarfirma', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <div class="row xs-pt-15">
                              ...
                              <div class="col-xs-6">
                                <p class="text-right">
                                  <a href="<?php echo e(url('/gestion-de-aprobacion-firma-administracion/'.$idopcion)); ?>"><button type="button" class="btn btn-space btn-danger btncancelar">Cancelar</button></a>
                ...
                <div id="rechazar" class="tab-pane">
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                        <form method="POST" id='formpedidorechazar' action="<?php echo e(url('/agregar-extorno-administracion-firma/'.$idopcion.'/'.Hashids::encode(substr($firma->ID_DOCUMENTO, -8)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                              <?php echo e(csrf_field()); ?>

<input type="hidden" name="device_info" id='device_info'>

                          <?php echo $__env->make('planillamovilidad.form.formrechazo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
