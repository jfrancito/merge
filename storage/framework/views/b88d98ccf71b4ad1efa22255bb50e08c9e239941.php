                    ...
                    <div class="panel panel-default panel-table">
                        ...
                        <div class="panel-body selectfiltro">
                                ...
                                <div class="col-xs-12">
                                     ...
                                     <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12 abajocaja">
                                                <?php echo Form::select('cliente_select', $listacentro, '',
                                                   [
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12 abajocaja">
                                                <?php echo Form::select('cliente_select1', $listadepartamento, '',
                                                   [
                                                     'class'       => 'form-control control select2' ,
                                                     'id'          => 'cliente_select1',
                                                     'data-aw'     => '1',
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                                        <div class="form-group">
                                            <label class="col-sm-12 control-label labelleft negrita"> PROVINCIA <span class="obligatorio">(*)</span> :</label>
                                             <div class="col-sm-12 abajocaja">
                                                <?php echo Form::select('cliente_select2', $listaprovincia, '',
                                                   [
                                                     'class'       => 'form-control control select2' ,
                                                     'id'          => 'cliente_select2',
                                                     'data-aw'     => '1',
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-12 control-label labelleft negrita"> DISTRITO <span class="obligatorio">(*)</span> :</label>
                                             <div class="col-sm-12 abajocaja">
                                                <?php echo Form::select('cliente_select3', $listadistrito, '',
                                                   [
                                                     'class'       => 'form-control control select2' ,
                                                     'id'          => 'cliente_select3',
                                                     'data-aw'     => '1',
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                                        ...
                                        <div class="form-group">
                                           <label class="col-sm-12 control-label labelleft negrita" style="margin-top:10px;"> TIPO DE LÍNEA <span class="obligatorio">(*)</span> :</label>
                                             <div class="col-sm-12 abajocaja">
                                                <?php echo Form::select('cliente_select4', $listatipolinea, '',
                                                   [
                                                     'class'       => 'form-control control select2' ,
                                                     'id'          => 'cliente_select4',
                                                     'data-aw'     => '1',
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                                        ...
                                        <label class="col-sm-12 control-label labelleft negrita"style="margin-top:10px;"> TIPO DE IMPORTE <span class="obligatorio">(*)</span> :</label>
                                           <div class="col-sm-12 abajocaja">
                                                 ...
                                                 <?php echo Form::select('cod_tipo', $listatipoimporte, '',
                                                   [
                                                     'class'       => 'form-control control select2' ,
                                                     'id'          => 'cod_tipo',
                                                     'data-aw'     => '1',
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                 ...
                                                 <?php echo Form::select('ind_destino', ['' => 'Selecciona indicador', '1' => 'Sí', '0' => 'No'], null, [
                                                    'class'   => 'form-control control select2',
                                                    'id'      => 'ind_destino',
                                                    'data-aw' => '1'
                                                ]); ?>
                            ...
                            <div class="panel panel-default panel-border-color panel-border-color-primary">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <?php echo Form::select('cod_centro', $listalugarpartida, '', [
                                                        'class' => 'form-control control select2',
                                                        'id' => 'cod_centro',
                                                        'data-aw' => '1',
                                                    ]); ?>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ind_producto">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <?php echo Form::select('cod_distrito', $listalugardestino, '', [
                                                        'class' => 'form-control control select2',
                                                        'id' => 'cod_distrito',
                                                        'data-aw' => '1',
                                                    ]); ?>
                                ...
                                <?php echo $__env->make('valerendir.ajax.listamodalregistroimportegastos', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/vale/registroimportegastos.js?v='.$version)); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
