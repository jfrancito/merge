    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">Aprobar Comprobante Tesoreria<span class="panel-subtitle">Aprobar un Comprobante Tesoreria</span></div>
...
<input type="hidden" name="device_info" id='device_info'>
              ...
              <?php echo $__env->make('comprobante.form.formaprobartes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </form>
          </div>
        </div>
      </div>
