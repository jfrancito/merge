      ...
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          ...
          <div class="panel-body">
            <form method="POST" action="<?php echo e(url('/gestion-de-cpe/'.$idopcion)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed frmbuscar">
...
<input type="hidden" name="device_info" id='device_info'>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input  type="text"
                          id="ruc" name='ruc' value="<?php echo e(old('ruc')); ?>" placeholder="RUC"
                          required = ""
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <?php echo Form::select( 'td', $combotd, array('01'),
                                    [
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input  type="text"
                          id="serie" name='serie' value="<?php echo e(old('serie')); ?>" placeholder="SERIE"
                          required = ""
                          autocomplete="off" class="form-control input-sm" data-aw="4"/>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input  type="text"
                          id="correlativo" name='correlativo' value="<?php echo e(old('correlativo')); ?>" placeholder="NRO. DOCUMENTO"
                          required = ""
                          autocomplete="off" class="form-control input-sm" data-aw="4"/>
              ...
              <div class="form-group" style="text-align: center;">
                ...
                <?php if(Session::has('respuetacdr')): ?>
                    <?php if(Session::get('respuetacdr')['cod_error'] == 1): ?>
                      <span class="label label-danger"><?php echo e(Session::get('respuetacdr')['mensaje']); ?></span>
                    <?php else: ?>
                      <a class="btn btn-space btn-success" href="<?php echo e(url('descargar-archivo/'.Session::get('respuetacdr')['nombre_archivo'])); ?>">Descargar CDR</a>

                    <?php endif; ?>
                <?php endif; ?>

                <?php if(Session::has('respuetaxml')): ?>
                    <?php if(Session::get('respuetaxml')['cod_error'] == 1): ?>
                      <span class="label label-danger"><?php echo e(Session::get('respuetaxml')['mensaje']); ?></span>
                    <?php else: ?>
                      <a class="btn btn-space btn-success" href="<?php echo e(url('descargar-archivo/'.Session::get('respuetaxml')['nombre_archivo'])); ?>">Descargar XML Y CDR</a>

                    <?php endif; ?>
                <?php endif; ?>
                <?php if(Session::has('respuetapdf')): ?>
                    <?php if(Session::get('respuetapdf')['cod_error'] == 1): ?>
                      <span class="label label-danger"><?php echo e(Session::get('respuetaxml')['mensaje']); ?></span>
                    <?php else: ?>
                      <a class="btn btn-space btn-success" href="<?php echo e(url('descargar-archivo/'.Session::get('respuetapdf')['nombre_archivo'])); ?>">Descargar PDF</a>
