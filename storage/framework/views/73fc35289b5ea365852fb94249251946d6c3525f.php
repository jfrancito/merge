...
<div class="tab-content mt-3">
  <div id="resumenviaticos" class="tab-pane active">
    <?php echo $__env->make('valerendir.ajax.modaldetalleimporteviaticosresumen', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </div>
  <div id="detalleviaticos" class="tab-pane">
    <?php echo $__env->make('valerendir.ajax.modaldetalleimporteviaticos', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </div>
</div>
