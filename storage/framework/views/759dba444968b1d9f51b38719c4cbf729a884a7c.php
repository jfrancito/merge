        ...
        <tr>
          ...
          <td class="text-center">
            <span class="badge badge-cantidad" style="background: #e9ecef; color: #495057;">
              <?php echo e((int)$detalle->CANTIDAD); ?>
          ...
          <td class="text-right fw-bold text-success">
            S/ <?php echo e(number_format($precio, 2, '.', ',')); ?>

          </td>
          
          <td class="text-right fw-bold" style="color:#1f2a50;">
            S/ <?php echo e(number_format($subtotal, 2, '.', ',')); ?>
      ...
      <tfoot>
        <tr style="background-color: #f8f9fa;">
            ...
            <td class="text-right fw-bold" style="font-size: 1.2rem; color: #d9534f;">
                S/ <?php echo e(number_format($suma_total_general, 2, '.', ',')); ?>
