<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <?php echo $__env->make('comprobante.form.liquidacioncompraanticipo.comparar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <?php echo $__env->make('comprobante.form.liquidacioncompraanticipo.seguimiento', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
</div>

<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <?php echo $__env->make('comprobante.form.liquidacioncompraanticipo.archivos', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8">
        <?php echo $__env->make('comprobante.form.liquidacioncompraanticipo.informacion', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
</div>
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <?php echo $__env->make('comprobante.form.liquidacioncompraanticipo.archivosobservados', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
</div>
            ...
            <div class="panel-body" style="padding: 20px;">
                <div class="row" style="margin-bottom: 25px;">
                    <div class="col-md-3">
                        ...
                        <div style="font-weight: 600; color: #334155;"><?php echo e($contrato_anticipo->TXT_PROVEEDOR); ?></div>
                    </div>
                    <div class="col-md-2">
...
<div class="row xs-pt-15">
    ...
    <div class="col-xs-6">
        <p class="text-right">
            <a href="<?php echo e(url('/gestion-de-administracion-aprobar/'.$idopcion)); ?>">
