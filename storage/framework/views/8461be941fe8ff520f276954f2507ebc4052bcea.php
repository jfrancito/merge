	...
	<table id="" class="table table-striped table-borderless table-hover td-color-borde td-padding-7" >
		  ...
		  <tbody>
		    ...
		    <?php $__currentLoopData = $listadatos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		       <?php  $NOMBRE_OSIRIS =  $funcion->funciones->cuenta_osiris_lca_folio($item->ID_DOCUMENTO)  ?>
		      <tr>
				...
				<td><b><?php echo e(number_format($item->TOTAL_VENTA_ORIG, 2, '.', ',')); ?></b></td>
		        ...
		        <td><b>
		        	<?php echo e($simbolo); ?> <?php echo e(number_format($funcion->funciones->neto_pagar_documento($item->ID_DOCUMENTO), 2, '.', ',')); ?>
