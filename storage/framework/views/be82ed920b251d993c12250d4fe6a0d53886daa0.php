        ...
        <table class="table table-hover align-middle mb-0 detalle-table">
            ...
            <thead class="text-white sticky-top detalle-thead">
                <tr class="text-uppercase small">
                    ...
                    <?php if($mostrarJefe): ?>
                    <th class="text-center">Cant. Jefe</th> <?php endif; ?>
                    <?php if($mostrarGer): ?>
                    <th class="text-center">Cant. Gerencia</th><?php endif; ?>
                    <?php if($mostrarAdm): ?>
                    <th class="text-center">Cant. Admin</th><?php endif; ?>
                    <th>Observación</th>
                </tr>
            </thead>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $pedillodetalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="fw-semibold" title="<?php echo e($detalle->NOM_PRODUCTO); ?>">
                            <?php echo e($detalle->NOM_PRODUCTO); ?>

                        </td>

                        <td class="text-secondary" title="<?php echo e($detalle->NOM_CATEGORIA); ?>">
                        ...
                        <td class="observacion" title="<?php echo e($detalle->TXT_OBSERVACION); ?>">
