            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Gestión de Obras
                  <div class="tools">
                    <?php if(isset($permisos) && $permisos['anadir'] == 1): ?>
                  ...
                  <div id="modal-formulario-activo" class="modal-container colored-header colored-header-primary modal-effect-8">
                      <div class="modal-content">
                          ...
                          <div class="modal-body modal-formulario-activo-container">
                              <?php echo $__env->make('activofijo.modal.ajax.mformulario', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                          </div>
...
<?php $__env->startSection('script'); ?>
  ...
  <script src="<?php echo e(asset('public/lib/datatables/plugins/buttons/js/buttons.html5.js?v=5')); ?>" type="text/javascript"></script>
  ...
  <script src="<?php echo e(asset('public/js/activofijo/activofijo.js?v='.time())); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
