...
<form method="POST" action="<?php echo e(url('/configurar-datos-cuenta-bancaria-lq/'.$idoc.'/'.$idopcion)); ?>">
		    ...
		    <div class="col-md-12">
		        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
		              <div class="form-group">
		                ...
		                <div class="col-sm-12 abajocaja" >
		                  <?php echo Form::select( 'banco_id', $combo_banco, $defecto_banco,
		                                    [
		                                      'class'       => 'select7 form-control control input-xs combo' ,
		                                      'id'          => 'banco_id',
		                                      'data-aw'     => '1',
		                                      'required'    => '',
		                                    ]); ?>
		        ...
		        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
		              <div class="form-group">
		                ...
		                <div class="col-sm-12 abajocaja" >
		                  <?php echo Form::select( 'tipocuenta_id', $combo_tipocuenta, $defecto_tipocuenta,
		                                    [
		                                      'class'       => 'select7 form-control control input-xs combo' ,
		                                      'id'          => 'tipocuenta_id',
		                                      'data-aw'     => '1',
