...
<?php else: ?>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group sectioncargarimagen">
                                    <label class="col-sm-12 control-label"
                                           style="text-align: left;"><b><?php echo e($item->NOM_CATEGORIA_DOCUMENTO); ?>
                                        ...
                                        <?php if($item->COD_CATEGORIA_DOCUMENTO == 'DCC0000000000005'): ?>
                                            <b>(Descargue el pdf de este enlace <a
                                                        ...
                                                        target="_blank">Sunat</a> y subalo para que pueda aprobar</b>)
                                        <?php else: ?>
                                            <br><br>
                                        <?php endif; ?>
                                    </label>
    ...
    <?php else: ?>
        <input type="hidden" id="contabilidadfisico" name="contabilidadfisico" value="0">
    <?php endif; ?>
    <?php if($rol->ind_uc == 1 || $rol->id == '1CIX00000020' || $rol->id == '1CIX00000015'): ?>
        <div class="row xs-pt-15">
            <div class="col-xs-6">
                <div class="be-checkbox">
                </div>
