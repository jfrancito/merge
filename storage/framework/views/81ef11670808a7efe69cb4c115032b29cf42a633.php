                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 20px;">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 cajareporte">
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <?php echo Form::select( 'tipo_detraccion_id', $combotipodetraccion, array($fedocumento->VALOR_DETRACCION),
                                                    [
                          ...
                          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
                            <div class="form-group">
                              ...
                              <div class="col-sm-12 abajocaja" >
                                  <input type="text" name="monto_detraccion" id='monto_detraccion' class="form-control control input-sm importe" value = '<?php echo e($fedocumento->MONTO_DETRACCION_RED); ?>'>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 cajareporte">
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <?php echo Form::select( 'pago_detraccion', $combopagodetraccion, array($fedocumento->COD_PAGO_DETRACCION),
                                                    [
                                                      'class'       => 'select2 form-control control input-xs' ,
                                                      'id'          => 'pago_detraccion',
                                                      'data-aw'     => '1',
