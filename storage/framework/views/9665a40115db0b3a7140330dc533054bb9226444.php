            ...
            <div class="col-sm-12">
                ...
                <div class="tab-container">
                    ...
                    <div class="tab-content">
                        ...
                        <?php echo $__env->make('ordenpedido.monto.tabmontoordenpedido', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div><!-- FIN tab-content -->
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/ordenpedido/ordenmonto.js?v='.$version)); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
