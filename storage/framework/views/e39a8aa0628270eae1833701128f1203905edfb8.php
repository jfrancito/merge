              ...
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading"><?php echo e($titulo); ?>
                  ...
                  <div class="tools tooltiptop">
                    <a href="<?php echo e(url('/agregar-cuarta-categoria/'.$idopcion)); ?>" class="btn btn-secondary botoncabecera tooltipcss opciones" style="width:140px;">
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('cuartacategoria.ajax.alistacuartacategoria', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
