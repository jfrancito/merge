      ...
      <div class="tab-container">
        ...
        <div class="tab-content">
                      ...
                      <?php $__currentLoopData = $listadatos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          <td class="cell-detail sorting_1" style="position: relative;">
                            ...
                            <span><b>CANTIDAD  :</b> <?php echo e($item->CAN_FOLIO); ?></span>
                          ...
                          <td>
                              <div class="icon iconoentregable">
                                <span class="mdi mdi-select-all mdisel" data_folio='<?php echo e($item->FOLIO); ?>'></span>
                                <span class="mdi mdi-eye mdidet" data_folio='<?php echo e($item->FOLIO); ?>'></span>
                                <!-- <span class="mdi mdi-floppy mdisave" data_folio='<?php echo e($item->FOLIO); ?>' data_glosa='<?php echo e($item->TXT_GLOSA); ?>'></span> -->
                                <span class="mdi mdi-delete mdiex" data_folio='<?php echo e($item->FOLIO); ?>'></span>
                                <a href="<?php echo e(url('/descargar-folio-excel-detraccion-reserva/'.$item->FOLIO)); ?>">
                                  <span class="mdi mdi-file mdiexcel" data_folio='<?php echo e($item->FOLIO); ?>'></span>
                                </a>  
          ...
          <div id="crearfolios" class="tab-pane cont">
            <form method="POST" action="<?php echo e(url('/crear-folio-entregable-detraccion/'.$idopcion)); ?>">
                    ...
                    <div class="col-md-12">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <?php echo Form::select( 'banco_id', $combobancos, $banco_id,
                                                    [
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <?php echo Form::select( 'moneda_id', $combo_moneda, $defecto_moneda,
                                                    [
          ...
          <div id="detallefolios" class="tab-pane detalle_folio">
            <?php echo $__env->make('entregadocumento.modal.ajax.mdetallefolio', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          </div>

          <div id="guardarfolio" class="tab-pane cont">
            <form method="POST" action="<?php echo e(url('/guardar-folio-entregable-detraccion/'.$idopcion)); ?>">
                  <?php echo e(csrf_field()); ?>
