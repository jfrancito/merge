                    ...
                    <div class="panel-body panel-body-contrast">
                      <table class="table table-condensed table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td><b>ANTICIPO</b></td>
                              <td  colspan="2" class=""><b><?php echo e($fedocumento->MONTO_ANTICIPO_DESC); ?></b></td>
                            </tr>
                                  ...
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 20px;">
                                      ...
                                      <div class="col-xs-6">
                                        <p class="text-right">
                                          ...
                                          <input type="hidden" name="empresa_id" id='empresa_id' value = "<?php echo e(Session::get('empresas')->COD_EMPR); ?>">
