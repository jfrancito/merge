...
<html lang="<?php echo e(app()->getLocale()); ?>">
  <head>
    ...
    <link rel="icon" href="<?php echo e(asset('public/img/icono/favicon.ico')); ?>">    
    <title>404</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/alfasweb.css')); ?> "/>
  </head>
      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="error-container">
            ...
            <div class="error-goback-button"><a href="<?php echo e(url('/bienvenido')); ?>" class="btn btn-xl btn-primary">Vamos a inicio</a></div>
