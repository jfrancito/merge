                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000010394'): ?> panel-border-color-danger <?php else: ?> <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000007086'): ?> panel-border-color-success <?php else: ?> panel-border-color-info <?php endif; ?> <?php endif; ?>">
                        ...
                        <div class="panel-body">
                            <div class='filtrotabla row'>
                                <div class="col-xs-12">
                                    <form method="POST"
                                          id="formdescargar"
                                          target="_blank"
                                          action="<?php echo e(url('/descargar-archivo-reporte-div-saldos')); ?>"
                            ...
                            <div class='listajax'>
                                <?php echo $__env->make('reporte.ajax.alistareportedivsaldos', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/venta/reportedivsaldos.js?v='.$version)); ?>" type="text/javascript"></script>
