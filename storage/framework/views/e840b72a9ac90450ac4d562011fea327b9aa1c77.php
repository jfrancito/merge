<?php if(count($productos) > 0): ?>
    <div class="row" style="margin-bottom: 15px; padding: 0 5px;">
        <div class="col-md-12">
            <p class="text-muted">
                Seleccione los productos del consolidado <b><?php echo e($id_consolidado); ?></b> que desea deshabilitar. Solo se
                ...
                <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="fila-producto-deshabilitar" style="cursor: pointer;">
                        <td class="text-center">
                            <div class="xs-check-prod">
                                <input id="check-prod-<?php echo e(trim($prod->COD_PRODUCTO)); ?>" type="checkbox"
                                    name="cod_producto_desh[]" class="check-producto-desh"
                                    value="<?php echo e(trim($prod->COD_PRODUCTO)); ?>" checked>
                        ...
                        <td class="text-center"><?php echo e(number_format($prod->CANTIDAD, 2)); ?></td>
                        <td class="text-center font-bold text-danger"><?php echo e(number_format($prod->SALDO_PENDIENTE, 2)); ?></td>
...
<?php else: ?>
    <div class="alert alert-warning text-center shadow-soft" style="margin: 20px 0; border-radius: 8px;">
        ...
        <p>Todos los productos de este consolidado (<b><?php echo e($id_consolidado); ?></b>) ya están asociados a una cotización
            activa.</p>
    </div>
    <script>
        $(document).ready(function () {
