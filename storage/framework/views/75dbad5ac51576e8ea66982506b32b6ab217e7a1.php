        ...
        <table class="table table-hover align-middle mb-0 detalle-table">
            ...
            <thead class="text-white sticky-top detalle-thead">
                <tr class="text-uppercase small">
                    ...
                    <?php if($mostrarJefe): ?>
                    <th style="width:10%" class="text-center">Cant. Jefe</th> <?php endif; ?>
                    <?php if($mostrarGer): ?>
                    <th style="width:10%" class="text-center">Cant. Gerencia</th><?php endif; ?>
                    <?php if($mostrarAdm): ?>
                    <th style="width:10%" class="text-center">Cant. Admin</th><?php endif; ?>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $pedillodetalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="fw-semibold text-truncate" title="<?php echo e($detalle->NOM_PRODUCTO); ?>">
                            <?php echo e($detalle->NOM_PRODUCTO); ?>

                        </td>

                        <td class="text-truncate text-secondary" title="<?php echo e($detalle->NOM_CATEGORIA); ?>">
                        ...
                        <td class="text-truncate observacion" title="<?php echo e($detalle->TXT_OBSERVACION); ?>">
...
<div class="modal-footer justify-content-center bg-light" style="margin-top:-10px; border-top:1px solid #dee2e6;">
