            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                  ...
                  <div class="tools tooltiptop">
                      ...
                      <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="menudespacho"
                              ...
                              <li>
                                  <a href="<?php echo e(url('/comprobante-masivo-reparable-excel')); ?>" 
                                     class='tn btn-secondary botoncabecera tooltipcss opciones'
                                     target="_blank"
                                     id="descargarcomprobantemasivoreparableexcel" 
                                     data-href="<?php echo e(url('/comprobante-masivo-reparable-excel')); ?>"
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                      ...
                      <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                          <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja" >
                              <?php echo Form::select( 'tipoarchivo_id', $combo_tipoarchivo, array($tipoarchivo_id),
                                                [
                                                  'class'       => 'select2 form-control control input-sm' ,
                                                  'id'          => 'tipoarchivo_id',
                                                  'required'    => '',
                      ...
                      <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                          <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja" >
                              <?php echo Form::select( 'estado_id', $combo_estdo, array($estado_id),
                                                [
                                                  'class'       => 'select2 form-control control input-sm' ,
                                                  'id'          => 'estado_id',
                                                  'required'    => '',
                      ...
                      <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                          <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja" >
                              <?php echo Form::select( 'anio_id', $combo_anio, array($anio_id),
                                                [
                                                  'class'       => 'select2 form-control control input-sm' ,
                                                  'id'          => 'anio_id',
                                                  'required'    => '',
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('comprobante.ajax.mergelistareparable', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
