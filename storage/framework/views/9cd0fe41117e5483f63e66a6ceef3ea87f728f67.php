<table id="<?php echo e($id); ?>" class="table table-striped table-borderless table-hover td-color-borde td-padding-7 listatabla"
    ...
    <?php $__currentLoopData = $listadatos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr data_requerimiento_id="<?php echo e($item->ID_DOCUMENTO); ?>">
            ...
            <td><?php echo e(date_format(date_create($item->FEC_ORDEN), 'd-m-Y')); ?></td>
            <td><?php echo e($item->COD_ORDEN); ?></td>
            <td><?php echo e($item->COND_PAGO); ?></td>
            ...
            <td class="rigth">
                <div class="btn-group btn-hspace">
                    ...
                    <ul role="menu" class="dropdown-menu pull-right">
                        ...
                        <li>
                            <a href="<?php echo e(url('/aprobar-comprobante-contabilidad/'.$idopcion.'/'.$item->DOCUMENTO_ITEM.'/'.substr($item->ID_DOCUMENTO, 0,6).'/'.Hashids::encode(substr($item->ID_DOCUMENTO, -10)))); ?>">
                                Revisar Comprobante
                            </a>
                        </li>
