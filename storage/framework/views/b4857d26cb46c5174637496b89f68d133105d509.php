            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                  ...
                  <div class="tools tooltiptop">
                      <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="menudespacho"
                              ...
                              <li>
                                  <a href="<?php echo e(url('/comprobante-masivo-tesoreria-excel')); ?>" 
                                     class='tn btn-secondary botoncabecera tooltipcss opciones'
                                     target="_blank"
                                     id="descargarcomprobantemasivotesoreriraexcel" 
                                     data-href="<?php echo e(url('/comprobante-masivo-tesoreria-excel')); ?>"
                              ...
                              <li>
                                <a href="<?php echo e(url('/comprobante-masivo-excel')); ?>" 
                                   class='tn btn-secondary botoncabecera tooltipcss opciones'
                                   target="_blank"
                                   id="descargarcomprobantemasivoexcel" 
                                   data-href="<?php echo e(url('/comprobante-masivo-excel')); ?>"
                                   title="Descargar excel" style="width:100%">
                              ...
                              <li>
                                <a href="<?php echo e(url('/comprobante-masivo-marketing-excel')); ?>" 
                                   class='tn btn-secondary botoncabecera tooltipcss opciones'
                                   target="_blank"
                                   id="descargarcomprobantemasivomarketingexcel" 
                                   data-href="<?php echo e(url('/comprobante-masivo-marketing-excel')); ?>"
                                   title="Descargar excel" style="width:100%">
                ...
                <div class="panel-body">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                    <?php echo Form::select( 'proveedor_id', $combo_proveedor, array(),
                                                      [
                                                        'class'       => 'select2 form-control control input-sm' ,
                                                        'id'          => 'proveedor_id',
                                                        'required'    => '',
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                    <?php echo Form::select( 'estado_id', $combo_estado, array(),
                                                      [
                                                        'class'       => 'select2 form-control control input-sm' ,
                                                        'id'          => 'estado_id',
                                                        'required'    => '',
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                    <?php echo Form::select( 'filtrofecha_id', $combo_filtrofecha, array(),
                                                      [
                                                        'class'       => 'select2 form-control control input-sm' ,
                                                        'id'          => 'filtrofecha_id',
                                                        'required'    => '',
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('comprobante.ajax.mergelistaocvalidado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
...
<?php $__env->startSection('script'); ?>
  ...
  <script src="<?php echo e(asset('public/js/comprobante/oc.js?v='.$version)); ?>" type="text/javascript"></script>
