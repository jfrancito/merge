    ...
    <div class="row">
      ...
      <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading">Revision de Comprobante (<?php echo e($fedocumento->ID_DOCUMENTO); ?>)</div>
              ...
              <div class="tab-content">
                <div id="aprobar" class="tab-pane active cont">
                      ...
                      <div class="panel panel-default panel-border-color panel-border-color-primary">
                        ...
                        <div class="panel-body">
                          <form method="POST" id='formpedido' action="<?php echo e(url('/aprobar-comprobante-administracion-contratoa/'.$idopcion.'/'.$fedocumento->DOCUMENTO_ITEM.'/'.$fedocumento->ID_DOCUMENTO)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>

                                <input type="hidden" name="device_info" id='device_info'>
                            <?php echo $__env->make('comprobante.form.formaprobaradmcontratoa', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                          </form>
                        </div>
                      </div>
                ...
                <div id="observar" class="tab-pane cont">
                    ...
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        ...
                        <div class="panel-body">
                              <form method="POST" id='formpedidoobservar' action="<?php echo e(url('/agregar-observacion-administracion-mcontratoa/'.$idopcion.'/'.$fedocumento->ID_DOCUMENTO)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                                    <?php echo e(csrf_field()); ?>

                                <input type="hidden" name="device_info" id='device_info'>
                                <?php echo $__env->make('comprobante.form.formobservaradminmcontratoa', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                              </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        ...
                        <div class="panel-body">
                            <form method="POST" id='formpedidorechazar'
                                  action="<?php echo e(url('/agregar-extorno-administracion-oc-mcontratoa/'.$idopcion.'/'.$fedocumento->ID_DOCUMENTO)); ?>"
                                  style="border-radius: 0px;"
                                  class="form-horizontal group-border-dashed">
                                <?php echo e(csrf_field()); ?>

                                <input type="hidden" name="device_info" id='device_info'>
                                <?php echo $__env->make('comprobante.form.formrechazomcontratoa', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </form>
                        </div>
                    </div>
                </div>
