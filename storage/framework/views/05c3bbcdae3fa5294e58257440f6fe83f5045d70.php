                                ...
                                <div id="aprobar" class="tab-pane active cont">
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidocomision'
                                                  action="<?php echo e(url('/aprobar-comprobante-contabilidad-estiba-comision/'.$idopcion.'/'.$lote)); ?>"
                                                ...
                                                <?php echo $__env->make('comprobante.form.formaprobarcontestibacomision', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                            </form>
                                        </div>
                                    </div>
                                </div>
