...
<!--               <li>
              ...
              <li>
                <a href="<?php echo e(url('/aprobar-comprobante-uc/'.$idopcion.'/'.$item->DOCUMENTO_ITEM.'/'.substr($item->ID_DOCUMENTO, 0,6).'/'.Hashids::encode(substr($item->ID_DOCUMENTO, -10)))); ?>">
                  Aprobar Comprobante
                </a>  
              </li>
 <!--              <li>
                <a href="<?php echo e(url('/extornar-pre-aprobar-comprobante/'.$idopcion.'/'.$item->DOCUMENTO_ITEM.'/'.substr($item->ID_DOCUMENTO, 0,6).'/'.Hashids::encode(substr($item->ID_DOCUMENTO, -10)))); ?>">
