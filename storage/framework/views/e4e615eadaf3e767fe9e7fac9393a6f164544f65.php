        ...
        <div class="tab-container">
          ...
          <div class="tab-content">
            <div id="oc" class="tab-pane <?php if($tab_id=='oc'): ?> active <?php endif; ?> cont">
              <?php echo $__env->make('cuartacategoria.lista.ajax.alistacccont', ['id' => 'nso' , 'lrentacuartacategoria' => $lrentacuartacategoria], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
          </div>
        </div>
      </div>
