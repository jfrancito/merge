        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="form-field">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control "  id='empresa_actual' name='empresa_actual' required="" value="<?php echo e(Session::get('empresas')->NOM_EMPR); ?>"  readonly>
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="form-field">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="mdi mdi-collection-text"></i></span>
                    <input type="text" class="form-control "  id='sede' name='sede' required="" value="<?php echo e($centro->NOM_CENTRO); ?>"  readonly>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-field">
                ...
                <?php echo Form::select('empresa_id', $combo_empresa, array($empresa_id), ['class' => 'select2 form-control', 'id' => 'empresa_id', 'required' => '']); ?>

            </div>
        </div>

        <div class="col-xs-12 col-sm-6 col-md-3 ajax_combo_cuenta">
            <?php echo $__env->make('general.ajax.combocuentaanti', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-3 ajax_combo_subcuenta">
            <?php echo $__env->make('general.ajax.combosubcuentaanti', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="form-field">
                ...
                <?php echo Form::select('variedad_id', $combo_variedad, array($variedad_id), ['class' => 'select2 form-control', 'id' => 'variedad_id', 'required' => '']); ?>
    ...
    <div class="row" style="background: #f8fbfe; border: 1px dashed #cbd5e0; padding: 15px 0; margin-bottom: 20px; border-radius: 8px; margin-left: 0; margin-right: 0;">
        ...
        <div class="col-xs-12 col-sm-5">
            ...
            <div class="form-field">
                ...
                <?php echo Form::select('tercero_id_detalle_input', $combo_empresa, array($empresa_id), ['class' => 'select2 form-control', 'id' => 'tercero_id_detalle_input']); ?>
        ...
        <?php $__currentLoopData = $tarchivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            <div class="col-xs-12 col-md-6">
                <div class="form-field sectioncargarimagen mb-3">
                    <label class="form-label"><?php echo e($item->NOM_CATEGORIA); ?> (<?php echo e($item->COD_CTBLE); ?>)</label>
                    <div class="file-loading">
                        <input id="file-<?php echo e($item->COD_CATEGORIA); ?>" name="<?php echo e($item->COD_CATEGORIA); ?>[]" class="file-es" type="file" multiple data-max-file-count="1" required>
                    </div>
                </div>
            </div>
