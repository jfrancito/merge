<div class="listadatos">  
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
              <div class="panel panel-default panel-contrast">
                ...
                <div class="panel-body panel-body-contrast">
                  <form method="POST" action="<?php echo e(url('subir-xml-cargar-datos-estiba-administrator-orden-compra-anticipo/'.$idopcion.'/'.$idoc)); ?>" name="formcargardatos" id="formcargardatos" enctype="multipart/form-data" >
          ...
          <?php if(count($fedocumento)>0): ?>
            <form method="POST" action="<?php echo e(url('validar-xml-oc-estiba-administrator-oca/'.$idopcion.'/'.$idoc)); ?>" name="formguardardatos" id="formguardardatos" enctype="multipart/form-data" >
             <?php echo e(csrf_field()); ?>
            ...
            <input type="hidden" name="device_info" id='device_info'>
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                  <?php if($fedocumento->OPERACION_DET == 'SIN_XML'): ?>
                    <?php echo $__env->make('comprobante.form.ordencompra.compararanticiposxml', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  <?php else: ?>
                    <?php echo $__env->make('comprobante.form.ordencompra.compararanticipo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  <?php endif; ?>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8">
                  <?php if($fedocumento->OPERACION_DET != 'SIN_XML'): ?>
                    <?php echo $__env->make('comprobante.form.ordencompra.informacionoca', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  <?php endif; ?>
                </div>
              </div>
