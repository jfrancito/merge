<div class="listadatos">  
        <div class="container">
          <?php if(count($fedocumento)>0): ?>
            <form method="POST" action="<?php echo e(url('validar-xml-oc-administrator-sx/'.$idopcion.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>" name="formguardardatos" id="formguardardatos" enctype="multipart/form-data" >
...
<input type="hidden" name="device_info" id='device_info'>
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                  <?php echo $__env->make('comprobante.form.ordencompra.compararsx', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
