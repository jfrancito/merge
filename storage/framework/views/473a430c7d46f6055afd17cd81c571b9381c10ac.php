<table id="cesic" class="table table-striped table-bordered table-hover td-color-borde td-padding-7 display nowrap" style='width: 100%;'>
    ...
    <tr style="background: #4285f4; color: white; text-align: center">
        ...
        <th></th>
        <th style="text-align: right"><?php echo e(number_format($total_comercial, 2, '.', '')); ?></th>
        <th style="text-align: right"><?php echo e(number_format($total_porcentaje_comercial, 2, '.', '')); ?></th>
    </tr>
    </tfoot>
</table>
