<form method="POST" id='formpedido' action="<?php echo e(url('/pago-comprobante-tesoreria-contrato/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_DOCUMENTO_CTBLE, 0,7).'/'.Hashids::encode(substr($ordencompra->COD_DOCUMENTO_CTBLE, -9)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
...
<input type="hidden" name="device_info" id='device_info'>
	...
	<div class="modal-header" style="background: #1d3a6d;">
	  ...
	  <div class="row">
			<div class="col-xs-6">
				ORDEN COMPRA : <?php echo e($ordencompra->COD_DOCUMENTO_CTBLE); ?>
	  ...
	  <div class="row">
			<div class="col-xs-6">
				PROVEEDOR : <?php echo e($ordencompra->TXT_EMPR_EMISOR); ?>
