      ...
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          ...
          <div class="panel-body">
            <form method="POST" action="<?php echo e(url('/agregar-tercero/'.$idopcion)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                  ...
                  <select class="select2 input-sm" id="personal" name='personal' required = "">
                    <optgroup label="Usuarios">
                      ...
                      <?php $__currentLoopData = $listapersonal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item->id); ?>" data_usuario='<?php echo e($item->COD_USUARIO); ?>'><?php echo e($item->nombres); ?></option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <?php echo Form::select( 'rol_id', $comborol, array('1CIX00000048'),
                                    [
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input  type="text"
                          id="cuenta_bancaria" name='cuenta_bancaria' value="<?php echo e(old('cuenta_bancaria')); ?>" placeholder="Cuenta Bancaria"
                          required = ""
