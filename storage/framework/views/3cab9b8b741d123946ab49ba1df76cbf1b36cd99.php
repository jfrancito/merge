  ...
  <thead>
  	...
  	<tr>
        <th></th>
      	...
      	<th class="border cplomo"><?php echo e(Session::get('empresas')->NOM_EMPR); ?></th>
  	</tr>

  	<tr>
        <th></th>
      	<th class="border cplomo">BANCO:</th>
      	<th class="border cplomo"><?php echo e($folio->TXT_CATEGORIA_BANCO); ?></th>
  	</tr>
  	<tr>
        <th></th>
      	<th class="border cplomo">GLOSA:</th>
      	<th class="border cplomo"><?php echo e($folio->TXT_GLOSA); ?></th>
  	</tr>
  	...
  	<tr>
        <th></th>
      	...
      	<th class="border cplomo"><?php echo e($folio->nombre); ?></th>
  	</tr>
  </thead>
</table>