...
<div class="table-responsive" style="max-height: 450px; overflow-y: auto;">
    <table id="table-pedidos-servicios-aprobado" class="table table-striped table-hover table-fw-widget listatabla">
        ...
        <tbody>
            <?php $__currentLoopData = $lista_pedidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td class="text-center">
                    <div class="xs-check">
                        <input id="check-ped-<?php echo e($item->ID_PEDIDO); ?>" 
                               type="checkbox" 
                               name="id_pedido_servicio[]" 
                               class="check-pedido" 
                               value="<?php echo e($item->ID_PEDIDO); ?>"
                               data-centro="<?php echo e(trim($item->NOM_CENTRO)); ?>">
                        <label for="check-ped-<?php echo e($item->ID_PEDIDO); ?>"></label>
                    </div>
                </td>
                <td class="font-bold"><?php echo e($item->ID_PEDIDO); ?></td>
                <td class="text-primary" style="font-size: 11px; font-weight: 700;"><?php echo e($item->NOM_CENTRO); ?></td>
                <td style="font-size: 12px;"><?php echo e($item->TXT_TRABAJADOR_SOLICITA); ?></td>
                <td><?php echo e(date('d-m-Y', strtotime($item->FEC_PEDIDO))); ?></td>
                <td style="font-size: 11px; max-width: 250px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="<?php echo e($item->TXT_GLOSA); ?>">
                    <?php echo e($item->TXT_GLOSA); ?>
