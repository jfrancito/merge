                            ...
                            <div class="tab-content">
                                <div id="aprobar" class="tab-pane active cont">
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        <div class="panel-heading panel-heading-divider">Aprobar Liquidacion de Gasto
                                            Contabilidad<span class="panel-subtitle">Aprobar una Liquidacion de Gasto Contabilidad</span>
                                        </div>
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="<?php echo e(url('/aprobar-liquidacion-gasto-contabilidad/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8)))); ?>"
                                                ...
                                                <?php echo $__env->make('liquidaciongasto.form.formaprobarcontlg', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                <div class="row xs-pt-15">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <p class="text-right">
                                                            <a href="<?php echo e(url('/gestion-de-aprobacion-liquidacion-gastos-contabilidad/'.$idopcion)); ?>">
                                                                <button type="button"
                                                            ...
                                                            <button type="button"
                                                                    data-url="<?php echo e(url('/aprobar-liquidacion-gasto-contabilidad/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8)))); ?>"
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidoobservar'
                                                  action="<?php echo e(url('/agregar-observar-contabilidad/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8)))); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <?php echo $__env->make('liquidaciongasto.form.formobservarcont', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                <div class="row xs-pt-15">
                                                    <div class="col-xs-6">
                                                        <div class="be-checkbox">
                                                        </div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="POST" id='formpedidorechazar'
                                                  action="<?php echo e(url('/agregar-extorno-contabilidad-lg/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8)))); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <?php echo $__env->make('liquidaciongasto.form.formrechazocont', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                ...
                                                <div class="row xs-pt-15">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <p class="text-right">
                                                            ...
                                                            <button type="button"
                                                                    class="btn btn-space btn-primary btnrechazocomporbatnte">
                                                                Guardar
                                                            </button>
                                                        </p>
                                                    </div>
