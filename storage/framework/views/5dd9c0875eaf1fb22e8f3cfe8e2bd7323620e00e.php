...
<!-- 
                    ...
                    <a href="#" class="btn btn-secondary botoncabecera tooltipcss opciones loteentregable">
                      ...
                      <strong class='folios_hit' data_folio_sel="<?php if(count($entregable_sel)>0): ?><?php echo e($entregable_sel->FOLIO); ?><?php endif; ?>" style="font-size:13px; padding: 5px;">
                        <?php if(count($entregable_sel)>0): ?>
                          <?php echo e($entregable_sel->FOLIO); ?> (<?php echo e($entregable_sel->CAN_FOLIO); ?>)
                        <?php else: ?>
                          Sin Folio
                        <?php endif; ?>
                      </strong>
                    </a>
                    <input type="hidden" name="folio_sel" id="folio_sel" value="<?php if(count($entregable_sel)>0): ?><?php echo e($entregable_sel->FOLIO); ?><?php endif; ?>">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                    <?php echo Form::select( 'centro_id', $combo_centro, array($centro_id),
                                                      [
                                                        'class'       => 'select2 form-control control input-sm' ,
                                                        'id'          => 'centro_id',
                                                        'required'    => '',
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                    <?php echo Form::select( 'area_id', $combo_area, array($area_id),
                                                      [
                                                        'class'       => 'select2 form-control control input-sm' ,
                                                        'id'          => 'area_id',
                                                        'required'    => '',
                           ...
                           <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                    <?php echo Form::select( 'operacion_id', $combo_operacion, array($operacion_id),
                                                      [
                                                        'class'       => 'select2 form-control control input-sm' ,
                                                        'id'          => 'operacion_id',
                                                        'required'    => '',
                           ...
                           <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                    <?php echo Form::select( 'banco_id', $combobancos, array($banco_id),
                                                      [
                                                        'class'       => 'select2 form-control control input-sm' ,
                                                        'id'          => 'banco_id',
                                                        'required'    => '',
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-12 abajocaja" >
                                      <?php echo Form::select( 'moneda_id', $combo_moneda, $moneda_id,
                                                        [
...
<!--                             <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
 ...
 -->
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('entregadocumento.ajax.mergelistaentregable', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
    ...
    <?php echo $__env->make('entregadocumento.modal.mregistrorequerimiento', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('script'); ?>
  ...
  <script src="<?php echo e(asset('public/js/comprobante/entregable.js?v='.$version)); ?>" type="text/javascript"></script>
