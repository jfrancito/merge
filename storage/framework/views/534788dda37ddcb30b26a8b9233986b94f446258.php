                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="tab-container">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#aprobar" data-toggle="tab"><b>GESTION</b></a>
                                </li>
                            </ul>
                                ...
                                <div id="aprobar" class="tab-pane active cont">
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                                <?php echo $__env->make('cuartacategoria.form.formgestioncontcc', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
