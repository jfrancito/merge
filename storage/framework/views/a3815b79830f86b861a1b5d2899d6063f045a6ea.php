              ...
              <td class="rigth">
                <div class="btn-group btn-hspace">
                  ...
                  <ul role="menu" class="dropdown-menu pull-right">
                    <li>
                      <a href="<?php echo e(url('/descargar-archivo-requerimiento-liquidacion-compra-anticipo-anulado/'.$item->TIPO_ARCHIVO.'/'.$idopcion.'/'.$linea.'/'.substr($ordenpago->COD_AUTORIZACION, 0,6).'/'.Hashids::encode(substr($ordenpago->COD_AUTORIZACION, -10)))); ?>">
                        Descargar
                      </a>  
                    </li>
                  </ul>
