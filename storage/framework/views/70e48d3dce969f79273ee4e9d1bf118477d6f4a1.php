                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text"
                               ...
                               value="<?php echo e($estadosMerge[$estado_merge] ?? ''); ?>"
                               readonly>
                        <input type="hidden"
                               id="cod_estado"
                               name="cod_estado"
                               value="<?php echo e($estado_merge); ?>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text"
                               class="form-control control text-uppercase"
                               value="<?php echo e(strtoupper($listasolicita[$usuario_solicita] ?? '')); ?>"
                               readonly>
                        <input type="hidden"
                               id="cod_trabajador_solicita"
                               name="cod_trabajador_solicita"
                               value="<?php echo e($usuario_solicita); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row form-row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo Form::select('cod_anio', $periodo_anio, date('Y'), [
                            'id' => 'cod_anio',
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text"
                               class="form-control control text-uppercase"
                               value="<?php echo e(strtoupper($nomArea ?? '')); ?>"
                               readonly>

                        <input type="hidden"
                               id="cod_area"
                               name="cod_area"
                               value="<?php echo e($area_id); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row form-row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <?php echo Form::select('cod_periodo', $periodo_mes, '', [
                          'id' => 'cod_periodo',
                          'class' => 'form-control control select2'
                      ]); ?>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo Form::select('cod_trabajador_autoriza', $usuario_autoriza, '', [
        ...
        <div class="row form-row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="text"
                               class="form-control control"
                               value="<?php echo e($listaempresa[$empresa] ?? ''); ?>"
                               readonly>
                        <input type="hidden"
                               id="cod_empr"
                               name="cod_empr"
                               value="<?php echo e($empresa); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo Form::select('cod_trabajador_aprueba_ger', $usuario_aprueba_ger, '', [
        ...
        <div class="row form-row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php if(count($combo_sede) > 0): ?>
                            <?php echo Form::select('cod_centro', $combo_sede, $cod_centro, [
                                'id' => 'cod_centro',
                                'class' => 'form-control control select2'
                            ]); ?>
                        ...
                        <?php else: ?>
                            <input type="text"
                                   class="form-control control"
                                   value="<?php echo e($nom_centro); ?>"
                                   readonly>
                            <input type="hidden"
                                   id="cod_centro"
                                   name="cod_centro"
                                   value="<?php echo e($cod_centro); ?>">
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php echo Form::select('cod_trabajador_aprueba_adm', $usuario_aprueba_adm, '', [
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                            ...
                            <?php echo Form::select('cod_tipo_pedido', $listatipopedido, '', [
                            'id' => 'cod_tipo_pedido',
                            'class' => 'form-control control select2',
                             'disabled' => 'disabled'
                        ]); ?>
