  ...
  <body class="form-v10 wrapper registroruc">
    ...
    <div class="page-content">
      <div class="form-v10-content">
        <form class="form-detail" action="<?php echo e(url('registrate')); ?>" method="POST" id="myform">
...
<input type="hidden" name="device_info" id='device_info'>
                    ...
                    <div class="col-md-12">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                              ...
                              <div class='encontro_proveedor'>
                                <?php echo $__env->make('usuario.form.formproveedor', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                              </div>
                              <div class='inputr'>
                                ...
                                <div class="abajocaja">
                                  ...
                                  <input  type="text"
                                          id="cuenta_detraccion" name='cuenta_detraccion' value="<?php echo e(old('cuenta_detraccion')); ?>" 
                              ...
                              <div class='inputr'>
                                ...
                                <div class="abajocaja">
                                  ...
                                  <input  type="password"
                                          id="lblcontrasena" name='lblcontrasena' value="<?php echo e(old('lblcontrasena')); ?>" placeholder="Ingresa una contraseña"
                                          required = ""
                              ...
                              <div class='inputr'>
                                ...
                                <div class="abajocaja">
                                    ...
                                    <input  type="password"
                                            id="lblcontrasenaconfirmar" name='lblcontrasenaconfirmar' value="<?php echo e(old('lblcontrasenaconfirmar')); ?>" placeholder="Confirmar contraseña"
                                            required = ""
                                            autocomplete="off"
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class='inputr'>
                      ...
                      <div class="abajocaja">
                        ...
                        <input  type="text"
                                id="nombre" name='nombre' value="<?php echo e(old('nombre')); ?>" placeholder="Nombre"
                                required = ""
                                autocomplete="off" class="form-control input-sm" data-aw="4"/>
                    ...
                    <div class='inputr'>
                      ...
                      <div class="abajocaja">
                        ...
                        <input  type="text"
                                id="lblcelular" name='lblcelular' value="<?php echo e(old('lblcelular')); ?>" placeholder="Ingrese su celular"
                                required = ""
                    ...
                    <div class='inputr'>
                      ...
                      <div class="abajocaja">
                        ...
                        <input  type="email"
                                id="lblemail" name='lblemail' value="<?php echo e(old('lblemail')); ?>" placeholder="Ingresa tu correo electronico"
                                required = ""
                                autocomplete="off" 
                                class="form-control textpucanegro fuente-recoleta-regular input-sm"
                                data-aw="1"/>
                    ...
                    <div class='inputr'>
                      ...
                      <div class="abajocaja">
                        ...
                        <input  type="email"
                                id="lblconfirmaremail" name='lblconfirmaremail' value="<?php echo e(old('lblconfirmaremail')); ?>" placeholder="Ingresa confirmacion de correo electronico"
                                required = ""
                                autocomplete="off" 
    ...
    <script src="<?php echo e(asset('public/js/user/registro.js')); ?>" type="text/javascript"></script>
