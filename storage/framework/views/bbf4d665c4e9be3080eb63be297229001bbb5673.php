                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'anio_asiento', $array_anio, '',
                                                  [
                                                    'class'       => 'slim',
                                                    'id'          => 'anio_asiento',
                                                    'data-aw'     => '1',
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte ajax_anio_asiento">
                        <div class="form-group">
                            <label class="col-sm-12 control-label labelleft negrita">Periodo
                                :</label>
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'periodo_asiento', $array_periodo, '',
                                                  [
                                                    'class'       => 'slim',
                                                    'id'          => 'periodo_asiento',
                                                    'data-aw'     => '2',
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'moneda_asiento', $combo_moneda_asiento, '',
                                                  [
                                                    'class'       => 'slim',
                                                    'id'          => 'moneda_asiento',
                                                    'data-aw'     => '4',
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'empresa_asiento', [], '',
                                                  [
                                                    'id'          => 'empresa_asiento',
                                                    'data-aw'     => '6',
                                                    'required'    => true,
                    ...
                    <script>
                        let defaultId = "<?php echo e(''); ?>";
                        let defaultText = "<?php echo e(''); ?>";
                    </script>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'tipo_asiento', $combo_tipo_asiento, '',
                                                  [
                                                    'class'       => 'slim',
                                                    'id'          => 'tipo_asiento',
                                                    'data-aw'     => '7',
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'tipo_documento_asiento', $combo_tipo_documento, '',
                                                  [
                                                    'class'       => 'slim',
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                <?php echo Form::select( 'tipo_documento_ref', $combo_tipo_documento, '',
                                                  [
                                                    'class'       => 'slim',
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                ...
                                <input type="text"
                                       id="percepcion_xml"
                                       data_valor="<?php echo e((!empty($fedocumento->PERCEPCION) ? $fedocumento->PERCEPCION : 0.00) > 0.00 ? $fedocumento->PERCEPCION : 0.00); ?>"
                                       name='percepcion_xml'
                                       value="<?php echo e((!empty($fedocumento->PERCEPCION) ? $fedocumento->PERCEPCION : 0.00) > 0.00 ? $fedocumento->PERCEPCION : 0.00); ?>"
                                       placeholder="0.00"
                                       autocomplete="off"
                                       class="form-control input-sm dinero"
                                       data-aw="1"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cajareporte">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 abajocaja">
                                ...
                                <input type="text"
                                       id="anticipo_xml"
                                       data_valor="<?php echo e((!empty($fedocumento->MONTO_ANTICIPO_DESC) ? $fedocumento->MONTO_ANTICIPO_DESC : 0.00) > 0.00 ? $fedocumento->MONTO_ANTICIPO_DESC : 0.00); ?>"
                                       name='anticipo_xml'
                                       value="<?php echo e((!empty($fedocumento->MONTO_ANTICIPO_DESC) ? $fedocumento->MONTO_ANTICIPO_DESC : 0.00) > 0.00 ? $fedocumento->MONTO_ANTICIPO_DESC : 0.00); ?>"
                                       placeholder="0.00"
                                       autocomplete="off"
                                       class="form-control input-sm dinero"
                                       data-aw="1"
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 cajareporte">
                    <div class="form-group">
                        <label class="col-sm-12 control-label labelleft negrita">Tipo
                            ...
                            :</label>
                        <div class="col-sm-12 abajocaja">
                            <?php echo Form::select( 'tipo_descuento_asiento', $combo_descuento, '',
                                              [
                                                'class'       => 'slim',
