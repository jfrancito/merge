<html>
    ...
    <table>
        <thead>
        <tr>
            <th class="center tablaho" colspan="<?php echo e(count($centros_internacional) + 5); ?>">INDUAMERICA INTERNACIONAL</th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th class="footerho" style="text-align: right"><?php echo e(number_format($total_internacional, 2, '.', '')); ?></th>
            <th class="footerho" style="text-align: right"><?php echo e(number_format($total_porcentaje_internacional, 2, '.', '')); ?></th>
        </tr>
        </tfoot>
    </table>
