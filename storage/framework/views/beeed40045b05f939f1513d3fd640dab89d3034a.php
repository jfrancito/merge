    ...
    <div class="tab-container">
        ...
        <div class="tab-content">
                ...
                <div id="pendientes" class="tab-pane cont active">
                   <?php echo $__env->make('valerendir.ajax.listamodalvalerendirapruebapendiente', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
                <div id="autorizados" class="tab-pane cont">
                   <?php echo $__env->make('valerendir.ajax.listamodalvalerendiraprobado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
                 <div id="rechazados" class="tab-pane cont">
                   <?php echo $__env->make('valerendir.ajax.listamodalvalerendirrechazado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
