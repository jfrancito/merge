      ...
      <div class="tab-container">
        ...
        <div class="tab-content">
          ...
          <div id="crearfolios" class="tab-pane cont">
            <form method="POST" action="<?php echo e(url('/crear-folio-entregable-pla/'.$idopcion)); ?>">
...
<input type="hidden" name="device_info" id='device_info'>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <?php echo Form::select( 'periodo_id', $combo_periodo, $periodo_id,
                                                    [
                                                      'class'       => 'select4 form-control control input-xs combo' ,
                                                      'id'          => 'periodo_id',
                                                      'data-aw'     => '1',
                                                      'required'    => '',
                                                    ]); ?>
          ...
          <div id="detallefolios" class="tab-pane detalle_folio">
            <?php echo $__env->make('planillamovilidad.modal.ajax.mdetallefoliopl', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          </div>

          <div id="guardarfolio" class="tab-pane cont">
            <form method="POST" action="<?php echo e(url('/guardar-folio-entregable-pla/'.$idopcion)); ?>">
                  <?php echo e(csrf_field()); ?>
