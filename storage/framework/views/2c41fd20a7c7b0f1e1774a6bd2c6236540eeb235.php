...
<h5 class="modal-title fw-semibold text-center w-100">
    <div class="d-flex justify-content-center align-items-center mb-1">
        ...
        <span>DETALLE DEL PEDIDO (ADMINISTRACIÓN)</span>
    </div>
...
<tr>
    ...
    <?php if(
        ...
        <input type="number"
               ...
               value="<?php echo e((int)$cant_original); ?>"
               min="1"
...
<tr>
    <td colspan="<?php echo e(4 + ($mostrarJefe ? 1 : 0) + ($mostrarGer ? 1 : 0)); ?>"
...
<tfoot style="background: #f8f9fa; color: #1f2a50; border-top: 2px solid #dee2e6;">
    <tr>
        <td colspan="<?php echo e(6 + ($mostrarJefe ? 1 : 0) + ($mostrarGer ? 1 : 0)); ?>" class="text-right py-3 px-4" style="border:none;">
