...
<table table id="tablaValeRendirAutoriza" class="table table-striped table-borderless" style="font-style: italic;">
    ...
    <?php $__currentLoopData = $listarusuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <?php if(($item['TXT_CATEGORIA_ESTADO_VALE'] === 'AUTORIZADO' || $item['TXT_CATEGORIA_ESTADO_VALE'] === 'APROBADO') && $item['USUARIO_AUTORIZA_ID'] === $usuario_logueado_id): ?>
      
        <tr data_vale_rendir_reembolso="<?php echo e($item['ID']); ?>">
            ...
            <td class="align-middle text-center">
              <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                ...
                <?php elseif($item['TXT_CATEGORIA_ESTADO_VALE'] === 'APROBADO'): ?>
                    <span class="badge badge-success mb-4"><?php echo e($item['TXT_CATEGORIA_ESTADO_VALE']); ?></span>    
                <?php elseif($item['TXT_CATEGORIA_ESTADO_VALE'] === 'RECHAZADO'): ?>
                    <span class="badge badge-danger mb-4"><?php echo e($item['TXT_CATEGORIA_ESTADO_VALE']); ?></span>
                <?php else: ?>
                     <span class="badge badge-custom-dange mb-4"><?php echo e($item['TXT_CATEGORIA_ESTADO_VALE']); ?></span>                        
                <?php endif; ?>


                <?php if($item['ESTADO_OSIRIS'] === 'GENERADO'): ?>
                    <span class="badge bg-white text-dark">GENERADO</span>
                <?php elseif($item['ESTADO_OSIRIS'] === 'COBRADO'): ?>
                    <span class="badge badge-success">COBRADO</span>
                <?php elseif($item['ESTADO_OSIRIS'] === 'RECHAZADO'): ?>
                ...
                <div class="dropdown">
                       ...
                       <div class="dropdown-menu d-dropdown-menu shadow-sm p-1" aria-labelledby="dropdownAcciones<?php echo e($item['ID']); ?>">
                            ...
                            <?php if(!empty($item['TXT_GLOSA_AUTORIZADO'])): ?>
                               <a class="dropdown-item show-glosa d-flex align-items-center" href="#"
