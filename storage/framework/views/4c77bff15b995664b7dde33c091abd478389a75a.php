...
<input type="hidden" name="device_info" id='device_info'>
                ...
                <div id="observar" class="tab-pane cont">
                  ...
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                      <form method="POST" id='formpedidoobservar' action="<?php echo e(url('/agregar-observacion-administracion-liquidacion-compra-anticipo/'.$idopcion.'/'.$linea.'/'.substr($ordenpago->COD_AUTORIZACION, 0,6).'/'.Hashids::encode(substr($ordenpago->COD_AUTORIZACION, -10)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                            <?php echo e(csrf_field()); ?>

<input type="hidden" name="device_info" id='device_info'>

                            
                        <?php echo $__env->make('comprobante.form.formobservaradminliquidacioncompraanticipo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                      </form>
                    </div>
                  </div>
