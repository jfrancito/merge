...
<?php $__env->startSection('section'); ?>
  <div class="be-content contenido cfedocumento">
            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('rr.ajax.alistavalidarrr', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
    ...
    <?php echo $__env->make('rr.modal.mrr', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </div>
<?php $__env->stopSection(); ?>
