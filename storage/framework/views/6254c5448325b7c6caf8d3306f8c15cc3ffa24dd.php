...
<div class="row">
  ...
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
    ...
    <?php if($fedocumento->OPERACION_DET != 'SIN_XML'): ?> <?php echo $__env->make('comprobante.form.ordencompra.sunatconta', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> <?php endif; ?> 
