<form method="POST" id='formpedido' action="<?php echo e(url('/pago-comprobante-tesoreria-pagado/'.$idopcion.'/'.$linea.'/'.substr($fedocumento->ID_DOCUMENTO, 0,6).'/'.Hashids::encode(substr($fedocumento->ID_DOCUMENTO, -10)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
