    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="panel-body">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            <?php echo Form::select('nombre_config', $combo1, $nombre_config,
                                [
            ...
            <div class="table-responsive listajax mt-3">
                <?php echo $__env->make('ordenpedido.monto.alistamontoordenpedido', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
