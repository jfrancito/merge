...
<div class="panel-heading">
  <form method="POST" id='formre' action="<?php echo e(url('/select-xml-estiba-orden-compra-anticipo/'.$idopcion)); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
...
<table id="estiba" class="table table-striped table-borderless table-hover td-color-borde td-padding-7 listatabla">
  ...
  <tbody>
    <?php $__currentLoopData = $listadatos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr data_requerimiento_id = "<?php echo e($item->COD_ORDEN); ?>" data_lote = "<?php echo e($item->LOTE_DOC); ?>" data_total = "<?php echo e($item->CAN_TOTAL); ?>" data_mergetotal = "<?php echo e($item->TOTAL_MERGE); ?>">
        ...
        <td class="rigth">
          <div class="text-center be-checkbox be-checkbox-sm has-primary">
            <input  type="checkbox"
              class="<?php echo e($item->COD_ORDEN); ?>-<?php echo e($item->LOTE_DOC); ?> input_asignar"
              data_total = "<?php echo e($item->CAN_TOTAL); ?>"   
              id="<?php echo e($item->COD_ORDEN); ?>-<?php echo e($item->LOTE_DOC); ?>" >
            <label  for="<?php echo e($item->COD_ORDEN); ?>-<?php echo e($item->LOTE_DOC); ?>"
                  data-atr = "ver"
                  class = "checkbox checkbox_asignar"
                  data_total = "<?php echo e($item->CAN_TOTAL); ?>"                
                  name="<?php echo e($item->COD_ORDEN); ?>-<?php echo e($item->LOTE_DOC); ?>"
            ></label>
          </div>
        </td>
      </tr>                    
