                                ...
                                <div class="container-fluid" style="padding-left: 0; padding-right: 0;">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                            <div class="panel panel-default panel-contrast">
                                                ...
                                                <div class="panel-body panel-body-contrast">
                                                    <form method="POST"
                                                          action="<?php echo e(url('subir-xml-cargar-datos-comision-administrator-masivo/'.$idopcion.'/'.$idoc)); ?>"
                                            ...
                                            <div id="col-pdf-left">
                                                <?php if($documento_id != 'DCC0000000000048'): ?>
                                                    ...
                                                    <div id="panel-pdf-masivo-container" class="panel panel-default panel-contrast" style="margin-top: 15px;">
                                                        ...
                                                        <div class="panel-body panel-body-contrast">
                                                            <form method="POST"
                                                                  action="<?php echo e(url('subir-pdf-masivo-comision-administrator/'.$idopcion.'/'.$idoc)); ?>"
                                                                ...
                                                                <input type="hidden" name="jsondocumenos" id='jsondocumenos_pdf' value="<?php echo e($jsondocumenos); ?>">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-12" style="margin-bottom: 15px;">
                                                                            ...
                                                                            <input type="hidden" id="total_asociado_oc" value="<?php echo e($documento_asociados->sum('MONTOATENDIDOREAL')); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <!-- Panel CONSULTA API SUNAT -->
                                             <div id="panel-api-sunat-container" class="panel panel-default panel-contrast" <?php if($documento_id == 'DCC0000000000048'): ?> style="display: none;" <?php endif; ?>>
                                                 <div class="panel-heading" style="background: #1d3a6d; color: #fff;">CONSULTA API SUNAT
                                                 </div>
                                                 <div class="panel-body panel-body-contrast">
                                                      <?php if(empty($fedocumentos) || $fedocumentos->isEmpty()): ?>
                                                      ...
                                                      <?php else: ?>
                                                          <?php $__currentLoopData = $fedocumentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fedoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                              <div style="border-bottom: 1px dashed #ddd; padding-bottom: 10px; margin-bottom: 10px; font-size: 13px; line-height: 1.8;">
                                                                  <p style="margin:0px;"><b>Comprobante</b> : <?php echo e($fedoc->SERIE); ?>-<?php echo e($fedoc->NUMERO); ?></p>
                                                                  <p style="margin:0px;"><b>Respuesta Sunat</b> : <?php echo e($fedoc->message); ?></p>
                                                                  <p style="margin:0px;" class="<?php if($fedoc->estadoCp == 1): ?> msjexitoso <?php else: ?> msjerror <?php endif; ?>"><b>Estado Comprobante</b> : 
                                                                      <?php echo e($fedoc->nestadoCp); ?>

                                                                  </p>
                                                                  <p style="margin:0px;"><b>Estado Ruc</b> : <?php echo e($fedoc->nestadoRuc); ?></p>
                                                                  <p style="margin:0px;"><b>Estado Domicilio</b> : <?php echo e($fedoc->ncondDomiRuc); ?></p>
                                                                  <?php if(!empty($fedoc->RESPUESTA_CDR)): ?>
                                                                      <p style="margin:0px;"><b>Respuesta CDR</b> : <?php echo e($fedoc->RESPUESTA_CDR); ?></p>
                                                                  <?php endif; ?>
                                                              </div>
                                                    ...
                                                    <table class="table table-condensed table-striped">
                                                        ...
                                                        <?php $__currentLoopData = $documento_asociados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo e(number_format($item->MONTOATENDIDOREAL, 4, '.', '')); ?></td>
                                                            </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </tbody>
                                                    </table>
                                     ...
                                     <div id="panel-xml-detalle-container" <?php if(empty($fedocumentos) || $fedocumentos->isEmpty() || $documento_id == 'DCC0000000000048'): ?> style="display: none;" <?php endif; ?>>
                                         <?php if(!empty($fedocumentos) && !$fedocumentos->isEmpty() && $documento_id != 'DCC0000000000048'): ?>
                                             <?php $__currentLoopData = $fedocumentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indexFedoc => $fedoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                 <?php 
                                                 ...
                                                 <div class="row" style="margin-top: 20px; border-bottom: 2px dashed #ccc; padding-bottom: 20px; margin-bottom: 20px;">
                                                     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                         <div class="panel panel-default panel-contrast">
                                                             <div class="panel-heading" style="background: #1d3a6d;color: #fff;"><?php echo e($fereftop1->OPERACION); ?> (<?php echo e($fedoc->SERIE); ?>-<?php echo e($fedoc->NUMERO); ?>)
                                                             </div>
                                                             <div class="panel-body panel-body-contrast">
                                                                 <table class="table table-condensed table-striped">
                                                                     <thead>
                                                                     ...
                                                                     <tr>
                                                                         ...
                                                                         <td class="">
                                                                             <div class='subtitulomerge <?php if($fedoc->ind_ruc == 1): ?> msjexitoso <?php else: ?> msjerror <?php endif; ?>'>
                                                                                 <b><?php echo e($fedoc->RUC_PROVEEDOR); ?></b>
                                                                             </div>
                                                                         </td>
                                                                     </tr>
                                                                     ...
                                                                     <tr>
                                                                         ...
                                                                         <td>
                                                                             <div class='subtitulomerge <?php if($fedoc->ind_moneda == 1): ?> msjexitoso <?php else: ?> msjerror <?php endif; ?>'>
                                                                                 <b>
                                                                                     <?php if($fedoc->MONEDA == 'PEN' || $fedoc->MONEDA == 'SOLES'): ?>
                                                                                         SOLES
                                                                                     <?php else: ?>
                                                                                         <?php echo e($fedoc->MONEDA); ?>
                                                                     ...
                                                                     <tr>
                                                                         <td><b>Total</b></td>
                                                                         <td>
                                                                             <p class='subtitulomerge'><?php echo e(number_format($curr_op_total, 4, '.', ',')); ?></p>
                                                                         </td>
                                                                         <td>
                                                                             <div class='subtitulomerge <?php if($fedoc->ind_total == 1): ?> msjexitoso <?php else: ?> msjerror <?php endif; ?>'>
                                                                                 <b><?php echo e(number_format($fedoc->TOTAL_VENTA_ORIG, 4, '.', ',')); ?></b>
                                                                             </div>
                                                                         </td>
                                                                     </tr>
                                                                     </tbody>
                                                             ...
                                                             <div class="panel-body panel-body-contrast">
                                                                 <div class="tab-container">
                                                                     <ul class="nav nav-tabs">
                                                                         <li class="active"><a href="#xml-<?php echo e($indexFedoc); ?>" data-toggle="tab">XML</a></li>
                                                                     </ul>
                                                                     <div class="tab-content">
                                                                         <div id="xml-<?php echo e($indexFedoc); ?>" class="tab-pane active cont">
                                                                             <table class="table table-condensed table-striped" style="margin-bottom: 20px;">
                                                                                 ...
                                                                                 <tbody>
                                                                                 <tr>
                                                                                     <td><?php echo e($fedoc->SERIE); ?></td>
                                                                                     <td><?php echo e($fedoc->NUMERO); ?></td>
                                                                                     <td><?php echo e($fedoc->FEC_VENTA); ?></td>
                                                                                     <td><?php echo e($fedoc->FORMA_PAGO); ?></td>
                                                                                     <td>
                                                                                         <span class="pdf-asoc-badge label label-danger" 
                                                                                               data-serie="<?php echo e($fedoc->SERIE); ?>" 
                                                                                               data-numero="<?php echo e((int)$fedoc->NUMERO); ?>">
                                                                                             No cargado
                                                                                         </span>
                                                                                     </td>
                                                                                 </tr>
                                                                             ...
                                                                             <table class="table table-condensed table-striped">
                                                                                 ...
                                                                                 <tbody>
                                                                                 <?php $__currentLoopData = $curr_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                     <tr>
                                    ...
                                    <div class="row" style="margin-top: 20px; margin-bottom: 10px;">
                                        <div class="col-xs-12 text-right" style="padding-right: 15px;">
                                            <button type="button" id="btn-guardar-comision-masivo" class="btn btn-success btn-guardar-premium" <?php if(($documento_id == 'DCC0000000000048' || empty($fedocumentos) || $fedocumentos->isEmpty())): ?> disabled="disabled" <?php endif; ?>>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/comprobante/comisionmasivo_v2.js?v='.$version)); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
