      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e($liquidaciongastos->TXT_CUENTA); ?>"                         
                    readonly = "readonly"
                    required = ""
                    autocomplete="off" class="form-control input-sm"/>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e($liquidaciongastos->TXT_SUBCUENTA); ?>"                         
                    readonly = "readonly"
                    required = ""
                    autocomplete="off" class="form-control input-sm"/>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e(date_format(date_create($liquidaciongastos->FECHA_CREA), 'd-m-Y h:i:s')); ?>"                         
                    readonly = "readonly"
                    required = ""
                    autocomplete="off" class="form-control input-sm"/>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e($liquidaciongastos->TXT_CENTRO); ?>"                         
                    placeholder="NUMERO"
                    readonly = "readonly"
                    required = ""
                    autocomplete="off" class="form-control input-sm"/>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e($liquidaciongastos->ARENDIR); ?>"                         
                    placeholder="NUMERO"
                    readonly = "readonly"
                    required = ""
                    autocomplete="off" class="form-control input-sm"/>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e($liquidaciongastos->TXT_USUARIO_AUTORIZA); ?>"                         
                    placeholder="NUMERO"
                    readonly = "readonly"
                    required = ""
                    autocomplete="off" class="form-control input-sm"/>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e($liquidaciongastos->TOTAL); ?>"                         
                    placeholder="TOTAL"
                    readonly = "readonly"
                    required = ""
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e($liquidaciongastos->TXT_AREA); ?>"                         
                    placeholder="NUMERO"
                    readonly = "readonly"
                    required = ""
                    autocomplete="off" class="form-control input-sm"/>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e($liquidaciongastos->TXT_CATEGORIA_MONEDA); ?>"                         
                    placeholder="NUMERO"
                    readonly = "readonly"
                    required = ""
                    autocomplete="off" class="form-control input-sm"/>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-12">
            <input  type="text"
                    ...
                    value="<?php echo e($fechasarendir); ?>"                         
