              ...
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading"><?php echo e($titulo); ?>
                  ...
                  <div class="tools tooltiptop">
                      <a href="#" class="tooltipcss opciones buscardocumentoobservados">
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('comprobante.ajax.mergelistaobservados', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
