            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <input type="hidden" name="idoc" id='idoc' value="<?php echo e($idoc); ?>">

                        <div class="panel-heading">Revision de Comprobante (<?php echo e($ordencompra->COD_ORDEN); ?>)</div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="POST" id='formpedido'
                                                  action="<?php echo e(url('/aprobar-comprobante-contabilidad/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>"
                                                ...
                                                <?php echo $__env->make('comprobante.form.formaprobarcont', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="POST" id='formpedidoobservar'
                                                  action="<?php echo e(url('/agregar-observacion-contabilidad/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <?php echo $__env->make('comprobante.form.formobservar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidoreparable'
                                                  action="<?php echo e(url('/agregar-reparable-contabilidad/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <?php echo $__env->make('comprobante.form.formreparable', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidorechazar'
                                                  action="<?php echo e(url('/agregar-extorno-contabilidad/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <?php echo $__env->make('comprobante.form.formrechazo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('public/js/comprobante/af.js?v='.$version)); ?>" type="text/javascript"></script>
