...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/reporte/reportes.css?v=' . $version)); ?> " />
...
<div class="be-content contenido cfedocumento">
    <div class="main-content container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div
                    class="panel panel-default panel-border-color <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000010394'): ?> panel-border-color-danger <?php else: ?> <?php if(Session::get('empresas')->COD_EMPR == 'IACHEM0000007086'): ?> panel-border-color-success <?php else: ?> panel-border-color-info <?php endif; ?> <?php endif; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <select name="trabajador" id="trabajador"
                                                        ...
                                                        <?php $__currentLoopData = $trabajadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->COD_EMPRESA_TRABAJADOR); ?>">
                                                                <?php echo e($item->TXT_EMPRESA_TRABAJADOR); ?>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    <div data-min-view="2" data-date-format="dd-mm-yyyy"
                                                        ...
                                                        <input size="16" type="text" value="<?php echo e(date('d-m-Y')); ?>"
...
<script src="<?php echo e(asset('public/js/reporte/conciliacionliquidaciongastos.js?v=' . $version)); ?>"
    type="text/javascript"></script>
