                    ...
                    <table class="table align-middle mb-0" id="tabla-detalle-tab">
                        <thead style="background: #f8f9fc;">
                            <tr style="font-size: 12px; color: #4e73df; font-weight: 700; text-transform: uppercase;">
                                ...
                                <?php if($mostrarJefe): ?> <th class="text-center py-3">Cant. Jefe</th> <?php endif; ?>
                                <?php if($mostrarGer): ?> <th class="text-center py-3">Cant. Gerencia</th> <?php endif; ?>
                                <?php if($mostrarAdm): ?> <th class="text-center py-3">Cant. Admin</th> <?php endif; ?>
                        ...
                        <tbody style="font-size: 13.5px; color: #5a5c69;">
                            <?php $__empty_1 = true; $__currentLoopData = $pedillodetalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr style="border-bottom: 1px solid #eaecf4;">
                                    <td class="text-center py-3 ps-4 fw-bold" style="color: #1d3a6d;"><?php echo e($index + 1); ?></td>
                                    <td class="py-3">
                                    ...
                                    <td class="py-3"><?php echo e($detalle->NOM_CATEGORIA); ?></td>
                                    ...
                                    <td class="text-center py-3 fw-bold"><?php echo e($detalle->CANTIDAD); ?></td>

                                    <?php if($mostrarJefe): ?>
                                        <td class="text-center py-3 fw-bold text-success"><?php echo e($detalle->CAN_MODIF_JEF_AUT ?? '—'); ?></td>
                                    <?php endif; ?>
                                    <?php if($mostrarGer): ?>
                                        <td class="text-center py-3 fw-bold text-info"><?php echo e($detalle->CAN_MODIF_GER ?? '—'); ?></td>
                                    <?php endif; ?>
                                    <?php if($mostrarAdm): ?>
                                        <td class="text-center py-3 fw-bold text-danger"><?php echo e($detalle->CAN_MODIF_ADM ?? '—'); ?></td>
                                    <?php endif; ?>
