                                         ...
                                         <?php $__currentLoopData = $detalleordencompra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                            <tr>
                                              ...
                                              <td class="tdopcionesordaf" style="display: flex;align-content: center;flex-wrap: nowrap;flex-direction: row;justify-content: center;align-items: baseline;">
                                                  <input type="checkbox" id="checkboxcataf<?php echo e($index); ?>" class="checkboxcataf" attd="<?php echo e(json_encode($item)); ?>" attcodprod="<?php echo e($item->COD_PRODUCTO ?? ''); ?>" attcantprod="<?php echo e($item->CAN_PRODUCTO ?? ''); ?>" attcodlote="<?php echo e($item->COD_LOTE ?? ''); ?>" attnrolinea="<?php echo e($item->NRO_LINEA ?? ''); ?>" atttxtdetprod="<?php echo e($item->TXT_DETALLE_PRODUCTO ?? ''); ?>" atttxtnombprod="<?php echo e($item->TXT_NOMBRE_PRODUCTO ?? ''); ?>" style="accent-color: green;width: 15px;height:15px;border-radius: 5px; transform: scale(1.5);cursor: not-allowed;margin-right: 5px;" <?php echo e($funcion->DPAF($idoc,$item->COD_PRODUCTO ?? '') ? 'checked' : ''); ?>>
                                                  <button type="button" name="btnActivoFijo" class="btn btn-xs btn-primary btnActivoFijo" attcodprod="<?php echo e($item->COD_PRODUCTO ?? ''); ?>" attcantprod="<?php echo e($item->CAN_PRODUCTO ?? ''); ?>" attcodlote="<?php echo e($item->COD_LOTE ?? ''); ?>" attnrolinea="<?php echo e($item->NRO_LINEA ?? ''); ?>" atttxtdetprod="<?php echo e($item->TXT_DETALLE_PRODUCTO ?? ''); ?>" atttxtnombprod="<?php echo e($item->TXT_NOMBRE_PRODUCTO ?? ''); ?>" id="btnActivoFijo<?php echo e($index); ?>" idcheckbox="checkboxcataf<?php echo e($index); ?>" title="Asignar categoría de Activo Fijo" style="font-size: 24px !important;border-radius: 5px; margin-top: -10px;">
