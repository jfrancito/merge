...
<?php if($estado_consolidado != 'ETM0000000000005'): ?>
...
<table id="consolidado_general_detalle" class="table table-striped table-bordered table-hover td-color-borde td-padding-7 display nowrap"
    ...
    <tbody>
    <?php $__empty_1 = true; $__currentLoopData = $listadetalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr class="fila-detalle-consolidado-general"
            ...
            <td style="width:90px;">
                <input type="number"
                       ...
                       value="<?php echo e(intval($item->CAN_COMPRADA !== null ? $item->CAN_COMPRADA:$item->CAN_COMPRADA_CALCULADA)); ?>"
                       min="0"
                       oninput="if(this.value<0)this.value=0"
                       step="1"
                       <?php if($estado_consolidado == 'ETM0000000000005'): ?> readonly <?php endif; ?>>
            </td>
