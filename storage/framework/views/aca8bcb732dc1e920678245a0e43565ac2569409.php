...
<div class="container">
      ...
      <p class="intro" style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 15px; color: #374151; line-height: 1.6;">
        ...
        <div class="card">
            <table>
                <tr>
                    <th>ID Pedido</th>
                    <td class="id"><?php echo e($pedido->ID_PEDIDO); ?></td>
                </tr>
                <tr>
                    <th>Fecha</th>
                    <td><?php echo e(date('d/m/Y', strtotime($pedido->FEC_PEDIDO))); ?></td>
                </tr>
                <tr>
                    <th>Solicitante</th>
                    <td><?php echo e($pedido->TXT_TRABAJADOR_SOLICITA); ?></td>
                </tr>
                <tr>
                    <th>Autorizado por</th>
                    <td><?php echo e($pedido->TXT_TRABAJADOR_AUTORIZA); ?></td>
                </tr>
                <tr>
                    <th>Área</th>
                    <td><?php echo e($pedido->TXT_AREA); ?></td>
                </tr>
                <tr>
                    <th>Motivo</th>
                    <td><?php echo e($pedido->TXT_GLOSA); ?></td>
                </tr>
            </table>
        </div>
    ...
    <!-- FOOTER -->
    <div class="footer">
        © <?php echo e(date('Y')); ?> INDUAMERICA<br>
