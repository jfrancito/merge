    <div class="panel panel-default panel-contrast">
      <div class="panel-heading" style="background: #1d3a6d;color: #fff;">CONSULTA API SUNAT
        <div class="tools select" style="cursor: pointer;padding-left: 12px;"> 
          <a class="tools select" href="<?php echo e(url('/refrescar-sunat-oc/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_ORDEN, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_ORDEN, -10)))); ?>">
