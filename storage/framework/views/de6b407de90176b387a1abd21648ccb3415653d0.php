...
<!--                     <a href="#" class="btn btn-secondary botoncabecera tooltipcss opciones buscartareas">
                    ...
                    <a href="<?php echo e(url('/tutorial/liquidaciongastos_01.mp4')); ?>" class="btn btn-secondary botoncabecera tooltipcss opciones" style="width:140px;" Target="_blank">
                      <span class="tooltip-text">Ver Tutorial</span>
                      Tutorial
                    </a>


                    <a href="<?php echo e(url('/agregar-liquidacion-gastos/'.$idopcion)); ?>" class="btn btn-secondary botoncabecera tooltipcss opciones" style="width:140px;">
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    <?php echo $__env->make('liquidaciongasto.ajax.alistaliquidaciongasto', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  </div>
                </div>
              </div>
            </div>
