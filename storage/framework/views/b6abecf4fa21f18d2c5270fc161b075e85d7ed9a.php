            ...
            <div id="vale_rendir_detalle" style="display: none;">
                ...
                <div class="row"
                    ...
                    <input type="hidden" id="importeDestinos"
                           value="<?php echo e(json_encode($importeDestinos)); ?>">
                </div>
              ...
              <?php echo $__env->make('valerendirreembolso.ajax.listamodaldetalleregistroimportereembolso', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
