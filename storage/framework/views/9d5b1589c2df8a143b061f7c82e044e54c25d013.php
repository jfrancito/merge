                ...
                <div class="col-sm-12">
                    ...
                    <div class="tab-container">
                      <ul class="nav nav-tabs">
                        ...
                        <li><a href="#valependiente" data-toggle="tab"><b>VALES PENDIENTES </b></a></li>
                        <li><a href="#liquidaciones" data-toggle="tab"><b>LIQUIDACIONES SIN PROCESAR </b></a></li>
                        <li><a href="#documentos" data-toggle="tab"><b>DOCUMENTOS CDR/XML </b></a></li>
                         <li><a href="#listanegra" data-toggle="tab"><b>PROVEEDORES LISTA NEGRA </b></a></li>
                      </ul>
                      <div class="tab-content">
                        <div id="crearvale" class="tab-pane active cont">
                           <?php echo $__env->make('valerendirreembolso.tab.creartabreembolso', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
