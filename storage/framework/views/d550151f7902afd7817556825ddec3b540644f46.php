            ...
            <div class="col-sm-12">
                <div class="panel panel-default panel-border-color panel-border-color-success">
                    ...
                    <div class="panel-body">
                      <?php echo $__env->make('comprobante.lista.detallecomprobantevalidadonuevo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->startSection('script'); ?>
  ...
  <script src="<?php echo e(asset('public/js/comprobante/af.js?v=' . time())); ?>" type="text/javascript"></script>
