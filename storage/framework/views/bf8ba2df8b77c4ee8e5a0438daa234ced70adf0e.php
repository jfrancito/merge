  ...
  <div class="col-sm-6">
    ...
    <?php $__currentLoopData = $documentoscompra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="be-checkbox">
        ...
        <label for="<?php echo e($item->COD_CATEGORIA); ?>"><?php echo e($item->NOM_CATEGORIA); ?> (<?php echo e($item->COD_CTBLE); ?>) <?php if(in_array($item->COD_CATEGORIA, $totalarchivos)): ?> <span class="label label-success">registrado</span> <?php endif; ?> </label>
      </div>
