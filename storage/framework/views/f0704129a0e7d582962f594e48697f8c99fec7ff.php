<table class="table table-striped table-bordered table-hover td-color-borde td-padding-7">
    <thead>
        <tr>
            <th colspan="13" style="text-align: center; font-size: 14px; font-weight: bold; background-color: #f1f5f9;">
                REPORTE MASIVO: <?php echo e($cantidad_consolidados); ?> CONSOLIDADOS SELECCIONADOS
            </th>
        </tr>
        <tr>
            <th style="background-color: #1e3a8a; color: #ffffff;"><b>ID CONSOLIDADO</b></th>
    ...
    <tbody>
        <?php $__currentLoopData = $listadetalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td style="font-weight: bold; color: #0f172a;"><?php echo e($item->ID_PEDIDO_CONSOLIDADO); ?></td>
