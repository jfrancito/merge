            ...
            <div class="col-sm-12">
                <div class="panel panel-default panel-border-color panel-border-color-success">
                    <div class="panel-heading"><?php echo e($titulo); ?> 
                            <?php echo $__env->make('comprobante.hextorno', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <div class="panel-body">
                        <?php if($fereftop1->OPERACION == 'DOCUMENTO_INTERNO_COMPRA'): ?>                            
                            <?php echo $__env->make('comprobante.lista.detallecomprobanteadministradorestibadocumentointernocompra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php else: ?>
                            <?php echo $__env->make('comprobante.lista.detallecomprobanteadministradorestiba', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php endif; ?>                      
                    </div>
                </div>
            </div>
