    ...
    <div class="row">
      <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading">Revision de Comporbante (<?php echo e($liquidaciongastos->ID_DOCUMENTO); ?>)</div>
              ...
              <div class="tab-content">
                <div id="aprobar" class="tab-pane active cont">
                      <div class="panel panel-default panel-border-color panel-border-color-primary">
                        ...
                        <div class="panel-body">
                          <form method="POST" id='formpedido' action="<?php echo e(url('/aprobar-liquidacion-gasto-administracion/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>

                            <input type="hidden" name="device_info" id='device_info'>

                            <?php echo $__env->make('liquidaciongasto.form.formaprobaradministracionlg', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <div id="observar" class="tab-pane cont">
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                        <form method="POST" id='formpedidoobservar' action="<?php echo e(url('/agregar-observar-administrador/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                              <?php echo e(csrf_field()); ?>

<input type="hidden" name="device_info" id='device_info'>

                          <input type="hidden" name="data_observacion" id="data_observacion">
                          <?php echo $__env->make('liquidaciongasto.form.formobservaradm', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                          <div class="row xs-pt-15">
                            <div class="col-xs-6">
                                <div class="be-checkbox">
                                </div>
                            ...
                            <div class="col-xs-6">
                              <p class="text-right">
                                <a href="<?php echo e(url('/gestion-de-aprobacion-liquidacion-gasto-jefe/'.$idopcion)); ?>"><button type="button" class="btn btn-space btn-danger btncancelar">Cancelar</button></a>
                ...
                <div id="rechazar" class="tab-pane">
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                        <form method="POST" id='formpedidorechazar' action="<?php echo e(url('/agregar-extorno-administracion/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8)))); ?>" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                              <?php echo e(csrf_field()); ?>

<input type="hidden" name="device_info" id='device_info'>

                          <?php echo $__env->make('liquidaciongasto.form.formrechazo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                          ...
                          <div class="row xs-pt-15">
                            ...
                            <div class="col-xs-6">
                              <p class="text-right">
                                <a href="<?php echo e(url('/gestion-de-aprobacion-liquidacion-gastos-administracion/'.$idopcion)); ?>"><button type="button" class="btn btn-space btn-danger btncancelar">Cancelar</button></a>
