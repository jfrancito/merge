...
Route::group(['middleware' => ['authaw']], function () {
	...
	Route::any('/comprobante-masivo-mkt-excel/{fecha_inicio}/{fecha_fin}/{proveedor_id}/{estado_id}/{operacion_id}/{idopcion}', 'ReporteComprobanteController@actionComprobanteMasivoMarketingExcel');
	...
	Route::any('/cambiar-orden-compra-anticipo/{procedencia}/{idopcion}/{prefijo}/{idordencompra}', 'GestionOCController@actionAgregarOCA');
	...
	Route::any('/select-xml-estiba-orden-compra-anticipo/{idopcion}', 'GestionEstibaController@actionDetalleSelectEstibaOrdenCompraAnticipo');

	Route::any('/select-xml-estiba-contrato-anticipo/{idopcion}', 'GestionEstibaController@actionDetalleSelectEstibaContratoAnticipo');
	...
	Route::any('/detalle-comprobante-estiba-administrator-compra-anticipo/{idopcion}/{lote}', 'GestionEstibaController@actionDetalleComprobanteestibaAdministratorCompraAnticipo');

	Route::any('/detalle-comprobante-estiba-administrator-contrato-anticipo/{idopcion}/{lote}', 'GestionEstibaController@actionDetalleComprobanteestibaAdministratorContratoAnticipo');
	...
	Route::any('/validar-xml-oc-estiba-administrator-contratoa/{idopcion}/{lote}', 'GestionEstibaController@actionValidarXMLEstibaAdministratorCONTRATOA');	



	Route::any('/subir-xml-cargar-datos-estiba-administrator-contrato-anticipo/{idopcion}/{lote}', 'GestionEstibaController@actionCargarXMLEstibaAdministratorContratoAnticipo');
	...
	Route::any('/descargar-pago-proveedor-macro-excel-cheque/{folio}', 'GestionEntregaDocumentoController@actionDescargarPagoFolioMacroCheque');
	...
	Route::any('/aprobar-comprobante-contabilidad-estiba-contratoa/{idopcion}/{lote}', 'GestionOCContabilidadController@actionAprobarContabilidadEstibaContratoa');
	...
	Route::any('/agregar-reparable-contabilidad-pg/{idopcion}/{linea}/{prefijo}/{idordencompra}', 'GestionOCContabilidadController@actionAgregarReparableContabilidadPg');
	Route::any('/agregar-reparable-contabilidad-nc/{idopcion}/{linea}/{prefijo}/{idordencompra}', 'GestionOCContabilidadController@actionAgregarReparableContabilidadNC');
	Route::any('/agregar-reparable-contabilidad-nd/{idopcion}/{linea}/{prefijo}/{idordencompra}', 'GestionOCContabilidadController@actionAgregarReparableContabilidadND');
	...
	Route::any('/agregar-reparable-contabilidad-estiba-dic/{idopcion}/{lote}', 'GestionOCContabilidadController@actionAgregarReparableContabilidadEstibaDIC');
	...
	Route::any('/agregar-extorno-estiba-acopio/{idopcion}/{lote}', 'GestionOCAdministracionController@actionAgregarExtornoEstibaAcopio');
	...
	Route::any('/aprobar-comprobante-administracion-contratoa/{idopcion}/{linea}/{idordencompra}', 'GestionOCAdministracionController@actionAprobarAdministracionCONTRATOA');
	...
	Route::any('/agregar-observacion-administracion-mcontratoa/{idopcion}/{idordencompra}', 'GestionOCAdministracionController@actionAgregarObservacionAdministracionMContratoa');
	Route::any('/agregar-extorno-administracion-oc-mcontratoa/{idopcion}/{idordencompra}', 'GestionOCAdministracionController@actionAgregarExtornoAdministracionContratooca');
	...
	Route::any('/agregar-extorno-contrato-admin/{idopcion}/{linea}/{prefijo}/{idordencompra}', 'GestionOCAdministracionController@actionAgregarExtornoContratoAdmin');
	...
	Route::post('/ajax-obtener-periodos-empresa', 'GestionOrdenPedidoController@actionAjaxObtenerPeriodosEmpresa');
	...
	Route::any('/comprobante-masivo-excel-op/{fecha_inicio}/{fecha_fin}/{empresa_id}/{centro_pedido}/{idopcion}', 'ReporteOrdenPedidoController@actionComprobanteMasivoExcelOp');
	Route::any('/pedido-masivo-excel-op/{fecha_inicio}/{fecha_fin}/{empresa_id}/{centro_pedido}/{idopcion}', 'ReporteOrdenPedidoController@actionDiseñoMasivoExcelOp');
	...
	Route::post('/ver_detalle_orden_pedido_aut', 'GestionOrdenPedidoAutorizaController@actionDetallePedidoAut');
	Route::post('/guardar_editar_detalle_pedido_aut', 'GestionOrdenPedidoAutorizaController@actionGuardarEditarDetalleAut');
	...
	Route::post('/ver_detalle_orden_pedido_ger', 'GestionOrdenPedidoApruebaGerController@actionDetallePedidoGer');
	Route::post('/guardar_editar_detalle_pedido_ger', 'GestionOrdenPedidoApruebaGerController@actionGuardarEditarDetalleGer');
	...
	Route::post('/ver_detalle_orden_pedido_adm', 'GestionOrdenPedidoApruebaAdmController@actionDetallePedidoAdm');
	...
	Route::get('/aprobar-consolidado-pedidos/{idopcion}', 'ConsolidadoPedidoAprobadoController@actionConsolidadoPedidoAprobar');
	Route::any('/ajax-buscar-consolidado-pedidos-aprobar', 'ConsolidadoPedidoAprobadoController@actionListarAjaxBuscarConsolidadoPedidoAprobar');
	Route::post('/ajax-listar-detalle-consolidado-aprobado', 'ConsolidadoPedidoAprobadoController@actionListarAjaxDetalleConsolidadoPedidoAprobar');
	Route::post('/ajax-guardar-cambios-consolidado-aprobar', 'ConsolidadoPedidoAprobadoController@actionAjaxGuardarCantidadCompradaAprobar');
	Route::post('/ajax-aprobar-consolidado-aprobar', 'ConsolidadoPedidoAprobadoController@actionAjaxAprobarConsolidadoPedido');
