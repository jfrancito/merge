$(document).ready(function(){
    ...
    $(".cfedocumento").on('click','.mdisel', function(e) {
        ...
        const link                  =   '/ajax-select-folio-pagos-detracion'
        data                        =   {
                                            _token                  : _token,
        ...
        $.confirm({
            ...
            buttons: {
                confirmar: function () {
                    ...
                    ajax_extornar(data,"/ajax-extornar-folio-pagos-detraccion");
                },
                cancelar: function () {
    ...
    $(".cfedocumento").on('click','.mdidet', function(e) {
        ...
        const link                  =   '/ajax-detalle-folio-pagos-detraccion'
        abrircargando();
        $.ajax({
            type    :   "POST",
            url     :   carpeta+link,
    ...
    $(".cfedocumento").on('click','.loteentregable', function(e) {
        ...
        ajax_modal(data,"/ajax-modal-detalle-folios-detraccion",
                  "modal-detalle-requerimiento","modal-detalle-requerimiento-container");
    ...
    $(".cfedocumento").on('click','.selectfolio', function(e) {
        ...
        const link      = '/ajax-crear-folio-pagos-detracion';
        var thischeck   =  $(this);
        data                        =   {
                                            _token                  : _token,
                                            check                   : check,
    ...
    $(".cfedocumento").on('click','.buscardocumento', function() {
        ...
        ajax_normal(data,"/ajax-buscar-documento-fe-entregable-detraccion");
