...
<!--                     <a href="#" class="btn btn-secondary botoncabecera tooltipcss opciones buscartareas">
                    ...
                    <a href="{{ url('/tutorial/liquidaciongastos.mp4') }}" class="btn btn-secondary botoncabecera tooltipcss opciones" style="width:140px;" Target="_blank">
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    @include('liquidaciongasto.ajax.alistaliquidaciongasto')
                  </div>
                </div>
              </div>
            </div>
