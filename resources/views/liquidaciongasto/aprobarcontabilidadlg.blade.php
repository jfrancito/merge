                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="{{ url('/aprobar-liquidacion-gasto-contabilidad/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8))) }}"
                                                ...
                                                <div class="row xs-pt-15">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <p class="text-right">
                                                            <a href="{{ url('/gestion-de-aprobacion-liquidacion-gastos-contabilidad/'.$idopcion) }}">
                                                                <button type="button"
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidoobservar'
                                                  action="{{ url('/agregar-observar-contabilidad/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8))) }}"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                {{ csrf_field() }}
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="POST" id='formpedidorechazar'
                                                  action="{{ url('/agregar-extorno-contabilidad-lg/'.$idopcion.'/'.Hashids::encode(substr($liquidaciongastos->ID_DOCUMENTO, -8))) }}"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                {{ csrf_field() }}
