        ...
        <div class="tab-container">
          ...
          <div class="tab-content">
            <div id="oc" class="tab-pane @if($tab_id=='oc') active @endif cont">
              @include('liquidaciongasto.lista.ajax.alistalgadmin', ['id' => 'nso' , 'listadatos' => $listadatos])
            </div>
            <div id="observado" class="tab-pane @if($tab_id=='observado') active @endif cont">
              @include('liquidaciongasto.lista.ajax.alistalgadmin', ['id' => 'nso_obs' , 'listadatos' => $listadatos_obs])
            </div>
            <div id="observadole" class="tab-pane @if($tab_id=='observadole') active @endif cont">
              @include('liquidaciongasto.lista.ajax.alistalgadmin', ['id' => 'nso_obs_le' , 'listadatos' => $listadatos_obs_le])
            </div>
          </div>
        </div>
      </div>
