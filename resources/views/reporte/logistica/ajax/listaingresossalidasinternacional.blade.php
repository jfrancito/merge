<table id="isinternacional"
    ...
    <tr class="pie">
        ...
        <th style="text-align: right">{{number_format($stock_anterior_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($total_anterior_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($stock_compras_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($total_compras_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($stock_anterior_compras_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($total_anterior_compras_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($stock_ingresos_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($total_ingresos_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($stock_salidas_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($total_salidas_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($stock_ultima_fecha_internacional, 4, '.', '')}}</th>
        <th style="text-align: right">{{number_format($total_ultima_fecha_internacional, 4, '.', '')}}</th>
    </tr>
    </tfoot>
</table>
