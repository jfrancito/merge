            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-success">
                            ...
                            <div class="tools tooltiptop">
                                ...
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="menudespacho"
                                      ...
                                      <li>
                                          <a href="{{url('/comprobante-masivo-tesoreria-comision-excel')}}" 
                                             class='tn btn-secondary botoncabecera tooltipcss opciones'
                                             target="_blank"
                                             id="descargarcomprobantemasivotesoreriracomisionexcel" 
                                             data-href="{{url('/comprobante-masivo-tesoreria-comision-excel')}}"
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 cajareporte">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 abajocaja">
                                            {!! Form::select( 'banco_id', $combo_banco, array($banco_id),
                                                              [
                        ...
                        <div class='listajax'>
                            @include('comision.ajax.alistacomisionadministrador')
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script src="{{ asset('public/js/comprobante/comision.js?v='.$version) }}" type="text/javascript"></script>
