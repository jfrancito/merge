            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Revision de Comprobante ({{$cuartacategoria->ID_DOCUMENTO}})</div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="{{ url('/aprobar-renta-cuarta-contabilidad/'.$idopcion.'/'.Hashids::encode(substr($cuartacategoria->ID_DOCUMENTO, -8))) }}"
                                                ...
                                                <div class="row xs-pt-15">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <p class="text-right">
                                                            ...
                                                            <button type="button" data-url="{{ url('/aprobar-renta-cuarta-contabilidad/'.$idopcion.'/'.Hashids::encode(substr($cuartacategoria->ID_DOCUMENTO, -8))) }}"
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="POST" id='formpedidorechazar'
                                                  action="{{ url('/agregar-extorno-contabilidad-rc/'.$idopcion.'/'.Hashids::encode(substr($cuartacategoria->ID_DOCUMENTO, -8))) }}"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                {{ csrf_field() }}
<input type="hidden" name="device_info" id='device_info'>
...
@section('script')
    ...
    <script src="{{ asset('public/js/comprobante/cuartacategoria.js?v='.$version) }}" type="text/javascript"></script>
@stop
