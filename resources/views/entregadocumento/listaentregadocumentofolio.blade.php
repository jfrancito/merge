                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <div data-min-view="2" 
                                    ...
                                    <input type='text' class="form-control control input-sm" id='fecha_inicio' name='fecha_inicio' value="{{$fechainicio}}" placeholder="Fecha Inicio" autocomplete="off"/>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-12 abajocaja" >
                                  <div data-min-view="2" 
                                       ...
                                       class='input-group date datetimepicker pickerfecha'
                                       style='padding: 0px 0;margin-top: -3px;'>
                                    <input type='text' class="form-control control input-sm" id='fecha_fin' name='fecha_fin' value="{{$fechafin}}" placeholder="Fecha Fin" autocomplete="off"/>
                                    <span class="input-group-addon btn btn-primary">
                                      <i class="icon-th mdi mdi-calendar"></i>
                                    </span>
                                  </div>
