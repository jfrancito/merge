      ...
      <ul class="nav nav-tabs">
        ...
        <div class="tab-content">
                ...
                <div id="pendientes" class="tab-pane cont active">
                   @include('ordenpedido.ajax.alistaordenpedidoapadminpendiente')
                </div>
                <div id="autorizados" class="tab-pane cont">
                   @include('ordenpedido.ajax.alistaordenpedidoaprobadoadm')
                </div>
                 <div id="rechazados" class="tab-pane cont">
                   @include('ordenpedido.ajax.alistaordenpedidorechazoadm')
                </div>
