                        ...
                        <tbody style="font-size: 13.5px; color: #5a5c69;">
                            ...
                            @foreach($pedillodetalle as $index => $detalle)
                                ...
                                <tr style="border-bottom: 1px solid #eaecf4;">
                                    <td class="text-center fw-bold" style="color: #1d3a6d; vertical-align: middle;">{{ $index + 1 }}</td>
                                    ...
                                    <td class="text-center fw-bold" style="vertical-align: middle;">{{ (int) $detalle->CANTIDAD }}</td>
                                    <td class="text-center text-uppercase" style="vertical-align: middle;">{{ $detalle->NOM_UNIDAD_MEDIDA ?? 'UND' }}</td>
