                    ...
                    <table class="table table-hover mb-0" id="tabla-detalle-tab-adm">
                        <thead>
                            <tr style="background: #f8f9fc;">
                                ...
                                @if($mostrarGer) <th class="text-center" style="color: #000; font-weight: 700;">Cant. Aprob. Gerencia</th> @endif
                        ...
                        <tbody style="font-size: 13.5px; color: #5a5c69;">
                            ...
                            @foreach($pedillodetalle as $index => $detalle)
                                ...
                                <tr style="border-bottom: 1px solid #eaecf4;">
                                    ...
                                    @if($mostrarGer)
                                        <td class="text-center" style="vertical-align: middle;">
                                            <span class="fw-bold text-info" style="font-size: 15px;">{{ (int)$cant_ger }}</span>
                                        </td>
                                    @endif
                                    ...
                                    <td style="vertical-align: middle; min-width: 180px; max-width: 280px;">
                                        <div class="text-muted" style="white-space: normal; word-wrap: break-word; word-break: break-word; overflow-wrap: break-word; font-size: 12px; line-height: 1.4;">
                                            {!! $detalle->TXT_OBSERVACION ? nl2br(e($detalle->TXT_OBSERVACION)) : '—' !!}
                                        </div>
                                    </td>

                                    <td class="text-center fw-bold cell-precio" data-precio="{{ $precio }}" style="vertical-align: middle; white-space: nowrap; min-width: 100px;">S/ {{ number_format($precio, 2) }}</td>
                        ...
                        <tfoot>
                            <tr style="background: #f8f9fc;">
                                <td colspan="{{ 8 + ($mostrarJefe ? 1 : 0) + ($mostrarGer ? 1 : 0) }}" class="text-right fw-bold text-uppercase" style="padding: 15px; color: #1d3a6d;">Total General</td>
