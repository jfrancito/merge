                            ...
                            <div class='filtrotabla row'>
                                <div class="col-xs-12">
                                    <form method="POST"
                                          id="formdescargar"
                                          target="_blank"
                                          action="{{ url('/descargar-orden-pedido-estado') }}"
                                    ...
                                    >
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 abajocaja">
                                                    {!! Form::select( 'centro', $combo_centro, '',
                                                                      [
                                        ...
                                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label labelleft negrita">Año
                                                    :</label>
                                                <div class="col-sm-12 abajocaja">
                                                    {!! Form::select( 'anio', $combo_anio, $defecto_anio,
                                                                      [
                                                                        'class'       => 'select2 form-control control input-xs' ,
                                                                        'id'          => 'anio',
                                                                        'data-aw'     => '2',
                                        ...
                                        <div class='ajax_periodo'>
                                            @include('ordenpedido.ajax.comboperiodo')
                                        </div>
                                        <input type="hidden" name="idopcion" id='idopcion' value='{{$id_opcion}}'>
                                    </form>
                                </div>
                            </div>
                            <div class='listajax'>
                                @include('ordenpedido.ajax.alistareporteordenpedidoestado')
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    ...
    <script src="{{ asset('public/js/ordenpedido/ordenpedido.js?v='.$version) }}"
            type="text/javascript"></script>
