            ...
            <tbody>
                @forelse($pedillodetalle as $index => $detalle)
                    <tr>
                        ...
                        <td class="fw-semibold text-truncate" title="{{ $detalle->NOM_PRODUCTO }}">
                            {{ $detalle->NOM_PRODUCTO }}
                        </td>

                        <td class="text-truncate text-secondary" title="{{ $detalle->NOM_CATEGORIA }}">
                        ...
                        <td class="text-truncate observacion" title="{{ $detalle->TXT_OBSERVACION }}">
