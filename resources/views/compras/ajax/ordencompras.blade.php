                            ...
                            <div class="panel panel-default panel-border-color panel-border-color-success">
                                    ...
                                    <div class="tools tooltiptop">
                                        <div class="dropdown">
                                            <a href="#" class="btn btn-secondary botoncabecera tooltipcss opciones buscarpedidoresumen">
                                                <span class="tooltiptext">Buscar Orden Compra</span>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row filtrotabla">
                                        <!-- Fila 1 -->
                                        <div class="col-xs-12 col-md-3 cajareporte" style="margin-bottom: 10px;">
                                            <label class="control-label">Empresa:</label>
                                            {!! Form::select('empresa_id', $empresas, $default_empresa_id, [
                                        ...
                                        <div class="col-xs-12 col-md-3 cajareporte" style="margin-bottom: 10px;">
                                            ...
                                            {!! Form::select('centro_id', $combo_centro, 'TODO', [
                                                'class' => 'form-control select2 input-sm',
                                                'id' => 'centro_id'
                                            ]) !!}
                                        </div>
                                        <div class="col-xs-12 col-md-3 cajareporte" style="margin-bottom: 10px;">
                                            <label class="control-label">Tipo Compra:</label>
                                            {!! Form::select('tipo_compra', $combo_tipo_compra, 'TODO', [
                                                'class' => 'form-control select2 input-sm',
                                                'id' => 'tipo_compra'
                                            ]) !!}
                                        </div>
                                        <div class="col-xs-12 col-md-3 cajareporte" style="margin-bottom: 10px;">
                                            ...
                                            {!! Form::select('moneda_id', $combo_moneda, 'TODO', [
                                                'class' => 'form-control select2 input-sm',
                                                'id' => 'moneda_id'
                                            ]) !!}
                                        </div>
                                    ...
                                    <div id="detalle-orden-compras-container" style="margin-top: 30px; display: none;">
                                        <!-- Se cargará aquí vía AJAX -->
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    <script src="{{ asset('public/js/compras/aprobaroc.js?v='.$version) }}" type="text/javascript"></script>
@stop
