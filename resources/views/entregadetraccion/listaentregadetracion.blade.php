...
@section('section')
  <div class="be-content contenido cfedocumento">
            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                ...
                <div class="panel-body">
                          ...
                          <div class='row'>
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-12 abajocaja" >
                                      {!! Form::select( 'operacion_id', $combo_operacion, $operacion_id,
                                                        [
                                                          'class'       => 'select2 form-control control input-xs combo' ,
                                                          'id'          => 'operacion_id',
                                                          'data-aw'     => '1',
                  ...
                  <div class='listajax'>
                    @include('entregadetraccion.ajax.mergelistadetraccion')
                  </div>
                </div>
              </div>
            </div>
    ...
    @include('entregadetraccion.modal.mregistrorequerimiento')
