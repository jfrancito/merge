<form method="POST" action="{{ url('/configurar-ubicacion-conta-orden/'.$prefijo_id.'/'.$orden_id.'/'.$idopcion) }}" class="form-ajax-ubicacion">
  {{ csrf_field() }}
  ...
  <style type="text/css">
      ...
      .premium-modal-wrapper .modal-close span {
          color: #ffffff !important;
      }
