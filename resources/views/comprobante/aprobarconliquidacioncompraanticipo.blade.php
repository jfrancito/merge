              ...
              <div class="tab-content">
                  ...
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                      <form method="POST" id='formpedido' action="{{ url('/aprobar-comprobante-contabilidad-liquidacion-compra-anticipo/'.$idopcion.'/'.$linea.'/'.substr($ordenpago->COD_AUTORIZACION, 0,6).'/'.Hashids::encode(substr($ordenpago->COD_AUTORIZACION, -10))) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
                        ...
                        @include('comprobante.form.formaprobarcontliquidacioncompraanticipo')
                      </form>
                    </div>
                  </div>
                ...
                <div id="observar" class="tab-pane cont">
                  ...
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                      <form method="POST" id='formpedidoobservar' action="{{ url('/agregar-observacion-contabilidad-liquidacion-compra-anticipo/'.$idopcion.'/'.$linea.'/'.substr($ordenpago->COD_AUTORIZACION, 0,6).'/'.Hashids::encode(substr($ordenpago->COD_AUTORIZACION, -10))) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                            {{ csrf_field() }}
                        <input type="hidden" name="device_info" id='device_info'> 
                        @include('comprobante.form.formobservaraconliquidacioncompraanticipo')
                      </form>
                    </div>
                  </div>
