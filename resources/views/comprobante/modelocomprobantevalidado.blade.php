            ...
            <div class="col-sm-12">
                <div class="panel panel-default panel-border-color panel-border-color-success">
                    ...
                    <div class="panel-body">
                      @include('comprobante.lista.detallecomprobantemodelo')
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">    
      ...
      @foreach($archivospdf as $index => $item)
        ...
        $('#file-'+{{$index}}).fileinput({
          theme: 'fa5',
          language: 'es',
          initialPreview: ["{{ route('serve-file-modelo', ['file' => '']) }}" + nombre_archivo],
          initialPreviewAsData: true,
          initialPreviewFileType: 'pdf',
          initialPreviewConfig: [
              {type: "pdf", caption: nombre_archivo, downloadUrl: "{{ route('serve-file-modelo', ['file' => '']) }}" + nombre_archivo} // Para mostrar el botón de descarga
          ]
        });
      @endforeach
