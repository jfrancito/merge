<div class="panel panel-default panel-contrast">
    ...
    <div class="panel-body panel-body-contrast" style="background: white">

        <div class="tablageneral" style="border-radius: 10px; padding: 10px">
            <div class="col-md-12" style="background: #1d3a6d; color: white">
                <h3>Detalle Asiento</h3>
            </div>
