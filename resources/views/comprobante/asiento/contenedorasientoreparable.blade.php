<div class="panel panel-default panel-contrast">
    <div class="panel-heading" style="background: #1d3a6d;color: #fff;">
        GENERACIÓN DE ASIENTO REPARABLE
    </div>
        ...
        <div class="tab-content">
            <div id="astcabgeneral" class="tab-pane active row cont">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 cajareporte">
                        <div class="form-group">
    ...
    <div class="panel-body panel-body-contrast">
        ...
        <div class="tab-container tablageneralreparable">
            <ul class="nav nav-tabs">
                <li class="active negrita"><a href="#astreparable" data-toggle="tab">DIARIO REPARABLE</a></li>
            </ul>
            <div class="tab-content">
                <div id="astreparable" class="tab-pane active cont">
                    ...
                    <button type="button" class="btn btn-success agregar-linea-reparable">
                        ➕ Agregar línea
                    </button>
                        ...
                        @if(!empty($asiento_reparable))
                            @foreach($asiento_reparable[2] as $key => $asiento_movimiento)
                                <tr class="fila" data_codigo="{{ $asiento_movimiento['COD_ASIENTO_MOVIMIENTO'] }}"
                                    data_moneda="{{ $asiento_reparable[1][0]['COD_CATEGORIA_MONEDA'] }}" data_tc="{{ $asiento_reparable[1][0]['CAN_TIPO_CAMBIO'] }}">
                                    ...
                                    <td class="col-debe-mn" style="text-align: right">{{ number_format($asiento_movimiento['CAN_DEBE_MN'], 4, '.', ',') }}</td>
                                    <td class="col-haber-mn" style="text-align: right">{{ number_format($asiento_movimiento['CAN_HABER_MN'], 4, '.', ',') }}</td>
                                    <td class="col-debe-me" style="text-align: right">{{ number_format($asiento_movimiento['CAN_DEBE_ME'], 4, '.', ',') }}</td>
                                    <td class="col-haber-me" style="text-align: right">{{ number_format($asiento_movimiento['CAN_HABER_ME'], 4, '.', ',') }}</td>
                                    <td>
        ...
        <div class="editarcuentasreparable" style="border-radius: 10px; padding: 10px">
            ...
            <div class="col-md-12" style="background: white;">
                ...
                <input type="hidden" name="asiento_id_editar_reparable" id="asiento_id_editar_reparable" value="">
                ...
                <div class="col-lg-12" style="margin-top: 20px; text-align: right; margin-bottom: 40px;">
                    <div class="col-lg-12">
                        <button type="button" class="btn btn-lg btn-default btn-regresar-lista-reparable">Regresar</button>
                        <button type="button" class="btn btn-lg btn-success btn-registrar-movimiento-reparable">Registrar</button>
                        <button type="button" class="btn btn-lg btn-primary btn-editar-movimiento-reparable">Editar</button>
                    </div>
                </div>
            </div>
