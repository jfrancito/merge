...
<div class="row">
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
    @if($fedocumento->OPERACION_DET == 'SIN_XML') @include('comprobante.form.contrato.compararanticiposxml') @endif    
    @if($fedocumento->OPERACION_DET != 'SIN_XML') @include('comprobante.form.contrato.compararanticipo') @endif 
  </div>
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
    @if($fedocumento->OPERACION_DET == 'SIN_XML') @include('comprobante.form.contrato.datosfactura') @endif    
    @if($fedocumento->OPERACION_DET != 'SIN_XML') @include('comprobante.form.contrato.sunat') @endif 
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    @include('comprobante.form.contrato.verarchivopdfmultiple')
  </div>
</div>
