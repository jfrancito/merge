  ...
  <div class="col-sm-6">
    @foreach($documentoscomprarepable as $index => $item)
      <div class="be-checkbox">
        <input id="{{$item->COD_CATEGORIA}}R" value="{{$item->COD_CATEGORIA}}"  type="checkbox" name="archivore[]" >
...
<div class="form-group">
  <label class="col-sm-3 control-label">Descripcion de Reparar Comprobante<span class="obligatorio">(*)</span> :</label>
  <div class="col-sm-6">
        <textarea 
        name="descripcion"
        id = "descripcion"
