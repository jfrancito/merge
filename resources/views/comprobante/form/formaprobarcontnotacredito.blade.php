...
<div class="row">
  ...
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
    @include('comprobante.form.notacredito.seguimiento')
  </div> 
</div>
...
<div class="row">
                  ...
                  <td class="rigth">
                    <div class="btn-group btn-hspace">
                      ...
                      <ul role="menu" class="dropdown-menu pull-right">
                        ...
                        <li>
                          <a href="{{ url('/descargar-archivo-requerimiento-nota-credito/'.$item->TIPO_ARCHIVO.'/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_DOCUMENTO_CTBLE, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_DOCUMENTO_CTBLE, -10))) }}">
                            Descargar
                          </a>  
                        </li>
                        ...
                        @if(Session::get('usuario')->id == '1CIX00000001' or Session::get('usuario')->id == '1CIX00000049')
                          <li>
                            <a class="elimnaritem"  href="{{ url('/eliminar-archivo-item-nota-credito/'.$item->TIPO_ARCHIVO.'/'.$item->NOMBRE_ARCHIVO.'/'.$idopcion.'/'.$linea.'/'.substr($ordencompra->COD_DOCUMENTO_CTBLE, 0,6).'/'.Hashids::encode(substr($ordencompra->COD_DOCUMENTO_CTBLE, -10))) }}">
                              Eliminar Item
                            </a>
                          </li>
                        @endif
  ...
  <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8">
    @include('comprobante.form.notacredito.informacion')
  </div>
</div>
...
<div class="row">
  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
    @include('comprobante.form.notacredito.archivosobservados')
  </div>
</div>
