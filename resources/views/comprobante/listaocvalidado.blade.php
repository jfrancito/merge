                  ...
                  <div class="tools tooltiptop">
                      <div class="dropdown">
                          ...
                          <a href="{{url('/gestion-de-oc-validado-excel-detallado')}}" 
                             ...
                             style="{{ $operacion_id == 'ORDEN_COMPRA' ? '' : 'display:none;' }}"
                ...
                <div class="panel-body">
                  <div class='filtrotabla row'>
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte caja_sede" style="{{ $operacion_id == 'ORDEN_COMPRA' ? '' : 'display:none;' }}">
