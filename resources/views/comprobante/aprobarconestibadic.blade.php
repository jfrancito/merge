                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="{{ url('/aprobar-comprobante-contabilidad-estiba-dic/'.$idopcion.'/'.$lote) }}"
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedidoreparable'
                                                  action="{{ url('/agregar-reparable-contabilidad-estiba-dic/'.$idopcion.'/'.$lote) }}"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                {{ csrf_field() }}
                                                <input type="hidden" name="operacion_id" id="operacion_id"
...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            let urlAsync = "{{ url('/ajax-generar-asientos-general/estiba-dic/'.$idopcion.'/0/0/'.$lote) }}";
