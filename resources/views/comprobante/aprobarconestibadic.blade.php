              ...
              <div class="tab-content">
                ...
                <div id="aprobar" class="tab-pane active cont">
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                      <form method="POST" id='formpedido' action="{{ url('/aprobar-comprobante-contabilidad-estiba-dic/'.$idopcion.'/'.$lote) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <input type="hidden" name="operacion_id" id="operacion_id" value = "{{$fedocumento->OPERACION}}">
                        @include('comprobante.form.formaprobarcontestibadic')
                      </form>
                    </div>
                  </div>
                </div>
                ...
                <div id="reparable" class="tab-pane">
                  ...
                  <div class="panel panel-default panel-border-color panel-border-color-primary">
                    ...
                    <div class="panel-body">
                        <form method="POST" id='formpedidoreparable' action="{{ url('/agregar-reparable-contabilidad-estiba-dic/'.$idopcion.'/'.$lote) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                              {{ csrf_field() }}
                              <input type="hidden" name="operacion_id" id="operacion_id" value = "{{$fedocumento->OPERACION}}">
                          @include('comprobante.form.formreparableestibadic')
                        </form>
                    </div>
                  </div>
                </div>
