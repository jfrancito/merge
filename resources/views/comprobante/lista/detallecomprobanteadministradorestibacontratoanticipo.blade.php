<div class="listadatos">  
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
              <div class="panel panel-default panel-contrast">
                ...
                <div class="panel-body panel-body-contrast">
                  <form method="POST" action="{{ url('subir-xml-cargar-datos-estiba-administrator-contrato-anticipo/'.$idopcion.'/'.$idoc) }}" name="formcargardatos" id="formcargardatos" enctype="multipart/form-data" >
                     {{ csrf_field() }}
          ...
          @if(count($fedocumento)>0)
            <form method="POST" action="{{ url('validar-xml-oc-estiba-administrator-contratoa/'.$idopcion.'/'.$idoc) }}" name="formguardardatos" id="formguardardatos" enctype="multipart/form-data" >
             {{ csrf_field() }}
            <input type="hidden" name="device_info" id='device_info'>
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                  @if($fedocumento->OPERACION_DET == 'SIN_XML')
                    @include('comprobante.form.contrato.compararanticiposxml')
                  @else
                    @include('comprobante.form.contrato.compararanticipo')
                  @endif
                </div>
                <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8">
                  @if($fedocumento->OPERACION_DET != 'SIN_XML')
                    @include('comprobante.form.contrato.informacionoca')
                  @endif
                </div>
              </div>
