                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="{{ url('/aprobar-comprobante-contabilidad-estiba-contratoa/'.$idopcion.'/'.$lote) }}"
                                                ...
                                                @include('comprobante.form.formaprobarcontestibamcontratoa')
                                            </form>
                                        </div>
                                    </div>
                                </div>
                ...
                initialPreviewConfig: [
                    {
                        ...
                        downloadUrl: "{{ route('serve-fileordencompraanticipo', ['file' => '']) }}" + nombre_archivo
