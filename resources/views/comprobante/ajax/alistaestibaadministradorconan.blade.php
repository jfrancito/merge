...
<div class="panel-heading">
  <form method="POST" id='formre' action="{{ url('/select-xml-estiba-contrato-anticipo/'.$idopcion) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
        {{ csrf_field()}}
