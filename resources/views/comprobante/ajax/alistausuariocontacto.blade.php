        ...
        <td class="rigth">
          <div class="btn-group btn-hspace">
            ...
            <ul role="menu" class="dropdown-menu pull-right">
              ...
              <li>
                <a href="{{ url('/aprobar-comprobante-uc/'.$idopcion.'/'.substr($item->ID_DOCUMENTO, 0,6).'/'.Hashids::encode(substr($item->ID_DOCUMENTO, -10))) }}">
                  Aprobar Comprobante
                </a>  
              </li>
              <li>
                <a href="{{ url('/extornar-pre-aprobar-comprobante/'.$idopcion.'/'.substr($item->ID_DOCUMENTO, 0,6).'/'.Hashids::encode(substr($item->ID_DOCUMENTO, -10))) }}">
