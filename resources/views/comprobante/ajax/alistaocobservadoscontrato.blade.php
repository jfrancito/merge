        ...
        <td class="rigth">
          <div class="btn-group btn-hspace">
            ...
            <ul role="menu" class="dropdown-menu pull-right">
              <li>
                <a href="{{ url('/observacion-comprobante-uc-contrato/'.$idopcion.'/'.$item->DOCUMENTO_ITEM.'/'.substr($item->ID_DOCUMENTO, 0,7).'/'.Hashids::encode(substr($item->ID_DOCUMENTO, -9))) }}">Observacion</a>  
              </li>
            </ul>
          </div>
        </td>
