            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Revision de Comprobante ({{$contratoanticipo->ID_DOCUMENTO}})</div>
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            <form method="POST" id='formpedido'
                                                  action="{{ url('/aprobar-contrato-acopio-acopio/'.$idopcion.'/'.Hashids::encode(substr($contratoanticipo->ID_DOCUMENTO, -8))) }}"
                                                ...
                                                @include('contratoacopio.form.formaprobaracopiocc')
                                                <div class="row xs-pt-15">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <p class="text-right">
                                                            <a href="{{ url('/gestion-de-aprobar-contrato-acopio/'.$idopcion) }}">
                                                                <button type="button"
                                                                        class="btn btn-space btn-danger btncancelar">
                                                                    Cancelar
                                                                </button>
                                                            </a>
                                                            <button type="button" data-url="{{ url('/aprobar-contrato-acopio-acopio/'.$idopcion.'/'.Hashids::encode(substr($contratoanticipo->ID_DOCUMENTO, -8))) }}"
                                    ...
                                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="POST" id='formpedidorechazar'
                                                  action="{{ url('/agregar-extorno-acopio-ca/'.$idopcion.'/'.Hashids::encode(substr($contratoanticipo->ID_DOCUMENTO, -8))) }}"
                                                  style="border-radius: 0px;"
                                                  class="form-horizontal group-border-dashed">
                                                {{ csrf_field() }}
                                                <input type="hidden" name="device_info" id='device_info'>

                                                @include('contratoacopio.form.formrechazoacopio')
                                                ...
                                                <div class="row xs-pt-15">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <p class="text-right">
                                                            <a href="{{ url('/gestion-de-aprobar-cuarta-categoria/'.$idopcion) }}">
                                                                <button type="button"
                                                                        class="btn btn-space btn-danger btncancelar">
                                                                    Cancelar
                                                                </button>
