    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">MOVILIDAD DE IMPULSO ({{$lote->ID_DOCUMENTO}}) MASIVO
          ...
          <div class="panel-body">
                ...
                <div class="row">
                  <div class="col-xs-12 ">
                    <form method="POST" action="{{ url('/emitir-movilidad-impulso/'.$idopcion.'/'.Hashids::encode(substr($lote->ID_DOCUMENTO, -8))) }}" style="border-radius: 0px;" id ='frmpmemitir'>
                          {{ csrf_field() }}
