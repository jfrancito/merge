    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">MOVILIDAD DE IMPULSO ({{$movilidad->ID_DOCUMENTO}})
          ...
          <div class="panel-body">
                ...
                <form method="POST" action="{{ url('/guardar-movilidad-detalle/'.$idopcion.'/'.Hashids::encode(substr($movilidad->ID_DOCUMENTO, -8))) }}" style="border-radius: 0px;" id ='frmdetalleimpulso'>
                  ...
                  <div class='detallemovilidad' style="margin-top:15px;">
                    @include('planillamovilidadimpulso.ajax.amdetalleplanillamovilidad')
                  </div>
                </form>

                <div class="row">
                  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-6">
                    @if(count($documentohistorial)>0)
                      @include('planillamovilidadimpulso.form.impulso.seguimiento')
                    @endif
                  </div>
                  <div class="col-xs-12 col-sm-6 col-md-4 col-lg-6">
