              ...
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">{{ $titulo }}
                  ...
                  <div class="tools tooltiptop">
                    ...
                    <a href="{{ url('/agregar-movilidad-venta-masivo/'.$idopcion) }}" class="btn btn-secondary botoncabecera tooltipcss opciones" style="width:140px;">
                      <span class="tooltiptext">Crear Movilidad Venta Masiva</span>
                      Crear Movilidad
                    </a>
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    @include('planillamovilidadimpulso.ajax.alistamovilidadventamasivo')
                  </div>
                </div>
              </div>
            </div>
