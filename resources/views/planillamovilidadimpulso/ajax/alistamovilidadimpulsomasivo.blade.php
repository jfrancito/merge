      ...
      <tr>
        ...
        <td class="cell-detail" style="position: relative;">
          ...
          @if($item->COD_ESTADO != 'ETM0000000000001')
            <a href="{{ url('/seguimiento-movilidad-impulso/'.$idopcion.'/'.Hashids::encode(substr($item->ID_DOCUMENTO, -8))) }}" style="margin-top: 5px;float: right;" class="btn btn-rounded btn-space btn-primary btn-sm">SEGUIMIENTO</a>
          @endif
