    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">MOVILIDAD IMPULSO
...
<input type="hidden" name="device_info" id='device_info'>
                  ...
                  <div class='formconsulta'>
                    ...
                    <div class="row xs-pt-15">
                      ...
                      <div class="col-xs-6">
                        <p class="text-right">
                            <button type="submit" class="btn btn-space btn-primary btnguardarplanillamovilidad">Crear Nueva Movilidad Impulso</button>     
                        </p>
                      </div>
                    </div>
                  </div>
