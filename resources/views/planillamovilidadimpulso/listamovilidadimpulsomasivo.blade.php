              ...
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">{{ $titulo }}
                  ...
                  <div class="tools tooltiptop">
                    ...
                    <a href="{{ url('/agregar-movilidad-impulso-masivo/'.$idopcion) }}" class="btn btn-secondary botoncabecera tooltipcss opciones" style="width:140px;">
                      <span class="tooltiptext">Crear Movilidad Impulso Masiva</span>
                      Crear Movilidad
                    </a>
