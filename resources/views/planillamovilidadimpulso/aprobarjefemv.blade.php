    ...
    <div class="row">
      <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading">Revision de Comprobante ({{$semanaimpulso->ID_DOCUMENTO}})</div>
...
<input type="hidden" name="device_info" id='device_info'>
                          ...
                          <div class="row xs-pt-15">
                            ...
                            <div class="col-xs-6">
                              <p class="text-right">
                                <a href="{{ url('/gestion-de-aprobacion-liquidacion-gasto-jefe/'.$idopcion) }}"><button type="button" class="btn btn-space btn-danger btncancelar">Cancelar</button></a>
                                <button type="button"  class="btn btn-space btn-primary btnobservarcomporbatntemv">Guardar</button>
                              </p>
                            </div>
                          </div>
