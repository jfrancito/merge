      ...
      <ul class="nav nav-tabs">
        ...
        <div class="tab-content">
                ...
                <div id="pendientes" class="tab-pane cont active">
                   @include('valerendirreembolso.ajax.listamodalvalerendirautorizapendientereembolso')
                </div>
                <div id="autorizados" class="tab-pane cont">
                   @include('valerendirreembolso.ajax.listamodalvalerendirautorizadoreembolso')
                </div>
                 <div id="rechazados" class="tab-pane cont">
                   @include('valerendirreembolso.ajax.listamodalvalerendirrechazadoautorizadoreembolso')
                </div>
