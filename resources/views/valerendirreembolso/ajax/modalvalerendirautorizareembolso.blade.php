                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-table">
                        <div class="panel-heading">Lista Vale a Rendir - Autoriza
                           ...
                           <div class='listajax'>    
                                @include('valerendirreembolso.ajax.listamodalvalerendirautorizareembolso')
                            </div>
                    </div>
                </div>
            </div>
...
<script src="{{ asset('public/js/valerendirreembolso/valerendirreembolso.js?v='.$version) }}" type="text/javascript"></script>
@stop