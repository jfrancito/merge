...
<!--               <a href="{{ url('/subir-firma/' . $idopcion) }}" class="btn btn-secondary botoncabecera tooltipcss opciones"
              ...
              <a href="{{ url('/agregar-planilla-movilidad/' . $idopcion) }}"
                ...
                <div class="form-group ">
                  ...
                  <div class="col-sm-12 abajocaja">
                    <div data-min-view="2" data-date-format="dd-mm-yyyy"
                      ...
                      <input size="16" type="text" value="{{$fecha_inicio}}" placeholder="Fecha Inicio"
              ...
              <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                <div class="form-group ">
                  ...
                  <div class="col-sm-12 abajocaja">
                    <div data-min-view="2" data-date-format="dd-mm-yyyy"
                      class="input-group date datetimepicker pickerfecha" style='padding: 0px 0;margin-top: -3px;'>
                      <input size="16" type="text" value="{{$fecha_fin}}" placeholder="Fecha Fin" id='fecha_fin'
