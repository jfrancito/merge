  ...
  <div class="row" style="max-height: 65vh; overflow-y: auto; overflow-x: hidden; padding-right: 10px;">
    ...
    <div class="col-sm-6">
      ...
      <div class="form-group">
        ...
        <input type="number" step="0.01" name="base_de_calculo" id="activo_base_de_calculo" class="form-control input-sm">
      </div>
      <div class="form-group">
        <label class="control-label">Depreciación Acumulada</label>
        <input type="number" step="0.01" name="depreciacion_acumulada" id="activo_depreciacion_acumulada" class="form-control input-sm" value="0">
      </div>
    </div>
    ...
    <div class="col-sm-6">
      <div class="form-group">
        ...
        <select name="tipo_activo" id="activo_tipo" class="form-control input-sm">
      ...
      <div class="form-group">
        ...
        <input type="date" name="fecha_emision" id="activo_fecha_emision" class="form-control input-sm">
      </div>
      <div class="form-group">
        <label class="control-label">Inicio Depreciación</label>
        <input type="date" name="fecha_inicio_depreciacion" id="activo_fecha_inicio_depreciacion" class="form-control input-sm">
      </div>
      <div class="form-group">
        <label class="control-label">Última Fecha Depreciación</label>
        <input type="date" name="ultima_fecha_depreciacion" id="activo_ultima_fecha_depreciacion" class="form-control input-sm">
      </div>
    </div>
